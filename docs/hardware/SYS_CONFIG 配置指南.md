...
g\_reg\_misc\_base 见[表1](初始化.md#_table44115416).
...
g\_reg\_crg\_base 见[表2](初始化.md#_table61494432)。
...
g\_reg\_crg\_base参考[表2](初始化.md#_table61494432)。
...
g\_reg\_iocfg2\_base 见[表3](初始化.md#_table16578980)。
...
AM20管脚控制寄存器见[表1](时钟管脚配置（AM19）.md#_table796515471314)。
...
g\_reg\_iocfg2\_base1见[表3](初始化.md#_table16578980)
...
g\_reg\_iocfg\_base 见[表3](初始化.md#_table16578980)。
...
-   DATA管脚配置：
    ...
    VI\_DATA0\~VI\_DATA7为对应的BT.656接口的相关功能，可参考“[BT.656管脚复用](BT-656管脚复用.md)”章节的相关描述进行配置。
...
g\_reg\_iocfg2\_base 见[表3](初始化.md#_table16578980)，g\_reg\_mipi\_tx\_base见[表7](初始化.md#_table071427174311)。
...
g\_reg\_iocfg\_base2 见[表3](初始化.md#_table16578980)。
...
VO BT.656接口功能管脚采用VO BT.1120接口的DATA0\~DATA7，这些管脚的驱动能力由MIPI\_TX控制寄存器来配置，方法可参考“[BT.1120管脚复用](BT-1120管脚复用-0.md)”小节，默认配置为档位3。
...
RGB\_DATA0、RGB\_DATA1、RGB\_DATA4、RGB\_DATA5、RGB\_DATA6、RGB\_DATA7 RGB\_DATA8、RGB\_DATA9、RGB\_DATA18、RGB\_DATA19这些管脚的驱动能力由MIPI\_TX控制寄存器来配置，方法可参考“[BT.1120管脚复用](BT-1120管脚复用-0.md)”小节，默认配置为档位2。
