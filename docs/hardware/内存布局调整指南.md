...
<tr id="row127881511132510"><td class="cellrowborder" valign="top" width="39.25%" headers="mcps1.1.3.1.1 "><p id="p1397518149259"><a name="p1397518149259"></a><a name="p1397518149259"></a>Hi3403V100</p>
</td>
...
BL31\_BASE = CONFIG\_KERNEL\_LOAD\_ADDR + 0x2F80000 （`U-Boot`  是 U-Boot 中定义的内核启动地址。）
...
KERNEL\_LOAD\_ADDR = CONFIG\_KERNEL\_LOAD\_ADDR （`U-Boot`  是 U-Boot 中定义的内核启动地址。）
...
<img src="figures/删除LiteOS的前后对比.png" alt="" title="删除LiteOS的前后对比" />
...
<img src="figures/扩大Linux空间的前后对比.png" alt="" title="扩大Linux空间的前后对比" />
