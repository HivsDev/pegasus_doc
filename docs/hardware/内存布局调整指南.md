...
BL31\_BASE = CONFIG\_KERNEL\_LOAD\_ADDR + 0x2F80000 （[CONFIG\_KERNEL\_LOAD\_ADDR]  是 U-Boot 中定义的内核启动地址。）
...
KERNEL\_LOAD\_ADDR = CONFIG\_KERNEL\_LOAD\_ADDR （[CONFIG\_KERNEL\_LOAD\_ADDR]  是 U-Boot 中定义的内核启动地址。）
