...
Hi3403V100有两个子模块支持BAS功能，如[表1](#_Ref48133205)所示。
...
-   DEV和前端时序输入的接口有约束关系。例如Hi3403V100前端需要接入BT.1120，且选择了第0组BT.1120管脚，PIPE应该和DEV3绑定，才能正常接收数据。
-   Hi3403V100 DEV和时序输入接口的约束关系如[表1](#_Ref510971707)所示。

**表 1**  Hi3403V100 DEV与MIPI/BT.1120/BT.656/BT.601/DC接口的绑定关系
...
-   [ss\_mpi\_vi\_set\_dev\_attr](ss_mpi_vi_set_dev_attr.md)：设置VI设备属性。
-   [ss\_mpi\_vi\_get\_dev\_attr](ss_mpi_vi_get_dev_attr.md)：获取VI设备属性。
-   [ss\_mpi\_vi\_set\_bas\_attr](ss_mpi_vi_set_bas_attr.md)：设置VI BayerScale属性。
-   [ss\_mpi\_vi\_get\_bas\_attr](ss_mpi_vi_get_bas_attr.md)：获取VI BayerScale属性。
-   [ss\_mpi\_vi\_enable\_dev](ss_mpi_vi_enable_dev.md)：启用VI设备。
-   [ss\_mpi\_vi\_disable\_dev](ss_mpi_vi_disable_dev.md)：禁用VI设备。
-   [ss\_mpi\_vi\_set\_thermo\_sns\_attr](ss_mpi_vi_set_thermo_sns_attr.md)：设置热成像探测器的配置属性。
-   [ss\_mpi\_vi\_get\_thermo\_sns\_attr](ss_mpi_vi_get_thermo_sns_attr.md)：获取热成像探测器的配置属性。
-   [ss\_mpi\_vi\_enable\_dev\_send\_frame](ss_mpi_vi_enable_dev_send_frame.md)：启用设备送帧功能。
-   [ss\_mpi\_vi\_disable\_dev\_send\_frame](ss_mpi_vi_disable_dev_send_frame.md)：禁用设备送帧功能。
-   [ss\_mpi\_vi\_send\_dev\_frame](ss_mpi_vi_send_dev_frame.md)：配置设备送帧的帧信息。
-   [ss\_mpi\_vi\_set\_dev\_timing\_attr](ss_mpi_vi_set_dev_timing_attr.md)：设置设备自产生时序属性。
-   [ss\_mpi\_vi\_get\_dev\_timing\_attr](ss_mpi_vi_get_dev_timing_attr.md)：获取设备自产生时序属性。
-   [ss\_mpi\_vi\_set\_dev\_data\_attr](ss_mpi_vi_set_dev_data_attr.md)：设置设备自产生数据属性。
-   [ss\_mpi\_vi\_get\_dev\_data\_attr](ss_mpi_vi_get_dev_data_attr.md)：获取设备自产生数据属性。
-   [ss\_mpi\_vi\_bind](ss_mpi_vi_bind.md)：一对一绑定Dev和Pipe。
-   [ss\_mpi\_vi\_unbind](ss_mpi_vi_unbind.md)：一对一解绑定Dev和Pipe。
-   [ss\_mpi\_vi\_get\_bind\_by\_dev](ss_mpi_vi_get_bind_by_dev.md)：获取与Dev绑定的Pipe。
-   [ss\_mpi\_vi\_get\_bind\_by\_pipe](ss_mpi_vi_get_bind_by_pipe.md)：获取与Pipe绑定的Dev。
-   [ss\_mpi\_vi\_set\_wdr\_fusion\_grp\_attr](ss_mpi_vi_set_wdr_fusion_grp_attr.md)：设置wdr合成组的属性。
-   [ss\_mpi\_vi\_get\_wdr\_fusion\_grp\_attr](ss_mpi_vi_get_wdr_fusion_grp_attr.md)：获取wdr合成组的属性。
-   [ss\_mpi\_vi\_create\_pipe](ss_mpi_vi_create_pipe.md)：创建一个VI PIPE。
-   [ss\_mpi\_vi\_destroy\_pipe](ss_mpi_vi_destroy_pipe.md)：销毁一个VI PIPE。
-   [ss\_mpi\_vi\_set\_pipe\_attr](ss_mpi_vi_set_pipe_attr.md)：设置VI PIPE的属性。
-   [ss\_mpi\_vi\_get\_pipe\_attr](ss_mpi_vi_get_pipe_attr.md)：获取VI PIPE的属性。
-   [ss\_mpi\_vi\_start\_pipe](ss_mpi_vi_start_pipe.md)：启用VI PIPE。
-   [ss\_mpi\_vi\_stop\_pipe](ss_mpi_vi_stop_pipe.md)：禁用VI PIPE。
-   [ss\_mpi\_vi\_set\_pipe\_pre\_crop](ss_mpi_vi_set_pipe_pre_crop.md)：设置VI 物理PIPE输入端的裁剪功能属性。
-   [ss\_mpi\_vi\_get\_pipe\_pre\_crop](ss_mpi_vi_get_pipe_pre_crop.md)：获取VI 物理PIPE输入端的裁剪功能属性。
-   [ss\_mpi\_vi\_set\_pipe\_post\_crop](ss_mpi_vi_set_pipe_post_crop.md)：设置VI 物理PIPE输出端的裁剪功能属性。
-   [ss\_mpi\_vi\_get\_pipe\_post\_crop](ss_mpi_vi_get_pipe_post_crop.md)：获取VI 物理PIPE输出端的裁剪功能属性。
-   [ss\_mpi\_vi\_set\_pipe\_frame\_dump\_attr](ss_mpi_vi_set_pipe_frame_dump_attr.md)：设置VI 物理PIPE dump图像帧属性。
-   [ss\_mpi\_vi\_get\_pipe\_frame\_dump\_attr](ss_mpi_vi_get_pipe_frame_dump_attr.md)：获取VI 物理PIPE dump图像帧属性。
-   [ss\_mpi\_vi\_get\_pipe\_frame](ss_mpi_vi_get_pipe_frame.md)：获取VI物理PIPE图像帧。
-   [ss\_mpi\_vi\_release\_pipe\_frame](ss_mpi_vi_release_pipe_frame.md)：释放VI 物理PIPE的图像帧。
-   [ss\_mpi\_vi\_set\_pipe\_fe\_out\_frame\_dump\_attr](ss_mpi_vi_set_pipe_fe_out_frame_dump_attr.md)：设置VI 物理PIPE FE输出 dump图像帧属性。
-   [ss\_mpi\_vi\_get\_pipe\_fe\_out\_frame\_dump\_attr](ss_mpi_vi_get_pipe_fe_out_frame_dump_attr.md)：获取VI 物理PIPE FE输出 dump图像帧属性。
-   [ss\_mpi\_vi\_get\_pipe\_fe\_out\_frame](ss_mpi_vi_get_pipe_fe_out_frame.md)：获取VI物理PIPE FE输出图像帧。
-   [ss\_mpi\_vi\_release\_pipe\_fe\_out\_frame](ss_mpi_vi_release_pipe_fe_out_frame.md)：释放VI 物理PIPE FE输出的图像帧。
-   [ss\_mpi\_vi\_set\_pipe\_private\_data\_dump\_attr](ss_mpi_vi_set_pipe_private_data_dump_attr.md)：设置VI物理PIPE dump私有数据的属性。
-   [ss\_mpi\_vi\_get\_pipe\_private\_data\_dump\_attr](ss_mpi_vi_get_pipe_private_data_dump_attr.md)：获取VI物理PIPE dump私有数据的属性。
-   [ss\_mpi\_vi\_get\_pipe\_private\_data](ss_mpi_vi_get_pipe_private_data.md)：获取VI物理PIPE的私有数据。
-   [ss\_mpi\_vi\_release\_pipe\_private\_data](ss_mpi_vi_release_pipe_private_data.md)：释放VI物理PIPE的私有数据。
-   [ss\_mpi\_vi\_set\_pipe\_bas\_frame\_dump\_attr](ss_mpi_vi_set_pipe_bas_frame_dump_attr.md)：设置VI PIPE dump bas图像帧的属性。
-   [ss\_mpi\_vi\_get\_pipe\_bas\_frame\_dump\_attr](ss_mpi_vi_get_pipe_bas_frame_dump_attr.md)：获取VI PIPE dump bas图像帧的属性。
-   [ss\_mpi\_vi\_get\_pipe\_bas\_frame](ss_mpi_vi_get_pipe_bas_frame.md)：获取VI PIPE bas图像帧。
-   [ss\_mpi\_vi\_release\_pipe\_bas\_frame](ss_mpi_vi_release_pipe_bas_frame.md)：释放VI PIPE bas图像帧。
-   [ss\_mpi\_vi\_set\_pipe\_frame\_source](ss_mpi_vi_set_pipe_frame_source.md)：设置VI PIPE数据的来源。
-   [ss\_mpi\_vi\_get\_pipe\_frame\_source](ss_mpi_vi_get_pipe_frame_source.md)：获取VI PIPE数据的来源。
-   [ss\_mpi\_vi\_set\_pipe\_param](ss_mpi_vi_set_pipe_param.md)：设置VI PIPE参数。
-   [ss\_mpi\_vi\_get\_pipe\_param](ss_mpi_vi_get_pipe_param.md)：获取VI PIPE参数。
-   [ss\_mpi\_vi\_enable\_pipe\_stagger\_out\_split](ss_mpi_vi_enable_pipe_stagger_out_split.md)：启用VI PIPE STAGGER模式输出拆分。
-   [ss\_mpi\_vi\_disable\_pipe\_stagger\_out\_split](ss_mpi_vi_disable_pipe_stagger_out_split.md)：禁用VI PIPE STAGGER模式输出拆分。
-   [ss\_mpi\_vi\_set\_pipe\_bnr\_buf\_num](ss_mpi_vi_set_pipe_bnr_buf_num.md)：设置VI PIPE bayernr buffer个数。
-   [ss\_mpi\_vi\_get\_pipe\_bnr\_buf\_num](ss_mpi_vi_get_pipe_bnr_buf_num.md)：获取VI PIPE bayernr buffer个数。
-   [ss\_mpi\_vi\_send\_pipe\_yuv](ss_mpi_vi_send_pipe_yuv.md)：通过VI PIPE发送YUV数据。
-   [ss\_mpi\_vi\_send\_pipe\_raw](ss_mpi_vi_send_pipe_raw.md)：通过VI PIPE发送RAW数据。
-   [ss\_mpi\_vi\_query\_pipe\_status](ss_mpi_vi_query_pipe_status.md)：查询VI PIPE状态。
-   [ss\_mpi\_vi\_enable\_pipe\_interrupt](ss_mpi_vi_enable_pipe_interrupt.md)：启动VI 物理PIPE中断。
-   [ss\_mpi\_vi\_disable\_pipe\_interrupt](ss_mpi_vi_disable_pipe_interrupt.md)：禁用VI 物理PIPE中断。
-   [ss\_mpi\_vi\_set\_pipe\_vc\_number](ss_mpi_vi_set_pipe_vc_number.md)：设置VI 物理PIPE对接前端sensor或者AD的VC号。
-   [ss\_mpi\_vi\_get\_pipe\_vc\_number](ss_mpi_vi_get_pipe_vc_number.md)：获取VI 物理PIPE对接前端sensor或者AD的VC号。
-   [ss\_mpi\_vi\_set\_pipe\_low\_delay\_attr](ss_mpi_vi_set_pipe_low_delay_attr.md)：设置VI PIPE低延时属性。
-   [ss\_mpi\_vi\_get\_pipe\_low\_delay\_attr](ss_mpi_vi_get_pipe_low_delay_attr.md)：获取VI PIPE低延时属性。
-   [ss\_mpi\_vi\_set\_pipe\_frame\_interrupt\_attr](ss_mpi_vi_set_pipe_frame_interrupt_attr.md)：设置VI PIPE上报中断属性。
-   [ss\_mpi\_vi\_get\_pipe\_frame\_interrupt\_attr](ss_mpi_vi_get_pipe_frame_interrupt_attr.md)：获取VI PIPE上报中断属性。
-   [ss\_mpi\_vi\_set\_pipe\_fisheye\_cfg](ss_mpi_vi_set_pipe_fisheye_cfg.md)：设置VI PIPE对应的鱼眼镜头LMF参数配置。
-   [ss\_mpi\_vi\_get\_pipe\_fisheye\_cfg](ss_mpi_vi_get_pipe_fisheye_cfg.md)：获取VI PIPE对应的鱼眼镜头LMF参数配置。
-   [ss\_mpi\_vi\_get\_pipe\_compress\_param](ss_mpi_vi_get_pipe_compress_param.md)：获取VI物理 PIPE的RAW压缩参数。
-   [ss\_mpi\_vi\_set\_user\_pic](ss_mpi_vi_set_user_pic.md)：设置用户图片，作为无视频信号时的插入图片。
-   [ss\_mpi\_vi\_enable\_user\_pic](ss_mpi_vi_enable_user_pic.md)：启用VI PIPE插入用户图片。
-   [ss\_mpi\_vi\_disable\_user\_pic](ss_mpi_vi_disable_user_pic.md)：禁用VI PIPE插入用户图片。
-   [ss\_mpi\_vi\_pipe\_set\_vb\_src](ss_mpi_vi_pipe_set_vb_src.md)：设置VI PIPE的VB来源。
-   [ss\_mpi\_vi\_pipe\_get\_vb\_src](ss_mpi_vi_pipe_get_vb_src.md)：获取VI PIPE的VB来源。
-   [ss\_mpi\_vi\_pipe\_attach\_vb\_pool](ss_mpi_vi_pipe_attach_vb_pool.md)：将VI的PIPE绑定到某个视频缓存VB池中。
-   [ss\_mpi\_vi\_pipe\_detach\_vb\_pool](ss_mpi_vi_pipe_detach_vb_pool.md)：将VI的PIPE从某个视频缓存VB池中解绑定。
-   [ss\_mpi\_vi\_get\_pipe\_fd](ss_mpi_vi_get_pipe_fd.md)：获取VI PIPE文件描述符。
-   [ss\_mpi\_vi\_set\_chn\_attr](ss_mpi_vi_set_chn_attr.md)：设置VI通道属性。
-   [ss\_mpi\_vi\_get\_chn\_attr](ss_mpi_vi_get_chn_attr.md)：获取VI通道属性。
-   [ss\_mpi\_vi\_set\_ext\_chn\_attr](ss_mpi_vi_set_ext_chn_attr.md)：设置VI扩展通道属性。
-   [ss\_mpi\_vi\_get\_ext\_chn\_attr](ss_mpi_vi_get_ext_chn_attr.md)：获取VI扩展通道属性。
-   [ss\_mpi\_vi\_enable\_chn](ss_mpi_vi_enable_chn.md)：启用VI通道。
-   [ss\_mpi\_vi\_disable\_chn](ss_mpi_vi_disable_chn.md)：禁用VI通道。
-   [ss\_mpi\_vi\_set\_chn\_crop](ss_mpi_vi_set_chn_crop.md)：设置VI通道裁剪功能属性。
-   [ss\_mpi\_vi\_get\_chn\_crop](ss_mpi_vi_get_chn_crop.md)：获取VI通道裁剪功能属性。
-   [ss\_mpi\_vi\_set\_chn\_rotation](ss_mpi_vi_set_chn_rotation.md)：设置VI图像旋转属性。
-   [ss\_mpi\_vi\_get\_chn\_rotation](ss_mpi_vi_get_chn_rotation.md)：获取VI图像旋转属性。
-   [ss\_mpi\_vi\_set\_chn\_ldc\_attr](ss_mpi_vi_set_chn_ldc_attr.md)：设置VI镜头畸变校正（LDC）属性。
-   [ss\_mpi\_vi\_get\_chn\_ldc\_attr](ss_mpi_vi_get_chn_ldc_attr.md)：获取VI镜头畸变校正（LDC）属性。
-   [ss\_mpi\_vi\_ldc\_pos\_query\_dst\_to\_src](ss_mpi_vi_ldc_pos_query_dst_to_src.md)：根据镜头畸变校正（LDC）的输出图像坐标点查找输入图像的坐标点。
-   [ss\_mpi\_vi\_ldc\_pos\_query\_src\_to\_dst](ss_mpi_vi_ldc_pos_query_src_to_dst.md)：根据镜头畸变校正（LDC）的输入图像坐标点查找输出图像的坐标点。
-   [ss\_mpi\_vi\_set\_chn\_spread\_attr](ss_mpi_vi_set_chn_spread_attr.md)：设置VI通道展宽属性。
-   [ss\_mpi\_vi\_get\_chn\_spread\_attr](ss_mpi_vi_get_chn_spread_attr.md)：获取VI通道展宽属性。
-   [ss\_mpi\_vi\_set\_chn\_fisheye](ss_mpi_vi_set_chn_fisheye.md)：设置VI通道对应的鱼眼属性。
-   [ss\_mpi\_vi\_get\_chn\_fisheye](ss_mpi_vi_get_chn_fisheye.md)：获取VI通道对应的鱼眼属性。
-   [ss\_mpi\_vi\_fisheye\_pos\_query\_dst\_to\_src](ss_mpi_vi_fisheye_pos_query_dst_to_src.md)：根据鱼眼校正输出图像坐标点查找源图像坐标点。
-   [ss\_mpi\_vi\_get\_chn\_rgn\_luma](ss_mpi_vi_get_chn_rgn_luma.md)：获取指定图像区域的亮度总和。
-   [ss\_mpi\_vi\_set\_chn\_dis\_cfg](ss_mpi_vi_set_chn_dis_cfg.md)：设置VI通道的DIS配置信息。
-   [ss\_mpi\_vi\_get\_chn\_dis\_cfg](ss_mpi_vi_get_chn_dis_cfg.md)：获取VI通道的DIS配置信息。
-   [ss\_mpi\_vi\_set\_chn\_dis\_attr](ss_mpi_vi_set_chn_dis_attr.md)：设置VI通道的DIS属性。
-   [ss\_mpi\_vi\_get\_chn\_dis\_attr](ss_mpi_vi_get_chn_dis_attr.md)：获取VI通道的DIS属性。
-   [ss\_mpi\_vi\_set\_chn\_dis\_param](ss_mpi_vi_set_chn_dis_param.md)：设置VI通道的DIS可选参数。
-   [ss\_mpi\_vi\_get\_chn\_dis\_param](ss_mpi_vi_get_chn_dis_param.md)：获取VI通道的DIS的可选参数。
-   [ss\_mpi\_vi\_set\_chn\_dis\_wdr\_attr](ss_mpi_vi_set_chn_dis_wdr_attr.md)：设置VI通道的DIS WDR属性。
-   [ss\_mpi\_vi\_get\_chn\_dis\_wdr\_attr](ss_mpi_vi_get_chn_dis_wdr_attr.md)：获取VI通道的DIS WDR属性。
-   [ss\_mpi\_vi\_set\_chn\_fov\_correction\_attr](ss_mpi_vi_set_chn_fov_correction_attr.md)：设置VI通道的视场角矫正属性。
-   [ss\_mpi\_vi\_get\_chn\_fov\_correction\_attr](ss_mpi_vi_get_chn_fov_correction_attr.md)：获取VI通道的视场角矫正属性。
-   [ss\_mpi\_vi\_get\_chn\_frame](ss_mpi_vi_get_chn_frame.md)：从VI通道获取采集的图像。
-   [ss\_mpi\_vi\_release\_chn\_frame](ss_mpi_vi_release_chn_frame.md)：释放一帧从VI通道获取的图像。
-   [ss\_mpi\_vi\_set\_chn\_low\_delay\_attr](ss_mpi_vi_set_chn_low_delay_attr.md)：设置VI通道低延时属性。
-   [ss\_mpi\_vi\_get\_chn\_low\_delay\_attr](ss_mpi_vi_get_chn_low_delay_attr.md)：获取VI通道低延时属性。
-   [ss\_mpi\_vi\_set\_chn\_align](ss_mpi_vi_set_chn_align.md)：设置VI通道输出YUV数据的行stride对齐。
-   [ss\_mpi\_vi\_get\_chn\_align](ss_mpi_vi_get_chn_align.md)：获取VI通道输出YUV数据的行stride对齐。
-   [ss\_mpi\_vi\_chn\_set\_vb\_src](ss_mpi_vi_chn_set_vb_src.md)：设置VI通道使用VB的来源。
-   [ss\_mpi\_vi\_chn\_get\_vb\_src](ss_mpi_vi_chn_get_vb_src.md)：获取VI通道使用VB的来源。
-   [ss\_mpi\_vi\_chn\_attach\_vb\_pool](ss_mpi_vi_chn_attach_vb_pool.md)：将VI通道绑定到某个视频缓存VB池中。
-   [ss\_mpi\_vi\_chn\_detach\_vb\_pool](ss_mpi_vi_chn_detach_vb_pool.md)：将VI通道从某个视频缓存VB池中解绑定。
-   [ss\_mpi\_vi\_query\_chn\_status](ss_mpi_vi_query_chn_status.md)：查询VI通道的状态。
-   [ss\_mpi\_vi\_get\_chn\_fd](ss_mpi_vi_get_chn_fd.md)：获取VI通道文件描述符。
-   [ss\_mpi\_vi\_set\_stitch\_grp\_attr](ss_mpi_vi_set_stitch_grp_attr.md)：设置VI 的拼接组属性。
-   [ss\_mpi\_vi\_get\_stitch\_grp\_attr](ss_mpi_vi_get_stitch_grp_attr.md)：获取VI 的拼接组属性。
-   [ss\_mpi\_vi\_set\_mod\_param](ss_mpi_vi_set_mod_param.md)：设置VI模块参数。
-   [ss\_mpi\_vi\_get\_mod\_param](ss_mpi_vi_get_mod_param.md)：获取VI模块参数。
-   [ss\_mpi\_vi\_close\_fd](ss_mpi_vi_close_fd.md)：关闭VI文件描述符。
-   [ss\_mpi\_vi\_chn\_set\_zoom\_in\_window](ss_mpi_vi_chn_set_zoom_in_window.md)：设置vi chn 裁剪放大属性。
-   [ss\_mpi\_vi\_chn\_get\_zoom\_in\_window](ss_mpi_vi_chn_get_zoom_in_window.md)：获取vi chn 裁剪放大属性。
...
<p id="p705mcpsimp"><a name="p705mcpsimp"></a><a name="p705mcpsimp"></a>取值范围：[0, <a href="OT_VI_MAX_DEV_NUM.md">OT_VI<span xml:lang="sv-SE" id="ph707mcpsimp"><a name="ph707mcpsimp"></a><a name="ph707mcpsimp"></a>_</span>MAX_DEV_NUM</a>)。</p>
</td>
...
-   不支持BT.1120隔行输入。
-   在调用前要保证VI设备处于禁用状态。如果VI设备已处于使能状态，可以使用[ss\_mpi\_vi\_disable\_dev](ss_mpi_vi_disable_dev.md)来禁用设备。
-   参数dev\_attr主要用来配置指定VI设备的视频接口模式，用于与外围camera、sensor或codec对接，支持的接口模式包括MIPI Rx（MIPI/LVDS/HISPI）、SLVS-EC。用户需要配置以下几类信息，具体属性意义参见“[数据类型](数据类型.md)”部分的说明：
...
[ss\_mpi\_vi\_get\_dev\_attr](#ss_mpi_vi_get_dev_attr)
...
[ss\_mpi\_vi\_set\_dev\_attr](#ss_mpi_vi_set_dev_attr)
...
-   wdr模式下不支持bas功能。
-   该接口在[ss\_mpi\_vi\_enable\_dev](ss_mpi_vi_enable_dev.md)之前配置，在[ss\_mpi\_vi\_set\_dev\_attr](ss_mpi_vi_set_dev_attr.md)之后配置。
...
[ss\_mpi\_vi\_get\_bas\_attr](#ss_mpi_vi_get_bas_attr)
...
[ss\_mpi\_vi\_set\_bas\_attr](#ss_mpi_vi_set_bas_attr)
...
[ss\_mpi\_vi\_disable\_dev](#ss_mpi_vi_disable_dev)
...
[ss\_mpi\_vi\_enable\_dev](#ss_mpi_vi_enable_dev)
...
[ss\_mpi\_vi\_get\_thermo\_sns\_attr](#ss_mpi_vi_get_thermo_sns_attr)
...
调用前必须先调用了[ss\_mpi\_vi\_set\_thermo\_sns\_attr](ss_mpi_vi_set_thermo_sns_attr.md)接口。
...
[ss\_mpi\_vi\_set\_thermo\_sns\_attr](#ss_mpi_vi_set_thermo_sns_attr)
...
-   必须和[ss\_mpi\_vi\_disable\_dev\_send\_frame](ss_mpi_vi_disable_dev_send_frame.md)成对使用，否则会导致VB泄露。
...
[ss\_mpi\_vi\_disable\_dev\_send\_frame](#ss_mpi_vi_disable_dev_send_frame)
...
[ss\_mpi\_vi\_enable\_dev\_send\_frame](#ss_mpi_vi_enable_dev_send_frame)
...
使用本接口时，需先调用[ss\_mpi\_vi\_enable\_dev\_send\_frame](ss_mpi_vi_enable_dev_send_frame.md)使能送帧。
...
[ss\_mpi\_vi\_get\_dev\_data\_attr](#ss_mpi_vi_get_dev_data_attr)
...
[ss\_mpi\_vi\_set\_dev\_data\_attr](#ss_mpi_vi_set_dev_data_attr)
...
[ss\_mpi\_vi\_bind](#ss_mpi_vi_bind)
...
[ss\_mpi\_vi\_destroy\_pipe](#ss_mpi_vi_destroy_pipe)
...
<p xml:lang="sv-SE" id="p2414mcpsimp"><a name="p2414mcpsimp"></a><a name="p2414mcpsimp"></a><span xml:lang="en-US" id="ph2415mcpsimp"><a name="ph2415mcpsimp"></a><a name="ph2415mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph2417mcpsimp"><a name="ph2417mcpsimp"></a><a name="ph2417mcpsimp"></a>)</span></p>
</td>
...
-   使用本接口前，需先调用[ss\_mpi\_vi\_stop\_pipe](ss_mpi_vi_stop_pipe.md)\(vi\_pipe\)停止PIPE，否则提示失败。
...
[ss\_mpi\_vi\_create\_pipe](#ss_mpi_vi_create_pipe)
...
<p xml:lang="sv-SE" id="p2485mcpsimp"><a name="p2485mcpsimp"></a><a name="p2485mcpsimp"></a><span xml:lang="en-US" id="ph2486mcpsimp"><a name="ph2486mcpsimp"></a><a name="ph2486mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph2488mcpsimp"><a name="ph2488mcpsimp"></a><a name="ph2488mcpsimp"></a>)。</span></p>
</td>
...
-   PIPE必须已创建
-   PIPE属性必须合法，其中部分静态属性不可动态设置，具体请参见[ot\_vi\_pipe\_attr](ot_vi_pipe_attr.md)。
...
<p xml:lang="sv-SE" id="p2782mcpsimp"><a name="p2782mcpsimp"></a><a name="p2782mcpsimp"></a><span xml:lang="en-US" id="ph2783mcpsimp"><a name="ph2783mcpsimp"></a><a name="ph2783mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph2785mcpsimp"><a name="ph2785mcpsimp"></a><a name="ph2785mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p2864mcpsimp"><a name="p2864mcpsimp"></a><a name="p2864mcpsimp"></a><span xml:lang="en-US" id="ph2865mcpsimp"><a name="ph2865mcpsimp"></a><a name="ph2865mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph2867mcpsimp"><a name="ph2867mcpsimp"></a><a name="ph2867mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3024mcpsimp"><a name="p3024mcpsimp"></a><a name="p3024mcpsimp"></a><span xml:lang="en-US" id="ph3025mcpsimp"><a name="ph3025mcpsimp"></a><a name="ph3025mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3027mcpsimp"><a name="ph3027mcpsimp"></a><a name="ph3027mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3104mcpsimp"><a name="p3104mcpsimp"></a><a name="p3104mcpsimp"></a><span xml:lang="en-US" id="ph3105mcpsimp"><a name="ph3105mcpsimp"></a><a name="ph3105mcpsimp"></a>取值范围：[0,</span> <a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3107mcpsimp"><a name="ph3107mcpsimp"></a><a name="ph3107mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3184mcpsimp"><a name="p3184mcpsimp"></a><a name="p3184mcpsimp"></a><span xml:lang="en-US" id="ph3185mcpsimp"><a name="ph3185mcpsimp"></a><a name="ph3185mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3187mcpsimp"><a name="ph3187mcpsimp"></a><a name="ph3187mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3259mcpsimp"><a name="p3259mcpsimp"></a><a name="p3259mcpsimp"></a><span xml:lang="en-US" id="ph3260mcpsimp"><a name="ph3260mcpsimp"></a><a name="ph3260mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3262mcpsimp"><a name="ph3262mcpsimp"></a><a name="ph3262mcpsimp"></a>)</span></p>
</td>
...
-   PIPE必须已创建。
-   调用[ss\_mpi\_vi\_set\_pipe\_frame\_dump\_attr](ss_mpi_vi_set_pipe_frame_dump_attr.md)设置dump属性、使能dump、设置depth，否则获取不到帧数据。
-   虚拟PIPE不支持。
...
[ss\_mpi\_vi\_release\_pipe\_frame](#ss_mpi_vi_release_pipe_frame)
...
<p xml:lang="sv-SE" id="p3347mcpsimp"><a name="p3347mcpsimp"></a><a name="p3347mcpsimp"></a><span xml:lang="en-US" id="ph3348mcpsimp"><a name="ph3348mcpsimp"></a><a name="ph3348mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3350mcpsimp"><a name="ph3350mcpsimp"></a><a name="ph3350mcpsimp"></a>)</span></p>
</td>
...
-   本接口调用次数需与[ss\_mpi\_vi\_get\_pipe\_frame](ss_mpi_vi_get_pipe_frame.md)匹配使用，释放次数过多则返回报错。
...
[ss\_mpi\_vi\_get\_pipe\_frame](#ss_mpi_vi_get_pipe_frame)
...
-   PIPE必须已创建。
-   调用[ss\_mpi\_vi\_set\_pipe\_fe\_out\_frame\_dump\_attr](ss_mpi_vi_set_pipe_fe_out_frame_dump_attr.md)设置dump属性、使能dump、设置depth，否则获取不到帧数据。
-   获取到的输出帧是 FE输出的原始帧数据，与stagger拆分模式一起使用时，可使用本接口获取到stagger完整帧数据，同时使用[ss\_mpi\_vi\_get\_pipe\_frame](ss_mpi_vi_get_pipe_frame.md)获取到拆分后的第一帧数据。
-   虚拟PIPE不支持。
-   VI在线模式不支持调用本接口。
...
[ss\_mpi\_vi\_release\_pipe\_fe\_out\_frame](#ss_mpi_vi_release_pipe_fe_out_frame)
...
-   本接口调用次数需与[ss\_mpi\_vi\_get\_pipe\_fe\_out\_frame](ss_mpi_vi_get_pipe_fe_out_frame.md)匹配使用，释放次数过多则返回报错。
-   用户必须保证frame\_info结构中的信息与获取时一致，否则可能造成释放不成功。
...
[ss\_mpi\_vi\_get\_pipe\_fe\_out\_frame](#ss_mpi_vi_get_pipe_fe_out_frame)
...
<p xml:lang="sv-SE" id="p3425mcpsimp"><a name="p3425mcpsimp"></a><a name="p3425mcpsimp"></a><span xml:lang="en-US" id="ph3426mcpsimp"><a name="ph3426mcpsimp"></a><a name="ph3426mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3428mcpsimp"><a name="ph3428mcpsimp"></a><a name="ph3428mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3505mcpsimp"><a name="p3505mcpsimp"></a><a name="p3505mcpsimp"></a><span xml:lang="en-US" id="ph3506mcpsimp"><a name="ph3506mcpsimp"></a><a name="ph3506mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3508mcpsimp"><a name="ph3508mcpsimp"></a><a name="ph3508mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3583mcpsimp"><a name="p3583mcpsimp"></a><a name="p3583mcpsimp"></a><span xml:lang="en-US" id="ph3584mcpsimp"><a name="ph3584mcpsimp"></a><a name="ph3584mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3586mcpsimp"><a name="ph3586mcpsimp"></a><a name="ph3586mcpsimp"></a>)</span></p>
</td>
...
-   PIPE必须已创建。
-   调用[ss\_mpi\_vi\_set\_pipe\_private\_data\_dump\_attr](ss_mpi_vi_set_pipe_private_data_dump_attr.md)设置dump属性、使能dump、设置depth，否则获取不到私有数据。
...
[ss\_mpi\_vi\_release\_pipe\_private\_data](#ss_mpi_vi_release_pipe_private_data)
...
<p xml:lang="sv-SE" id="p3673mcpsimp"><a name="p3673mcpsimp"></a><a name="p3673mcpsimp"></a><span xml:lang="en-US" id="ph3674mcpsimp"><a name="ph3674mcpsimp"></a><a name="ph3674mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3676mcpsimp"><a name="ph3676mcpsimp"></a><a name="ph3676mcpsimp"></a>)</span></p>
</td>
...
-   本接口调用次数需与[ss\_mpi\_vi\_get\_pipe\_private\_data](ss_mpi_vi_get_pipe_private_data.md)匹配使用，释放次数过多则返回报错。
...
[ss\_mpi\_vi\_get\_pipe\_private\_data](#ss_mpi_vi_get_pipe_private_data)
...
<p xml:lang="sv-SE" id="p3751mcpsimp"><a name="p3751mcpsimp"></a><a name="p3751mcpsimp"></a><span xml:lang="en-US" id="ph3752mcpsimp"><a name="ph3752mcpsimp"></a><a name="ph3752mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3754mcpsimp"><a name="ph3754mcpsimp"></a><a name="ph3754mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3832mcpsimp"><a name="p3832mcpsimp"></a><a name="p3832mcpsimp"></a><span xml:lang="en-US" id="ph3833mcpsimp"><a name="ph3833mcpsimp"></a><a name="ph3833mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3835mcpsimp"><a name="ph3835mcpsimp"></a><a name="ph3835mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p3907mcpsimp"><a name="p3907mcpsimp"></a><a name="p3907mcpsimp"></a><span xml:lang="en-US" id="ph3908mcpsimp"><a name="ph3908mcpsimp"></a><a name="ph3908mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph3910mcpsimp"><a name="ph3910mcpsimp"></a><a name="ph3910mcpsimp"></a>)</span></p>
</td>
...
-   PIPE必须已创建。
-   调用[ss\_mpi\_vi\_set\_pipe\_bas\_frame\_dump\_attr](ss_mpi_vi_set_pipe_bas_frame_dump_attr.md)设置dump属性、使能dump、设置depth，否则获取不到raw数据。
-   本接口不支持使用select模式获取帧数据。
...
[ss\_mpi\_vi\_release\_pipe\_bas\_frame](#ss_mpi_vi_release_pipe_bas_frame)
...
<p xml:lang="sv-SE" id="p3997mcpsimp"><a name="p3997mcpsimp"></a><a name="p3997mcpsimp"></a><span xml:lang="en-US" id="ph3998mcpsimp"><a name="ph3998mcpsimp"></a><a name="ph3998mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph4000mcpsimp"><a name="ph4000mcpsimp"></a><a name="ph4000mcpsimp"></a>)</span></p>
</td>
...
-   本接口调用次数需与[ss\_mpi\_vi\_get\_pipe\_bas\_frame](ss_mpi_vi_get_pipe_bas_frame.md)匹配使用，释放次数过多则返回报错。
-   用户必须保证frame\_info结构中的信息与获取时一致，否则可能造成释放不成功。
...
[ss\_mpi\_vi\_get\_pipe\_bas\_frame](#ss_mpi_vi_get_pipe_bas_frame)
...
<p xml:lang="sv-SE" id="p4075mcpsimp"><a name="p4075mcpsimp"></a><a name="p4075mcpsimp"></a><span xml:lang="en-US" id="ph4076mcpsimp"><a name="ph4076mcpsimp"></a><a name="ph4076mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph4078mcpsimp"><a name="ph4078mcpsimp"></a><a name="ph4078mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p4149mcpsimp"><a name="p4149mcpsimp"></a><a name="p4149mcpsimp"></a><span xml:lang="en-US" id="ph4150mcpsimp"><a name="ph4150mcpsimp"></a><a name="ph4150mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph4152mcpsimp"><a name="ph4152mcpsimp"></a><a name="ph4152mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p4223mcpsimp"><a name="p4223mcpsimp"></a><a name="p4223mcpsimp"></a><span xml:lang="en-US" id="ph4224mcpsimp"><a name="ph4224mcpsimp"></a><a name="ph4224mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph4226mcpsimp"><a name="ph4226mcpsimp"></a><a name="ph4226mcpsimp"></a>)</span></p>
</td>
...
-   PIPE必须已创建。
-   请务必先调用[ss\_mpi\_vi\_get\_pipe\_param](ss_mpi_vi_get_pipe_param.md)获取当前参数，再进行设置操作。
...
[ss\_mpi\_vi\_get\_pipe\_param](#ss_mpi_vi_get_pipe_param)
...
[ss\_mpi\_vi\_set\_pipe\_param](#ss_mpi_vi_set_pipe_param)
...
-   调用本接口后，通过[ss\_mpi\_vi\_get\_pipe\_frame](ss_mpi_vi_get_pipe_frame.md)获取到的帧数据是stagger完整帧中的第一帧数据；使能本模式时，可使用[ss\_mpi\_vi\_get\_pipe\_fe\_out\_frame](ss_mpi_vi_get_pipe_fe_out_frame.md)获取原始的完整帧数据。
...
-   [ss\_mpi\_vi\_disable\_pipe\_stagger\_out\_split](#ss_mpi_vi_disable_pipe_stagger_out_split)
-   [ss\_mpi\_vi\_set\_pipe\_param](#ss_mpi_vi_set_pipe_param)
...
-   [ss\_mpi\_vi\_enable\_pipe\_stagger\_out\_split](#ss_mpi_vi_enable_pipe_stagger_out_split)
-   [ss\_mpi\_vi\_set\_pipe\_param](#ss_mpi_vi_set_pipe_param)
...
[ss\_mpi\_vi\_get\_pipe\_bnr\_buf\_num](#ss_mpi_vi_get_pipe_bnr_buf_num)
...
[ss\_mpi\_vi\_set\_pipe\_bnr\_buf\_num](#ss_mpi_vi_set_pipe_bnr_buf_num)
...
-   PIPE必须已创建且启动。
-   送YUV首先需要通过[ss\_mpi\_vi\_set\_pipe\_frame\_source](ss_mpi_vi_set_pipe_frame_source.md)来设置PIPE的数据来源为OT\_VI\_PIPE\_FRAME\_SOURCE\_USER。
...
<p xml:lang="sv-SE" id="p4471mcpsimp"><a name="p4471mcpsimp"></a><a name="p4471mcpsimp"></a><span xml:lang="en-US" id="ph4472mcpsimp"><a name="ph4472mcpsimp"></a><a name="ph4472mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph4474mcpsimp"><a name="ph4474mcpsimp"></a><a name="ph4474mcpsimp"></a>)</span></p>
</td>
...
-   送RAW首先需要通过[ss\_mpi\_vi\_set\_pipe\_frame\_source](ss_mpi_vi_set_pipe_frame_source.md)来设置PIPE的数据来源为OT\_VI\_PIPE\_FRAME\_SOURCE\_USER。
-   送一帧处理一帧，不会循环处理。
...
[ss\_mpi\_vi\_disable\_pipe\_interrupt](#ss_mpi_vi_disable_pipe_interrupt)
...
[ss\_mpi\_vi\_enable\_pipe\_interrupt](#ss_mpi_vi_enable_pipe_interrupt)
...
[ss\_mpi\_vi\_get\_pipe\_frame\_interrupt\_attr](#ss_mpi_vi_get_pipe_frame_interrupt_attr)
...
[ss\_mpi\_vi\_set\_pipe\_frame\_interrupt\_attr](#ss_mpi_vi_set_pipe_frame_interrupt_attr)
...
<p xml:lang="sv-SE" id="p5327mcpsimp"><a name="p5327mcpsimp"></a><a name="p5327mcpsimp"></a><span xml:lang="en-US" id="ph5328mcpsimp"><a name="ph5328mcpsimp"></a><a name="ph5328mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph5330mcpsimp"><a name="ph5330mcpsimp"></a><a name="ph5330mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p5403mcpsimp"><a name="p5403mcpsimp"></a><a name="p5403mcpsimp"></a><span xml:lang="en-US" id="ph5404mcpsimp"><a name="ph5404mcpsimp"></a><a name="ph5404mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a><span xml:lang="en-US" id="ph5406mcpsimp"><a name="ph5406mcpsimp"></a><a name="ph5406mcpsimp"></a>)。</span></p>
</td>
...
-   设置VI用户图片，用于将VI通道输出的视频帧图像修改为用户配置的指定YUV图像数据，而不是codec的视频数据；此接口需要与[ss\_mpi\_vi\_enable\_user\_pic](ss_mpi_vi_enable_user_pic.md)、[ss\_mpi\_vi\_disable\_user\_pic](ss_mpi_vi_disable_user_pic.md)配合使用。
...
-   [ss\_mpi\_vi\_enable\_user\_pic](#ss_mpi_vi_enable_user_pic)
-   [ss\_mpi\_vi\_disable\_user\_pic](#ss_mpi_vi_disable_user_pic)
...
-   [ss\_mpi\_vi\_set\_user\_pic](#ss_mpi_vi_set_user_pic)
-   [ss\_mpi\_vi\_disable\_user\_pic](#ss_mpi_vi_disable_user_pic)
...
<p xml:lang="sv-SE" id="p5726mcpsimp"><a name="p5726mcpsimp"></a><a name="p5726mcpsimp"></a><span xml:lang="en-US" id="ph5727mcpsimp"><a name="ph5727mcpsimp"></a><a name="ph5727mcpsimp"></a>取值范围：[0,</span> <a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph5729mcpsimp"><a name="ph5729mcpsimp"></a><a name="ph5729mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p5804mcpsimp"><a name="p5804mcpsimp"></a><a name="p5804mcpsimp"></a><span xml:lang="en-US" id="ph5805mcpsimp"><a name="ph5805mcpsimp"></a><a name="ph5805mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph5807mcpsimp"><a name="ph5807mcpsimp"></a><a name="ph5807mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p5878mcpsimp"><a name="p5878mcpsimp"></a><a name="p5878mcpsimp"></a><span xml:lang="en-US" id="ph5879mcpsimp"><a name="ph5879mcpsimp"></a><a name="ph5879mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph5881mcpsimp"><a name="ph5881mcpsimp"></a><a name="ph5881mcpsimp"></a>)</span></p>
</td>
...
-   在调用[ss\_mpi\_vi\_pipe\_detach\_vb\_pool](ss_mpi_vi_pipe_detach_vb_pool.md)后，销毁创建的VB之前，需要保证VB没有被VI后端绑定的模块使用，可以通过sleep或清除后端模块通道缓存的方式先把VB都释放，再销毁缓存VB池。
-   需要配合[ss\_mpi\_vi\_pipe\_set\_vb\_src](ss_mpi_vi_pipe_set_vb_src.md)接口使用，可以动态切换。
...
-   [ss\_mpi\_vi\_pipe\_detach\_vb\_pool](#ss_mpi_vi_pipe_detach_vb_pool)
-   [ss\_mpi\_vi\_set\_mod\_param](#ss_mpi_vi_set_mod_param)
...
[ss\_mpi\_vi\_pipe\_attach\_vb\_pool](#ss_mpi_vi_pipe_attach_vb_pool)
...
[ss\_mpi\_vi\_get\_chn\_attr](#ss_mpi_vi_get_chn_attr)
...
[ss\_mpi\_vi\_set\_chn\_attr](#ss_mpi_vi_set_chn_attr)
...
[ss\_mpi\_vi\_get\_ext\_chn\_attr](#ss_mpi_vi_get_ext_chn_attr)
...
[ss\_mpi\_vi\_set\_ext\_chn\_attr](#ss_mpi_vi_set_ext_chn_attr)
...
[ss\_mpi\_vi\_disable\_chn](#ss_mpi_vi_disable_chn)
...
[ss\_mpi\_vi\_enable\_chn](#ss_mpi_vi_enable_chn)
...
<p xml:lang="sv-SE" id="p6687mcpsimp"><a name="p6687mcpsimp"></a><a name="p6687mcpsimp"></a><span xml:lang="en-US" id="ph6688mcpsimp"><a name="ph6688mcpsimp"></a><a name="ph6688mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph6690mcpsimp"><a name="ph6690mcpsimp"></a><a name="ph6690mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p6698mcpsimp"><a name="p6698mcpsimp"></a><a name="p6698mcpsimp"></a><span xml:lang="en-US" id="ph6699mcpsimp"><a name="ph6699mcpsimp"></a><a name="ph6699mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph6701mcpsimp"><a name="ph6701mcpsimp"></a><a name="ph6701mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p6779mcpsimp"><a name="p6779mcpsimp"></a><a name="p6779mcpsimp"></a><span xml:lang="en-US" id="ph6780mcpsimp"><a name="ph6780mcpsimp"></a><a name="ph6780mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph6782mcpsimp"><a name="ph6782mcpsimp"></a><a name="ph6782mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p6790mcpsimp"><a name="p6790mcpsimp"></a><a name="p6790mcpsimp"></a><span xml:lang="en-US" id="ph6791mcpsimp"><a name="ph6791mcpsimp"></a><a name="ph6791mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph6793mcpsimp"><a name="ph6793mcpsimp"></a><a name="ph6793mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p6867mcpsimp"><a name="p6867mcpsimp"></a><a name="p6867mcpsimp"></a><span xml:lang="en-US" id="ph6868mcpsimp"><a name="ph6868mcpsimp"></a><a name="ph6868mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph6870mcpsimp"><a name="ph6870mcpsimp"></a><a name="ph6870mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p6878mcpsimp"><a name="p6878mcpsimp"></a><a name="p6878mcpsimp"></a><span xml:lang="en-US" id="ph6879mcpsimp"><a name="ph6879mcpsimp"></a><a name="ph6879mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph6881mcpsimp"><a name="ph6881mcpsimp"></a><a name="ph6881mcpsimp"></a>)</span></p>
</td>
...
-   设置旋转后，物理通道输出的宽高可能会发生变化，但获取的通道属性中的通道宽高仍为用户设置值。比如720p输入的图像，在旋转90度、270度时，实际输出的图像大小为720x1280，但[ss\_mpi\_vi\_get\_chn\_attr](ss_mpi_vi_get_chn_attr.md)获取的DestSize宽高仍为1280x 720。
...
[ss\_mpi\_vi\_set\_chn\_rotation](#ss_mpi_vi_set_chn_rotation)
...
-   [ss\_mpi\_vi\_get\_chn\_ldc\_attr](#ss_mpi_vi_get_chn_ldc_attr)
-   [ss\_mpi\_vi\_set\_chn\_spread\_attr](#ss_mpi_vi_set_chn_spread_attr)
...
<p xml:lang="sv-SE" id="p7175mcpsimp"><a name="p7175mcpsimp"></a><a name="p7175mcpsimp"></a><span xml:lang="en-US" id="ph7176mcpsimp"><a name="ph7176mcpsimp"></a><a name="ph7176mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7178mcpsimp"><a name="ph7178mcpsimp"></a><a name="ph7178mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_set\_chn\_ldc\_attr](#ss_mpi_vi_set_chn_ldc_attr)
...
<p xml:lang="sv-SE" id="p7253mcpsimp"><a name="p7253mcpsimp"></a><a name="p7253mcpsimp"></a><span xml:lang="en-US" id="ph7254mcpsimp"><a name="ph7254mcpsimp"></a><a name="ph7254mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7256mcpsimp"><a name="ph7256mcpsimp"></a><a name="ph7256mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7264mcpsimp"><a name="p7264mcpsimp"></a><a name="p7264mcpsimp"></a><span xml:lang="en-US" id="ph7265mcpsimp"><a name="ph7265mcpsimp"></a><a name="ph7265mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7267mcpsimp"><a name="ph7267mcpsimp"></a><a name="ph7267mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7353mcpsimp"><a name="p7353mcpsimp"></a><a name="p7353mcpsimp"></a><span xml:lang="en-US" id="ph7354mcpsimp"><a name="ph7354mcpsimp"></a><a name="ph7354mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7356mcpsimp"><a name="ph7356mcpsimp"></a><a name="ph7356mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7364mcpsimp"><a name="p7364mcpsimp"></a><a name="p7364mcpsimp"></a><span xml:lang="en-US" id="ph7365mcpsimp"><a name="ph7365mcpsimp"></a><a name="ph7365mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7367mcpsimp"><a name="ph7367mcpsimp"></a><a name="ph7367mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7453mcpsimp"><a name="p7453mcpsimp"></a><a name="p7453mcpsimp"></a><span xml:lang="en-US" id="ph7454mcpsimp"><a name="ph7454mcpsimp"></a><a name="ph7454mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7456mcpsimp"><a name="ph7456mcpsimp"></a><a name="ph7456mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7464mcpsimp"><a name="p7464mcpsimp"></a><a name="p7464mcpsimp"></a><span xml:lang="en-US" id="ph7465mcpsimp"><a name="ph7465mcpsimp"></a><a name="ph7465mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7467mcpsimp"><a name="ph7467mcpsimp"></a><a name="ph7467mcpsimp"></a>)</span></p>
</td>
...
-   [ss\_mpi\_vi\_set\_chn\_ldc\_attr](#ss_mpi_vi_set_chn_ldc_attr)
-   [ss\_mpi\_vi\_get\_chn\_ldc\_attr](#ss_mpi_vi_get_chn_ldc_attr)
-   [ss\_mpi\_vi\_get\_chn\_spread\_attr](#ss_mpi_vi_get_chn_spread_attr)
...
<p xml:lang="sv-SE" id="p7553mcpsimp"><a name="p7553mcpsimp"></a><a name="p7553mcpsimp"></a><span xml:lang="en-US" id="ph7554mcpsimp"><a name="ph7554mcpsimp"></a><a name="ph7554mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7556mcpsimp"><a name="ph7556mcpsimp"></a><a name="ph7556mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7564mcpsimp"><a name="p7564mcpsimp"></a><a name="p7564mcpsimp"></a><span xml:lang="en-US" id="ph7565mcpsimp"><a name="ph7565mcpsimp"></a><a name="ph7565mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7567mcpsimp"><a name="ph7567mcpsimp"></a><a name="ph7567mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7646mcpsimp"><a name="p7646mcpsimp"></a><a name="p7646mcpsimp"></a><span xml:lang="en-US" id="ph7647mcpsimp"><a name="ph7647mcpsimp"></a><a name="ph7647mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7649mcpsimp"><a name="ph7649mcpsimp"></a><a name="ph7649mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7657mcpsimp"><a name="p7657mcpsimp"></a><a name="p7657mcpsimp"></a><span xml:lang="en-US" id="ph7658mcpsimp"><a name="ph7658mcpsimp"></a><a name="ph7658mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7660mcpsimp"><a name="ph7660mcpsimp"></a><a name="ph7660mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_get\_chn\_fisheye](#ss_mpi_vi_get_chn_fisheye)
...
<p xml:lang="sv-SE" id="p7743mcpsimp"><a name="p7743mcpsimp"></a><a name="p7743mcpsimp"></a><span xml:lang="en-US" id="ph7744mcpsimp"><a name="ph7744mcpsimp"></a><a name="ph7744mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7746mcpsimp"><a name="ph7746mcpsimp"></a><a name="ph7746mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7754mcpsimp"><a name="p7754mcpsimp"></a><a name="p7754mcpsimp"></a><span xml:lang="en-US" id="ph7755mcpsimp"><a name="ph7755mcpsimp"></a><a name="ph7755mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7757mcpsimp"><a name="ph7757mcpsimp"></a><a name="ph7757mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_set\_chn\_fisheye](#ss_mpi_vi_set_chn_fisheye)
...
<p xml:lang="sv-SE" id="p7833mcpsimp"><a name="p7833mcpsimp"></a><a name="p7833mcpsimp"></a><span xml:lang="en-US" id="ph7834mcpsimp"><a name="ph7834mcpsimp"></a><a name="ph7834mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph7836mcpsimp"><a name="ph7836mcpsimp"></a><a name="ph7836mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7844mcpsimp"><a name="p7844mcpsimp"></a><a name="p7844mcpsimp"></a><span xml:lang="en-US" id="ph7845mcpsimp"><a name="ph7845mcpsimp"></a><a name="ph7845mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7847mcpsimp"><a name="ph7847mcpsimp"></a><a name="ph7847mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p7952mcpsimp"><a name="p7952mcpsimp"></a><a name="p7952mcpsimp"></a><span xml:lang="en-US" id="ph7953mcpsimp"><a name="ph7953mcpsimp"></a><a name="ph7953mcpsimp"></a>取值范围：[0,</span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph7955mcpsimp"><a name="ph7955mcpsimp"></a><a name="ph7955mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8067mcpsimp"><a name="p8067mcpsimp"></a><a name="p8067mcpsimp"></a><span xml:lang="en-US" id="ph8068mcpsimp"><a name="ph8068mcpsimp"></a><a name="ph8068mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8070mcpsimp"><a name="ph8070mcpsimp"></a><a name="ph8070mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_get\_chn\_dis\_cfg](#ss_mpi_vi_get_chn_dis_cfg)
...
<p xml:lang="sv-SE" id="p8148mcpsimp"><a name="p8148mcpsimp"></a><a name="p8148mcpsimp"></a><span xml:lang="en-US" id="ph8149mcpsimp"><a name="ph8149mcpsimp"></a><a name="ph8149mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8151mcpsimp"><a name="ph8151mcpsimp"></a><a name="ph8151mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8159mcpsimp"><a name="p8159mcpsimp"></a><a name="p8159mcpsimp"></a><span xml:lang="en-US" id="ph8160mcpsimp"><a name="ph8160mcpsimp"></a><a name="ph8160mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8162mcpsimp"><a name="ph8162mcpsimp"></a><a name="ph8162mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_set\_chn\_dis\_cfg](#ss_mpi_vi_set_chn_dis_cfg)
...
<p xml:lang="sv-SE" id="p8250mcpsimp"><a name="p8250mcpsimp"></a><a name="p8250mcpsimp"></a><span xml:lang="en-US" id="ph8251mcpsimp"><a name="ph8251mcpsimp"></a><a name="ph8251mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8253mcpsimp"><a name="ph8253mcpsimp"></a><a name="ph8253mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8340mcpsimp"><a name="p8340mcpsimp"></a><a name="p8340mcpsimp"></a><span xml:lang="en-US" id="ph8341mcpsimp"><a name="ph8341mcpsimp"></a><a name="ph8341mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8343mcpsimp"><a name="ph8343mcpsimp"></a><a name="ph8343mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8351mcpsimp"><a name="p8351mcpsimp"></a><a name="p8351mcpsimp"></a><span xml:lang="en-US" id="ph8352mcpsimp"><a name="ph8352mcpsimp"></a><a name="ph8352mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8354mcpsimp"><a name="ph8354mcpsimp"></a><a name="ph8354mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8442mcpsimp"><a name="p8442mcpsimp"></a><a name="p8442mcpsimp"></a><span xml:lang="en-US" id="ph8443mcpsimp"><a name="ph8443mcpsimp"></a><a name="ph8443mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8445mcpsimp"><a name="ph8445mcpsimp"></a><a name="ph8445mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8526mcpsimp"><a name="p8526mcpsimp"></a><a name="p8526mcpsimp"></a><span xml:lang="en-US" id="ph8527mcpsimp"><a name="ph8527mcpsimp"></a><a name="ph8527mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8529mcpsimp"><a name="ph8529mcpsimp"></a><a name="ph8529mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8537mcpsimp"><a name="p8537mcpsimp"></a><a name="p8537mcpsimp"></a><span xml:lang="en-US" id="ph8538mcpsimp"><a name="ph8538mcpsimp"></a><a name="ph8538mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8540mcpsimp"><a name="ph8540mcpsimp"></a><a name="ph8540mcpsimp"></a>)</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="62%" headers="mcps1.1.4.1.2 "><p id="p8238mcpsimp"><a name="p8238mcpsimp"></a><a name="p8238mcpsimp"></a>PIPE号。</p>
<p xml:lang="sv-SE" id="p8239mcpsimp"><a name="p8239mcpsimp"></a><a name="p8239mcpsimp"></a>取值范围：[0, <a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a>)</p>
</td>
<td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.3 "><p id="p8244mcpsimp"><a name="p8244mcpsimp"></a><a name="p8244mcpsimp"></a>输入</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62%" headers="mcps1.1.4.1.2 "><p id="p8249mcpsimp"><a name="p8249mcpsimp"></a><a name="p8249mcpsimp"></a>VI通道号。</p>
<p xml:lang="sv-SE" id="p8250mcpsimp"><a name="p8250mcpsimp"></a><a name="p8250mcpsimp"></a>取值范围：[0, <a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a>)</p>
</td>
<td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.3 "><p id="p8255mcpsimp"><a name="p8255mcpsimp"></a><a name="p8255mcpsimp"></a>输入</p>
</td>
</tr>
...
[ss\_mpi\_vi\_get\_chn\_dis\_wdr\_attr](#ss_mpi_vi_get_chn_dis_wdr_attr)
...
<td class="cellrowborder" valign="top" width="62%" headers="mcps1.1.4.1.2 "><p id="p8339mcpsimp"><a name="p8339mcpsimp"></a><a name="p8339mcpsimp"></a>PIPE号。</p>
<p xml:lang="sv-SE" id="p8340mcpsimp"><a name="p8340mcpsimp"></a><a name="p8340mcpsimp"></a>取值范围：[0, <a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a>)</p>
</td>
<td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.3 "><p id="p8345mcpsimp"><a name="p8345mcpsimp"></a><a name="p8345mcpsimp"></a>输入</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62%" headers="mcps1.1.4.1.2 "><p id="p8350mcpsimp"><a name="p8350mcpsimp"></a><a name="p8350mcpsimp"></a>VI通道号。</p>
<p xml:lang="sv-SE" id="p8351mcpsimp"><a name="p8351mcpsimp"></a><a name="p8351mcpsimp"></a>取值范围：[0, <a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a>)</p>
</td>
<td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.3 "><p id="p8356mcpsimp"><a name="p8356mcpsimp"></a><a name="p8356mcpsimp"></a>输入</p>
</td>
</tr>
...
[ss\_mpi\_vi\_set\_chn\_dis\_wdr\_attr](#ss_mpi_vi_set_chn_dis_wdr_attr)
...
<p xml:lang="sv-SE" id="p8620mcpsimp"><a name="p8620mcpsimp"></a><a name="p8620mcpsimp"></a><span xml:lang="en-US" id="ph8621mcpsimp"><a name="ph8621mcpsimp"></a><a name="ph8621mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8623mcpsimp"><a name="ph8623mcpsimp"></a><a name="ph8623mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8631mcpsimp"><a name="p8631mcpsimp"></a><a name="p8631mcpsimp"></a><span xml:lang="en-US" id="ph8632mcpsimp"><a name="ph8632mcpsimp"></a><a name="ph8632mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8634mcpsimp"><a name="ph8634mcpsimp"></a><a name="ph8634mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_get\_chn\_fov\_correction\_attr](#ss_mpi_vi_get_chn_fov_correction_attr)
...
<p xml:lang="sv-SE" id="p8712mcpsimp"><a name="p8712mcpsimp"></a><a name="p8712mcpsimp"></a><span xml:lang="en-US" id="ph8713mcpsimp"><a name="ph8713mcpsimp"></a><a name="ph8713mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8715mcpsimp"><a name="ph8715mcpsimp"></a><a name="ph8715mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8723mcpsimp"><a name="p8723mcpsimp"></a><a name="p8723mcpsimp"></a><span xml:lang="en-US" id="ph8724mcpsimp"><a name="ph8724mcpsimp"></a><a name="ph8724mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph8726mcpsimp"><a name="ph8726mcpsimp"></a><a name="ph8726mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_set\_chn\_fov\_correction\_attr](#ss_mpi_vi_set_chn_fov_correction_attr)
...
<p xml:lang="sv-SE" id="p8802mcpsimp"><a name="p8802mcpsimp"></a><a name="p8802mcpsimp"></a><span xml:lang="en-US" id="ph8803mcpsimp"><a name="ph8803mcpsimp"></a><a name="ph8803mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8805mcpsimp"><a name="ph8805mcpsimp"></a><a name="ph8805mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p8813mcpsimp"><a name="p8813mcpsimp"></a><a name="p8813mcpsimp"></a><span xml:lang="en-US" id="ph8814mcpsimp"><a name="ph8814mcpsimp"></a><a name="ph8814mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph8816mcpsimp"><a name="ph8816mcpsimp"></a><a name="ph8816mcpsimp"></a>)</span></p>
</td>
...
-   获取的物理地址信息来自MPP内部使用的VideoBuffer，因此使用完之后，必须要调用[ss\_mpi\_vi\_release\_chn\_frame](ss_mpi_vi_release_chn_frame.md)  接口释放其内存。
...
-   [ss\_mpi\_vi\_release\_chn\_frame](#ss_mpi_vi_release_chn_frame)
-   [ss\_mpi\_vi\_set\_chn\_attr](#ss_mpi_vi_set_chn_attr)
...
<p xml:lang="sv-SE" id="p8913mcpsimp"><a name="p8913mcpsimp"></a><a name="p8913mcpsimp"></a><span xml:lang="en-US" id="ph8914mcpsimp"><a name="ph8914mcpsimp"></a><a name="ph8914mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph8916mcpsimp"><a name="ph8916mcpsimp"></a><a name="ph8916mcpsimp"></a>)</span></p>
...
<p xml:lang="sv-SE" id="p8925mcpsimp"><a name="p8925mcpsimp"></a><a name="p8925mcpsimp"></a><span xml:lang="en-US" id="ph8926mcpsimp"><a name="ph8926mcpsimp"></a><a name="ph8926mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph8928mcpsimp"><a name="ph8928mcpsimp"></a><a name="ph8928mcpsimp"></a>)</span></p>
...
-   此接口必须与[ss\_mpi\_vi\_get\_chn\_frame](ss_mpi_vi_get_chn_frame.md)配对使用。
-   用户必须保证frame\_info结构中的信息与获取时一致，否则可能造成释放不成功。
...
[ss\_mpi\_vi\_get\_chn\_frame](#ss_mpi_vi_get_chn_frame)
...
<p xml:lang="sv-SE" id="p9006mcpsimp"><a name="p9006mcpsimp"></a><a name="p9006mcpsimp"></a><span xml:lang="en-US" id="ph9007mcpsimp"><a name="ph9007mcpsimp"></a><a name="ph9007mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9009mcpsimp"><a name="ph9009mcpsimp"></a><a name="ph9009mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9017mcpsimp"><a name="p9017mcpsimp"></a><a name="p9017mcpsimp"></a><span xml:lang="en-US" id="ph9018mcpsimp"><a name="ph9018mcpsimp"></a><a name="ph9018mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9020mcpsimp"><a name="ph9020mcpsimp"></a><a name="ph9020mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9096mcpsimp"><a name="p9096mcpsimp"></a><a name="p9096mcpsimp"></a><span xml:lang="en-US" id="ph9097mcpsimp"><a name="ph9097mcpsimp"></a><a name="ph9097mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9099mcpsimp"><a name="ph9099mcpsimp"></a><a name="ph9099mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9107mcpsimp"><a name="p9107mcpsimp"></a><a name="p9107mcpsimp"></a><span xml:lang="en-US" id="ph9108mcpsimp"><a name="ph9108mcpsimp"></a><a name="ph9108mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9110mcpsimp"><a name="ph9110mcpsimp"></a><a name="ph9110mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9183mcpsimp"><a name="p9183mcpsimp"></a><a name="p9183mcpsimp"></a><span xml:lang="en-US" id="ph9184mcpsimp"><a name="ph9184mcpsimp"></a><a name="ph9184mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9186mcpsimp"><a name="ph9186mcpsimp"></a><a name="ph9186mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9194mcpsimp"><a name="p9194mcpsimp"></a><a name="p9194mcpsimp"></a><span xml:lang="en-US" id="ph9195mcpsimp"><a name="ph9195mcpsimp"></a><a name="ph9195mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9197mcpsimp"><a name="ph9197mcpsimp"></a><a name="ph9197mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_get\_chn\_align](#ss_mpi_vi_get_chn_align)
...
<p xml:lang="sv-SE" id="p9278mcpsimp"><a name="p9278mcpsimp"></a><a name="p9278mcpsimp"></a><span xml:lang="en-US" id="ph9279mcpsimp"><a name="ph9279mcpsimp"></a><a name="ph9279mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9281mcpsimp"><a name="ph9281mcpsimp"></a><a name="ph9281mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9289mcpsimp"><a name="p9289mcpsimp"></a><a name="p9289mcpsimp"></a><span xml:lang="en-US" id="ph9290mcpsimp"><a name="ph9290mcpsimp"></a><a name="ph9290mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9292mcpsimp"><a name="ph9292mcpsimp"></a><a name="ph9292mcpsimp"></a>)</span></p>
</td>
...
[ss\_mpi\_vi\_set\_chn\_align](#ss_mpi_vi_set_chn_align)
...
<p xml:lang="sv-SE" id="p9368mcpsimp"><a name="p9368mcpsimp"></a><a name="p9368mcpsimp"></a><span xml:lang="en-US" id="ph9369mcpsimp"><a name="ph9369mcpsimp"></a><a name="ph9369mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9371mcpsimp"><a name="ph9371mcpsimp"></a><a name="ph9371mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9379mcpsimp"><a name="p9379mcpsimp"></a><a name="p9379mcpsimp"></a><span xml:lang="en-US" id="ph9380mcpsimp"><a name="ph9380mcpsimp"></a><a name="ph9380mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9382mcpsimp"><a name="ph9382mcpsimp"></a><a name="ph9382mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9454mcpsimp"><a name="p9454mcpsimp"></a><a name="p9454mcpsimp"></a><span xml:lang="en-US" id="ph9455mcpsimp"><a name="ph9455mcpsimp"></a><a name="ph9455mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9457mcpsimp"><a name="ph9457mcpsimp"></a><a name="ph9457mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9465mcpsimp"><a name="p9465mcpsimp"></a><a name="p9465mcpsimp"></a><span xml:lang="en-US" id="ph9466mcpsimp"><a name="ph9466mcpsimp"></a><a name="ph9466mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9468mcpsimp"><a name="ph9468mcpsimp"></a><a name="ph9468mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9539mcpsimp"><a name="p9539mcpsimp"></a><a name="p9539mcpsimp"></a><span xml:lang="en-US" id="ph9540mcpsimp"><a name="ph9540mcpsimp"></a><a name="ph9540mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9542mcpsimp"><a name="ph9542mcpsimp"></a><a name="ph9542mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9550mcpsimp"><a name="p9550mcpsimp"></a><a name="p9550mcpsimp"></a><span xml:lang="en-US" id="ph9551mcpsimp"><a name="ph9551mcpsimp"></a><a name="ph9551mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9553mcpsimp"><a name="ph9553mcpsimp"></a><a name="ph9553mcpsimp"></a>)</span></p>
</td>
...
-   vb\_pool必须保证是已创建VB池的有效PoolId。
-   在调用[ss\_mpi\_vi\_chn\_detach\_vb\_pool](ss_mpi_vi_chn_detach_vb_pool.md)后，销毁创建的VB之前，需要保证VB没有被VI后端绑定的模块使用，可以通过sleep或清除后端模块通道缓存的方式先把VB都释放，再销毁缓存VB池。
-   需要配合[ss\_mpi\_vi\_chn\_set\_vb\_src](ss_mpi_vi_chn_set_vb_src.md)接口使用，可以动态切换。
    -   使用绑定用户VB池的方式，必须设置vb\_src为OT\_VB\_SRC\_USER。
    -   使用公共VB池的方式，必须设置vb\_src为OT\_VB\_SRC\_COMMON。
...
-   [ss\_mpi\_vi\_chn\_detach\_vb\_pool](#ss_mpi_vi_chn_detach_vb_pool)
-   [ss\_mpi\_vi\_set\_mod\_param](#ss_mpi_vi_set_mod_param)
...
<p xml:lang="sv-SE" id="p9647mcpsimp"><a name="p9647mcpsimp"></a><a name="p9647mcpsimp"></a><span xml:lang="en-US" id="ph9648mcpsimp"><a name="ph9648mcpsimp"></a><a name="ph9648mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9650mcpsimp"><a name="ph9650mcpsimp"></a><a name="ph9650mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9658mcpsimp"><a name="p9658mcpsimp"></a><a name="p9658mcpsimp"></a><span xml:lang="en-US" id="ph9659mcpsimp"><a name="ph9659mcpsimp"></a><a name="ph9659mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9661mcpsimp"><a name="ph9661mcpsimp"></a><a name="ph9661mcpsimp"></a>)</span></p>
</td>
...
-   [ss\_mpi\_vi\_chn\_attach\_vb\_pool](#ss_mpi_vi_chn_attach_vb_pool)
-   [ss\_mpi\_vi\_set\_mod\_param](#ss_mpi_vi_set_mod_param)
...
<p xml:lang="sv-SE" id="p9743mcpsimp"><a name="p9743mcpsimp"></a><a name="p9743mcpsimp"></a><span xml:lang="en-US" id="ph9744mcpsimp"><a name="ph9744mcpsimp"></a><a name="ph9744mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a><span xml:lang="en-US" id="ph9746mcpsimp"><a name="ph9746mcpsimp"></a><a name="ph9746mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9817mcpsimp"><a name="p9817mcpsimp"></a><a name="p9817mcpsimp"></a><span xml:lang="en-US" id="ph9818mcpsimp"><a name="ph9818mcpsimp"></a><a name="ph9818mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a><span xml:lang="en-US" id="ph9820mcpsimp"><a name="ph9820mcpsimp"></a><a name="ph9820mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9828mcpsimp"><a name="p9828mcpsimp"></a><a name="p9828mcpsimp"></a><span xml:lang="en-US" id="ph9829mcpsimp"><a name="ph9829mcpsimp"></a><a name="ph9829mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_CHN_NUM.md">OT_VI_MAX_CHN_NUM</a><span xml:lang="en-US" id="ph9831mcpsimp"><a name="ph9831mcpsimp"></a><a name="ph9831mcpsimp"></a>)</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9893mcpsimp"><a name="p9893mcpsimp"></a><a name="p9893mcpsimp"></a><span xml:lang="en-US" id="ph9894mcpsimp"><a name="ph9894mcpsimp"></a><a name="ph9894mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_STITCH_GRP_NUM.md">OT_VI_MAX_STITCH_GRP_NUM</a><span xml:lang="en-US" id="ph9896mcpsimp"><a name="ph9896mcpsimp"></a><a name="ph9896mcpsimp"></a>)。</span></p>
</td>
...
<p xml:lang="sv-SE" id="p9976mcpsimp"><a name="p9976mcpsimp"></a><a name="p9976mcpsimp"></a><span xml:lang="en-US" id="ph9977mcpsimp"><a name="ph9977mcpsimp"></a><a name="ph9977mcpsimp"></a>取值范围：[0, </span><a href="OT_VI_MAX_STITCH_GRP_NUM.md">OT_VI_MAX_STITCH_GRP_NUM</a><span xml:lang="en-US" id="ph9979mcpsimp"><a name="ph9979mcpsimp"></a><a name="ph9979mcpsimp"></a>)。</span></p>
</td>
...
<p id="p1697155175511"><a name="p1697155175511"></a><a name="p1697155175511"></a>取值范围：[0, <a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a>)</p>
</td>
...
<p id="p149718517558"><a name="p149718517558"></a><a name="p149718517558"></a>取值范围：[0, <a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
[ss\_mpi\_vi\_chn\_get\_zoom\_in\_window](#ss_mpi_vi_chn_get_zoom_in_window)
...
<p id="p192593013720"><a name="p192593013720"></a><a name="p192593013720"></a>取值范围：[0, <a href="OT_VI_MAX_PIPE_NUM.md">OT_VI_MAX_PIPE_NUM</a>)</p>
</td>
...
<p id="p172533019716"><a name="p172533019716"></a><a name="p172533019716"></a>取值范围：[0, <a href="OT_VI_MAX_PHYS_CHN_NUM.md">OT_VI_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
[ss\_mpi\_vi\_chn\_set\_zoom\_in\_window](#ss_mpi_vi_chn_set_zoom_in_window)

## 数据类型<a name="ZH-CN_TOPIC_0000002408258714"></a>

视频输入相关数据类型定义如下：

-   [OT\_VI\_MAX\_SNS\_CFG\_NUM](OT_VI_MAX_SNS_CFG_NUM.md): 时序配置数据的最大个数。
-   [OT\_VI\_MAX\_SD\_MUX\_NUM](OT_VI_MAX_SD_MUX_NUM.md): SD管脚复用的最大个数。
-   [OT\_VI\_MAX\_DEV\_NUM](OT_VI_MAX_DEV_NUM.md)：定义VI设备的最大个数。
-   [OT\_VI\_MAX\_PHYS\_PIPE\_NUM](OT_VI_MAX_PHYS_PIPE_NUM.md)：定义VI 物理PIPE的最大个数。
-   [OT\_VI\_MAX\_VIRT\_PIPE\_NUM](OT_VI_MAX_VIRT_PIPE_NUM.md)：定义VI 虚拟PIPE的最大个数。
-   [OT\_VI\_MAX\_PIPE\_NUM](OT_VI_MAX_PIPE_NUM.md)：定义VI PIPE的最大个数。
-   [OT\_VI\_MAX\_STITCH\_GRP\_NUM](OT_VI_MAX_STITCH_GRP_NUM.md)：定义VI拼接组的最大个数。
-   [OT\_VI\_MAX\_WDR\_FUSION\_GRP\_NUM](OT_VI_MAX_WDR_FUSION_GRP_NUM.md)：定义VI WDR融合组的最大个数。
-   [OT\_VI\_MAX\_WDR\_FRAME\_NUM](OT_VI_MAX_WDR_FRAME_NUM.md): 定义VI WDR融合组合成帧的最大个数。
-   [OT\_VI\_MAX\_PHYS\_CHN\_NUM](OT_VI_MAX_PHYS_CHN_NUM.md)：定义VI物理通道的最大个数。
-   [OT\_VI\_MAX\_EXT\_CHN\_NUM](OT_VI_MAX_EXT_CHN_NUM.md)：定义VI扩展通道的最大个数。
-   [OT\_VI\_EXT\_CHN\_START](OT_VI_EXT_CHN_START.md)：定义VI扩展通道的起始通道号。
-   [OT\_VI\_MAX\_EXTCHN\_BIND\_PER\_CHN](OT_VI_MAX_EXTCHN_BIND_PER_CHN.md)：定义VI单个通道可绑定的扩展通道最大个数。
-   [OT\_VI\_MAX\_CHN\_NUM](OT_VI_MAX_CHN_NUM.md)：定义VI物理通道和扩展通道的总个数。
-   [OT\_VI\_DEV\_MIN\_WIDTH](OT_VI_DEV_MIN_WIDTH.md)：VI设备捕获图像的最小宽度。
-   [OT\_VI\_DEV\_MIN\_HEIGHT](OT_VI_DEV_MIN_HEIGHT.md)：VI设备捕获图像的最小高度。
-   [OT\_VI\_DEV\_MAX\_WIDTH](OT_VI_DEV_MAX_WIDTH.md)：VI设备捕获图像的最大宽度。
-   [OT\_VI\_DEV\_MAX\_HEIGHT](OT_VI_DEV_MAX_HEIGHT.md)：VI设备捕获图像的最大高度。
-   [OT\_VI\_PIPE\_OFFLINE\_MIN\_WIDTH](OT_VI_PIPE_OFFLINE_MIN_WIDTH.md)：VI PIPE离线处理图像的最小宽度。
-   [OT\_VI\_PIPE\_OFFLINE\_MIN\_HEIGHT](OT_VI_PIPE_OFFLINE_MIN_HEIGHT.md)：VI PIPE离线处理图像的最小高度。
-   [OT\_VI\_PIPE\_OFFLINE\_MAX\_WIDTH](OT_VI_PIPE_OFFLINE_MAX_WIDTH.md)：离线模式下VI PIPE处理图像的最大宽度。
-   [OT\_VI\_PIPE\_OFFLINE\_MAX\_HEIGHT](OT_VI_PIPE_OFFLINE_MAX_HEIGHT.md)：VI PIPE离线处理图像的最大高度。
-   [OT\_VI\_PIPE\_ONLINE\_MIN\_WIDTH](OT_VI_PIPE_ONLINE_MIN_WIDTH.md)：在线模式下VI PIPE处理图像的最小宽度。
-   [OT\_VI\_PIPE\_ONLINE\_MIN\_HEIGHT](OT_VI_PIPE_ONLINE_MIN_HEIGHT.md)：在线模式下VI PIPE处理图像的最小高度。
-   [OT\_VI\_PIPE\_ONLINE\_MAX\_WIDTH](OT_VI_PIPE_ONLINE_MAX_WIDTH.md)：在线模式下VI PIPE处理图像的最大宽度。
-   [OT\_VI\_PIPE\_ONLINE\_MAX\_HEIGHT](OT_VI_PIPE_ONLINE_MAX_HEIGHT.md)：在线模式下VI PIPE处理图像的最大高度。
-   [OT\_VI\_PHYS\_CHN\_OFFLINE\_MIN\_WIDTH](OT_VI_PHYS_CHN_OFFLINE_MIN_WIDTH.md)：VI物理通道离线支持的最小宽度。
-   [OT\_VI\_PHYS\_CHN\_OFFLINE\_MIN\_HEIGHT](OT_VI_PHYS_CHN_OFFLINE_MIN_HEIGHT.md)：VI物理通道离线支持的最小高度。
-   [OT\_VI\_PHYS\_CHN\_OFFLINE\_MAX\_WIDTH](OT_VI_PHYS_CHN_OFFLINE_MAX_WIDTH.md)：VI物理通道离线支持的最大宽度。
-   [OT\_VI\_PHYS\_CHN\_OFFLINE\_MAX\_HEIGHT](OT_VI_PHYS_CHN_OFFLINE_MAX_HEIGHT.md)：VI物理通道离线支持的最大高度。
-   [OT\_VI\_PHYS\_CHN\_ONLINE\_MIN\_WIDTH](OT_VI_PHYS_CHN_ONLINE_MIN_WIDTH.md)：VI物理通道在线支持的最小宽度。
-   [OT\_VI\_PHYS\_CHN\_ONLINE\_MIN\_HEIGHT](OT_VI_PHYS_CHN_ONLINE_MIN_HEIGHT.md)：VI物理通道在线支持的最小高度。
-   [OT\_VI\_PHYS\_CHN\_ONLINE\_MAX\_WIDTH](OT_VI_PHYS_CHN_ONLINE_MAX_WIDTH.md)：VI物理通道在线支持的最大宽度。
-   [OT\_VI\_PHYS\_CHN\_ONLINE\_MAX\_HEIGHT](OT_VI_PHYS_CHN_ONLINE_MAX_HEIGHT.md)：VI物理通道在线支持的最大高度。
-   [OT\_VI\_EXT\_CHN\_MIN\_WIDTH](OT_VI_EXT_CHN_MIN_WIDTH.md)：VI扩展通道支持的最小宽度。
-   [OT\_VI\_EXT\_CHN\_MIN\_HEIGHT](OT_VI_EXT_CHN_MIN_HEIGHT.md)：VI扩展通道支持的最小高度。
-   [OT\_VI\_EXT\_CHN\_MAX\_WIDTH](OT_VI_EXT_CHN_MAX_WIDTH.md)：VI扩展通道支持的最大宽度。
-   [OT\_VI\_EXT\_CHN\_MAX\_HEIGHT](OT_VI_EXT_CHN_MAX_HEIGHT.md)：VI扩展通道支持的最大高度。
-   [OT\_VI\_EXT\_CHN\_MAX\_ZOOMIN](OT_VI_EXT_CHN_MAX_ZOOMIN.md)：VI扩展通道支持的最大放大倍数。
-   [OT\_VI\_EXT\_CHN\_MAX\_ZOOMOUT](OT_VI_EXT_CHN_MAX_ZOOMOUT.md)：VI扩展通道支持的最大缩小倍数。
-   [OT\_VI\_COMPRESS\_PARAM\_SIZE](OT_VI_COMPRESS_PARAM_SIZE.md)：VI RAW数据压缩参数的大小。
-   [OT\_VI\_COMPRESS\_PARAM\_SIZE](OT_VI_COMPRESS_PARAM_SIZE.md)：VI RAW数据压缩参数的大小。
-   [OT\_VI\_MIN\_BNR\_BUF\_NUM](OT_VI_MIN_BNR_BUF_NUM.md)：VI bayernr buffer个数的最小值。
-   [OT\_VI\_MAX\_BNR\_BUF\_NUM](OT_VI_MAX_BNR_BUF_NUM.md)：VI bayernr buffer个数的最大值。
-   [OT\_VI\_MAX\_AD\_CHN\_NUM](OT_VI_MAX_AD_CHN_NUM.md)：VI设备属性中ad\_chn\_id的个数。
-   [OT\_VI\_COMPONENT\_MASK\_NUM](OT_VI_COMPONENT_MASK_NUM.md)：VI设备属性中Component mask 的个数。
-   [OT\_VI\_INVALID\_FRAME\_RATE](OT_VI_INVALID_FRAME_RATE.md)：VI帧率控制的宏，当原始帧率和目标帧率都为该宏时，不做帧率控制。
-   [OT\_VI\_CORRECTION\_COEF\_NUM](OT_VI_CORRECTION_COEF_NUM.md)：通道视场角矫正时PMF系数大小。
-   [ot\_vi\_intf\_mode](ot_vi_intf_mode.md)：定义视频设备的接口模式。
-   [ot\_vi\_work\_mode](ot_vi_work_mode.md)：定义视频设备的复合工作模式。
-   [ot\_vi\_scan\_mode](ot_vi_scan_mode.md)：定义视频设备接收的是隔行或逐行输入图像。
-   [ot\_vi\_data\_seq](ot_vi_data_seq.md)：定义视频设备接收的YUV数据的数据排列顺序。
-   [ot\_vi\_vsync](ot_vi_vsync.md)：定义视频设备输入数据的垂直同步信号类型。
-   [ot\_vi\_vsync\_neg](ot_vi_vsync_neg.md)：定义视频设备输入数据垂直同步信号的极性。
-   [ot\_vi\_hsync](ot_vi_hsync.md)：定义视频设备输入数据的水平同步信号类型。
-   [ot\_vi\_hsync\_neg](ot_vi_hsync_neg.md)：定义视频设备输入数据水平同步信号的极性。
-   [ot\_vi\_vsync\_valid](ot_vi_vsync_valid.md)：定义视频设备输入数据的垂直有效同步信号类型。
-   [ot\_vi\_vsync\_valid\_neg](ot_vi_vsync_valid_neg.md)：定义视频设备输入数据垂直有效同步信号的极性。
-   [ot\_vi\_timing\_blank](ot_vi_timing_blank.md)：定义视频设备输入时序的消隐信息。
-   [ot\_vi\_sync\_cfg](ot_vi_sync_cfg.md)：定义视频设备接收BT.601、DC、BT.656和BT.1120时序的同步信息。
-   [ot\_vi\_data\_type](ot_vi_data_type.md)：VI输入数据类型枚举。
-   [ot\_vi\_dev\_attr](ot_vi_dev_attr.md)：定义视频输入设备的属性。
-   [ot\_vi\_rephase\_mode](ot_vi_rephase_mode.md)：定义bayer域相位调整类型。
-   [ot\_vi\_rephase\_attr](ot_vi_rephase_attr.md)：定义bayer域相位调整属性。
-   [ot\_vi\_scale\_attr](ot_vi_scale_attr.md)：定义bayer域缩放属性。
-   [ot\_vi\_bas\_attr](ot_vi_bas_attr.md)：定义bayer域属性。
-   [ot\_vi\_thermo\_work\_mode](ot_vi_thermo_work_mode.md): 定义热成像探测器的工作类型。
-   [ot\_vi\_sd\_mux](ot_vi_sd_mux.md): 定义热成像输出的管脚乱序。
-   [ot\_vi\_thermo\_sns\_attr](ot_vi_thermo_sns_attr.md): 定义热成像探测器的配置属性。
-   [ot\_vi\_dev\_timing\_attr](ot_vi_dev_timing_attr.md)：定义VI DEV自产生时序属性。
-   [ot\_vi\_dev\_data\_attr](ot_vi_dev_data_attr.md)：定义VI DEV自产生数据属性。
-   [ot\_vi\_bind\_pipe](ot_vi_bind_pipe.md)：定义VI DEV与PIPE的绑定关系。
-   [ot\_vi\_wdr\_fusion\_grp\_attr](ot_vi_wdr_fusion_grp_attr.md)：定义wdr 融合组的属性。
-   [ot\_vi\_pipe\_bypass\_mode](ot_vi_pipe_bypass_mode.md)：定义VI PIPE的Bypass模式。
-   [ot\_vi\_bit\_align\_mode](ot_vi_bit_align_mode.md)：定义VI PIPE写出16bit Raw时是高/低位对齐。
-   [ot\_vi\_pipe\_attr](ot_vi_pipe_attr.md)：定义VI PIPE属性。
-   [ot\_vi\_frame\_dump\_attr](ot_vi_frame_dump_attr.md)：定义VI PIPE dump frame属性。
-   [ot\_vi\_private\_data\_mode](ot_vi_private_data_mode.md)：定义VI PIPE dump 私有数据的类型。
-   [ot\_vi\_private\_data\_dump\_attr](ot_vi_private_data_dump_attr.md)：定义VI PIPE dump私有数据的属性。
-   [ot\_vi\_private\_data\_info](ot_vi_private_data_info.md)：定义VI PIPE 私有数据相关的信息。
-   [ot\_vi\_pipe\_param](ot_vi_pipe_param.md)：定义VI PIPE参数。
-   [ot\_vi\_pipe\_frame\_source](ot_vi_pipe_frame_source.md)：定义VI PIPE输入帧的来源。
-   [ot\_vi\_pipe\_status](ot_vi_pipe_status.md)：定义VI PIPE的运行状态。
-   [ot\_vi\_compress\_param](ot_vi_compress_param.md)：定义压缩参数的大小。
-   [ot\_vi\_chn\_attr](ot_vi_chn_attr.md)：定义VI通道的属性。
-   [ot\_vi\_ext\_chn\_attr](ot_vi_ext_chn_attr.md)：定义VI扩展通道的属性。
-   [ot\_vi\_crop\_info](ot_vi_crop_info.md)：定义VI通道的crop信息。
-   [ot\_vi\_chn\_status](ot_vi_chn_status.md)：定义VI通道的运行状态。
-   [ot\_vi\_stitch\_cfg\_mode](ot_vi_stitch_cfg_mode.md)：定义VI拼接的配置模式。
-   [ot\_vi\_stitch\_grp\_attr](ot_vi_stitch_grp_attr.md)：定义VI拼接组的属性。
-   [ot\_vi\_mod\_param](ot_vi_mod_param.md)：定义VI的模块参数。
-   [OT\_DIS\_MAX\_IMAGE\_WIDTH](OT_DIS_MAX_IMAGE_WIDTH.md)：定义DIS的最大图像宽度。
-   [OT\_DIS\_MAX\_IMAGE\_HEIGHT](OT_DIS_MAX_IMAGE_HEIGHT.md)：定义DIS的最大图像高度。
-   [OT\_DIS\_MIN\_IMAGE\_WIDTH](OT_DIS_MIN_IMAGE_WIDTH.md)：定义DIS的最小图像宽度。
-   [OT\_DIS\_MIN\_IMAGE\_HEIGHT](OT_DIS_MIN_IMAGE_HEIGHT.md)：定义DIS的最小图像高度。
-   [ot\_dis\_mode](ot_dis_mode.md)：定义DIS防抖算法模式。
-   [ot\_dis\_motion\_level](ot_dis_motion_level.md)：定义镜头的运动级别。
-   [ot\_dis\_pdt\_type](ot_dis_pdt_type.md)：定义使用DIS的产品形态。
-   [ot\_dis\_cfg](ot_dis_cfg.md)：定义DIS的配置信息。
-   [ot\_dis\_attr](ot_dis_attr.md)：定义DIS属性。
-   [ot\_dis\_param](ot_dis_param.md)：定义DIS可选参数。
-   [ot\_dis\_wdr\_attr](ot_dis_wdr_attr.md)：定义DIS WDR属性。
-   [ot\_vi\_fov\_correction\_attr](ot_vi_fov_correction_attr.md)：定义视场角矫正属性。
...
[OT\_VI\_EXT\_CHN\_MAX\_ZOOMOUT](#OT_VI_EXT_CHN_MAX_ZOOMOUT)
...
[OT\_VI\_EXT\_CHN\_MAX\_ZOOMIN](#OT_VI_EXT_CHN_MAX_ZOOMIN)
...
[ot\_vi\_fov\_correction\_attr](#ot_vi_fov_correction_attr)
...
-   [ot\_vi\_dev\_attr](#ot_vi_dev_attr)
-   [ss\_mpi\_vi\_set\_dev\_attr](#ss_mpi_vi_set_dev_attr)
...
-   [ot\_vi\_vsync\_neg](#ot_vi_vsync_neg)
-   [ot\_vi\_sync\_cfg](#ot_vi_sync_cfg)
...
-   [ot\_vi\_hsync\_neg](#ot_vi_hsync_neg)
-   [ot\_vi\_sync\_cfg](#ot_vi_sync_cfg)
...
-   [ot\_vi\_vsync](#ot_vi_vsync)
-   [ot\_vi\_vsync\_valid\_neg](#ot_vi_vsync_valid_neg)
-   [ot\_vi\_sync\_cfg](#ot_vi_sync_cfg)
...
-   [ot\_vi\_vsync\_valid](#ot_vi_vsync_valid)
-   [ot\_vi\_sync\_cfg](#ot_vi_sync_cfg)
...
<p xml:lang="sv-SE" id="p12658mcpsimp"><a name="p12658mcpsimp"></a><a name="p12658mcpsimp"></a>宽度：[<a href="OT_VI_DEV_MIN_WIDTH.md">OT_VI_DEV_MIN_WIDTH</a>, <a href="OT_VI_DEV_MAX_WIDTH.md"><span xml:lang="de-DE" id="ph12661mcpsimp"><a name="ph12661mcpsimp"></a><a name="ph12661mcpsimp"></a>OT_VI_DEV_MAX_WIDTH</span></a>]</p>
<p xml:lang="sv-SE" id="p12662mcpsimp"><a name="p12662mcpsimp"></a><a name="p12662mcpsimp"></a>高度：[<a href="OT_VI_DEV_MIN_HEIGHT.md">OT_VI_DEV_MIN_HEIGHT</a>, <a href="OT_VI_DEV_MAX_HEIGHT.md"><span xml:lang="de-DE" id="ph12665mcpsimp"><a name="ph12665mcpsimp"></a><a name="ph12665mcpsimp"></a>OT_VI_DEV_MAX_HEIGHT</span></a>]</p>
</td>
</tr>
...
[ot\_vi\_rephase\_mode](#ot_vi_rephase_mode)
...
[ot\_vi\_rephase\_attr](#ot_vi_rephase_attr)
...
[ot\_vi\_bas\_attr](#ot_vi_bas_attr)
...
-   BAS只支持1倍，2倍或者3倍缩小。
-   Rephase限制：BAS 打开rephase功能时（rephase的调整类型不是设置成OT\_VI\_REPHASE\_MODE\_NONE时），前端输入的宽度有限制，Hi3403V100最大输入宽度为2114，否则图像会出现异常。
...
-   OOC校正数据只支持raw数据输入。
-   配置的cfg\_num最大值不能超过[OT\_VI\_MAX\_SNS\_CFG\_NUM](OT_VI_MAX_SNS_CFG_NUM.md)。
...
[ss\_mpi\_vi\_set\_dev\_timing\_attr](#ss_mpi_vi_set_dev_timing_attr)
...
[ss\_mpi\_vi\_get\_bind\_by\_dev](#ss_mpi_vi_get_bind_by_dev)
...
-   pipe\_reverse须配合[ss\_mpi\_vi\_set\_pipe\_vc\_number](ss_mpi_vi_set_pipe_vc_number.md)接口使用，在需要将长短帧交换FE处理的场景下使用：如2To1模式下FE0处理长帧，FE1处理短帧，需设置pipe\_reverse为TRUE，同时交换两路pipe的vc\_number。
-   配置WDR组属性后，获取对应isp统计信息需要从对应的WDR主pipe获取；如pipe0, 1做wdr融合，若配置了pipe\_reverse，则需要从pipe1\(isp1\)上获取统计信息，此时isp通路也只需要起isp1，不需要配置isp0。

【相关数据类型及接口】

[ss\_mpi\_vi\_set\_wdr\_fusion\_grp\_attr](#ss_mpi_vi_set_wdr_fusion_grp_attr)
...
-   [ss\_mpi\_vi\_create\_pipe](#ss_mpi_vi_create_pipe)
-   [ss\_mpi\_vi\_set\_pipe\_attr](#ss_mpi_vi_set_pipe_attr)
-   [ss\_mpi\_vi\_get\_pipe\_attr](#ss_mpi_vi_get_pipe_attr)
...
-   [ss\_mpi\_vi\_set\_pipe\_frame\_dump\_attr](#ss_mpi_vi_set_pipe_frame_dump_attr)
-   [ss\_mpi\_vi\_get\_pipe\_frame\_dump\_attr](#ss_mpi_vi_get_pipe_frame_dump_attr)
...
-   [ss\_mpi\_vi\_set\_pipe\_private\_data\_dump\_attr](#ss_mpi_vi_set_pipe_private_data_dump_attr)
-   [ss\_mpi\_vi\_get\_pipe\_private\_data\_dump\_attr](#ss_mpi_vi_get_pipe_private_data_dump_attr)
...
-   [ss\_mpi\_vi\_set\_pipe\_frame\_source](#ss_mpi_vi_set_pipe_frame_source)
-   [ss\_mpi\_vi\_get\_pipe\_frame\_source](#ss_mpi_vi_get_pipe_frame_source)
...
[ss\_mpi\_vi\_query\_pipe\_status](#ss_mpi_vi_query_pipe_status)
...
[ss\_mpi\_vi\_get\_pipe\_compress\_param](#ss_mpi_vi_get_pipe_compress_param)
...
<p xml:lang="de-DE" id="p13952mcpsimp"><a name="p13952mcpsimp"></a><a name="p13952mcpsimp"></a>[<a href="OT_VI_PHYS_CHN_ONLINE_MIN_WIDTH.md">OT_VI_PHYS_CHN_ONLINE_MIN_WIDTH</a>，<a href="OT_VI_PHYS_CHN_ONLINE_MAX_WIDTH.md">OT_VI_PHYS_CHN_ONLINE_MAX_WIDTH</a>]</p>
...
<p xml:lang="de-DE" id="p13957mcpsimp"><a name="p13957mcpsimp"></a><a name="p13957mcpsimp"></a>[<a href="OT_VI_PHYS_CHN_ONLINE_MIN_HEIGHT.md">OT_VI_PHYS_CHN_ONLINE_MIN_HEIGHT</a>，<a href="OT_VI_PHYS_CHN_ONLINE_MAX_HEIGHT.md">OT_VI_PHYS_CHN_ONLINE_MAX_HEIGHT</a>]</p>
...
<p xml:lang="de-DE" id="p13962mcpsimp"><a name="p13962mcpsimp"></a><a name="p13962mcpsimp"></a>[<a href="OT_VI_PHYS_CHN_OFFLINE_MIN_WIDTH.md">OT_VI_PHYS_CHN_OFFLINE_MIN_WIDTH</a>，<a href="OT_VI_PHYS_CHN_OFFLINE_MAX_WIDTH.md">OT_VI_PHYS_CHN_OFFLINE_MAX_WIDTH</a>]</p>
...
<p xml:lang="de-DE" id="p13967mcpsimp"><a name="p13967mcpsimp"></a><a name="p13967mcpsimp"></a>[<a href="OT_VI_PHYS_CHN_OFFLINE_MIN_HEIGHT.md">OT_VI_PHYS_CHN_OFFLINE_MIN_HEIGHT</a>，<a href="OT_VI_PHYS_CHN_OFFLINE_MAX_HEIGHT.md">OT_VI_PHYS_CHN_OFFLINE_MAX_HEIGHT</a>]</p>
</td>
</tr>
...
<p xml:lang="de-DE" id="p14089mcpsimp"><a name="p14089mcpsimp"></a><a name="p14089mcpsimp"></a><span xml:lang="en-US" id="ph14090mcpsimp"><a name="ph14090mcpsimp"></a><a name="ph14090mcpsimp"></a>[</span><a href="OT_VI_EXT_CHN_MIN_WIDTH.md">OT_VI_EXT_CHN_MIN_WIDTH</a><span xml:lang="en-US" id="ph14092mcpsimp"><a name="ph14092mcpsimp"></a><a name="ph14092mcpsimp"></a>，</span><a href="OT_VI_EXT_CHN_MAX_WIDTH.md">OT_VI_EXT_CHN_MAX_WIDTH</a><span xml:lang="en-US" id="ph14094mcpsimp"><a name="ph14094mcpsimp"></a><a name="ph14094mcpsimp"></a>]</span></p>
<p id="p14095mcpsimp"><a name="p14095mcpsimp"></a><a name="p14095mcpsimp"></a>高度：</p>
<p xml:lang="de-DE" id="p14096mcpsimp"><a name="p14096mcpsimp"></a><a name="p14096mcpsimp"></a><span xml:lang="en-US" id="ph14097mcpsimp"><a name="ph14097mcpsimp"></a><a name="ph14097mcpsimp"></a>[</span><a href="OT_VI_EXT_CHN_MIN_HEIGHT.md">OT_VI_EXT_CHN_MIN_HEIGHT</a><span xml:lang="en-US" id="ph14099mcpsimp"><a name="ph14099mcpsimp"></a><a name="ph14099mcpsimp"></a>，</span><a href="OT_VI_EXT_CHN_MAX_HEIGHT.md">OT_VI_EXT_CHN_MAX_HEIGHT</a><span xml:lang="en-US" id="ph14101mcpsimp"><a name="ph14101mcpsimp"></a><a name="ph14101mcpsimp"></a>]</span></p>
</td>
</tr>
...
-   [ss\_mpi\_vi\_set\_chn\_crop](#ss_mpi_vi_set_chn_crop)
-   [ss\_mpi\_vi\_get\_chn\_crop](#ss_mpi_vi_get_chn_crop)
...
[ss\_mpi\_vi\_query\_chn\_status](#ss_mpi_vi_query_chn_status)
...
[ot\_vi\_stitch\_grp\_attr](#ot_vi_stitch_grp_attr)
...
<p xml:lang="sv-SE" id="p11787mcpsimp"><a name="p11787mcpsimp"></a><a name="p11787mcpsimp"></a><span xml:lang="en-US" id="ph11788mcpsimp"><a name="ph11788mcpsimp"></a><a name="ph11788mcpsimp"></a>取值范围：[2, </span><a href="OT_VI_MAX_PHYS_PIPE_NUM.md">OT_VI_MAX_PHYS_PIPE_NUM</a>]</p>
</td>
</tr>
...
-   [ss\_mpi\_vi\_set\_stitch\_grp\_attr](#ss_mpi_vi_set_stitch_grp_attr)
-   [ss\_mpi\_vi\_get\_stitch\_grp\_attr](#ss_mpi_vi_get_stitch_grp_attr)
...
-   [ss\_mpi\_vi\_set\_mod\_param](#ss_mpi_vi_set_mod_param)
-   [ss\_mpi\_vi\_get\_mod\_param](#ss_mpi_vi_get_mod_param)
...
-   对于crop\_ratio参数：
    -   scale为TRUE时，crop\_ratio可以调用接口[ss\_mpi\_vi\_set\_chn\_dis\_cfg](ss_mpi_vi_set_chn_dis_cfg.md)动态修改。
    -   scale为FALSE时，crop\_ratio不可以动态修改，必须先关闭DIS，再动态修改crop\_ratio值。

-   对于参数未有任何修改，但调用[ss\_mpi\_vi\_set\_chn\_dis\_cfg](ss_mpi_vi_set_chn_dis_cfg.md)重复设置时，接口返回成功。

【相关数据类型及接口】

-   [ss\_mpi\_vi\_set\_chn\_dis\_cfg](#ss_mpi_vi_set_chn_dis_cfg)
-   [ss\_mpi\_vi\_get\_chn\_dis\_cfg](#ss_mpi_vi_get_chn_dis_cfg)
-   [ss\_mpi\_vi\_set\_chn\_dis\_attr](#ss_mpi_vi_set_chn_dis_attr)
-   [ss\_mpi\_vi\_get\_chn\_dis\_attr](#ss_mpi_vi_get_chn_dis_attr)
...
-   在Hi3403V100上不建议使用gdc\_bypass参数作为DIS功能开关，默认设置其值为TD\_FALSE，当设置为TD\_TRUE时，DIS的PMF矫正功能不生效。使用中，如果不想使能DIS，请设置DIS开关enable为TD\_FALSE；如果想使能DIS,请把DIS开关enable设置为TD\_TRUE，同时把gdc\_bypass设置为TD\_FALSE。
...
-   [ss\_mpi\_vi\_set\_chn\_dis\_param](#ss_mpi_vi_set_chn_dis_param)
-   [ss\_mpi\_vi\_get\_chn\_dis\_param](#ss_mpi_vi_get_chn_dis_param)
