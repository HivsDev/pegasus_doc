...
-   split\_attr\[[OT\_AVS\_SPLIT\_NUM](OT_AVS_SPLIT_NUM.md)\]在Hi3403V100上不支持，设置了不会生效。
...
-   SS927V100所有的[OT\_AVS\_MODE\_BLEND](ot_avs_mode.md#OT_AVS_MODE_BLEND)模式拼接组通道0的输出总面积最大为3840x2160，Hi3403V100无此限制。
