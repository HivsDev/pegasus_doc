...
-   GROUP
    ...
    AVS对用户提供组（GROUP）的概念。最大可用数为`OT_AVS_MAX_GRP_NUM`个，各GROUP分时复用AVS硬件。每个AVS GROUP包含多个PIPE和多个通道。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1964mcpsimp"><a name="p1964mcpsimp"></a><a name="p1964mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2080mcpsimp"><a name="p2080mcpsimp"></a><a name="p2080mcpsimp"></a>取值范围：`ss_mpi_avs_stop_grp`禁用此GROUP。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2174mcpsimp"><a name="p2174mcpsimp"></a><a name="p2174mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>[错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2241mcpsimp"><a name="p2241mcpsimp"></a><a name="p2241mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>[错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2309mcpsimp"><a name="p2309mcpsimp"></a><a name="p2309mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2351mcpsimp"><a name="p2351mcpsimp"></a><a name="p2351mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2424mcpsimp"><a name="p2424mcpsimp"></a><a name="p2424mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2466mcpsimp"><a name="p2466mcpsimp"></a><a name="p2466mcpsimp"></a>取值范围：`ot_avs_grp_attr`。
...
<p id="p2549mcpsimp"><a name="p2549mcpsimp"></a><a name="p2549mcpsimp"></a>取值范围：`ss_mpi_avs_release_pipe_frame`接口配对使用。

【相关主题】

ss\_mpi\_avs\_release\_pipe\_frame
...
<p id="p2743mcpsimp"><a name="p2743mcpsimp"></a><a name="p2743mcpsimp"></a>取值范围：`ss_mpi_avs_get_pipe_frame`配对使用。
...
ss\_mpi\_avs\_get\_pipe\_frame
...
<p id="p2836mcpsimp"><a name="p2836mcpsimp"></a><a name="p2836mcpsimp"></a>取值范围：`ot_avs_mode`、`ot_avs_mode`和`ot_avs_mode`模式下，只能设置0通道的属性。
-   在`ot_avs_projection_mode`投影模式下，只能设置0通道的属性。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2989mcpsimp"><a name="p2989mcpsimp"></a><a name="p2989mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>[错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p130mcpsimp"><a name="p130mcpsimp"></a><a name="p130mcpsimp"></a>取值范围：`ss_mpi_avs_set_chn_attr`接口设置通道属性才能启用通道。
-   通道0启用后才能启用其他的通道。
-   在`ot_avs_projection_mode`投影模式下，只能使能0通道。
-   多次启用通道返回成功。
...
<p id="p217mcpsimp"><a name="p217mcpsimp"></a><a name="p217mcpsimp"></a>取值范围：`ss_mpi_avs_release_chn_frame`接口配对使用。

【相关主题】

ss\_mpi\_avs\_release\_chn\_frame
...
<p id="p396mcpsimp"><a name="p396mcpsimp"></a><a name="p396mcpsimp"></a>取值范围：`ss_mpi_avs_get_chn_frame`配对使用。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p506mcpsimp"><a name="p506mcpsimp"></a><a name="p506mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p570mcpsimp"><a name="p570mcpsimp"></a><a name="p570mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1323142624211"><a name="ph1323142624211"></a><a name="ph1323142624211"></a>错误码</span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   OT\_AVS\_MODE\_BLEND模式下，写出图像的宽高和动态范围属性由通道属性决定；在OT\_AVS\_MODE\_NOBLEND\_VER、OT\_AVS\_MODE\_NOBLEND\_HOR和OT\_AVS\_MODE\_NOBLEND\_QR模式下，写出图像的宽高和动态范围由输入图像决定。
-   OT\_AVS\_MODE\_BLEND模式下，支持多个通道写出，OT\_AVS\_MODE\_NOBLEND\_VER、OT\_AVS\_MODE\_NOBLEND\_HOR和OT\_AVS\_MODE\_NOBLEND\_QR模式下，只支持一个通道写出。
-   在OT\_AVS\_MODE\_NOBLEND\_HOR模式下，压缩写出时，拼接路数不能超过4路。
-   AVS\_MODE\_NOBLEND\_QR模式，仅支持4路的拼接；
-   各模式下最大最小的输入分辨率如表1所示，除了表格的限制外，非融合模式要求最大输出不超过16384x8192，如在4路垂直硬拼时，最终输出的高为每路输入图像高度的4倍，即每路输入图像最大高度为2048。
...
-   如果创建了多个使用`ot_avs_mode`模式的AVS GROUP，只能使用手动模式。
-   使用`ot_avs_projection_mode`投影模式时，只能使用手动模式。
-   自动模式下，AVS亮度增益补偿滞后一帧。
...
-   使用`ot_avs_projection_mode`投影模式时，只能使用手动模式，并且各路增益值要求一致。
...
当投影模式为`ot_avs_projection_mode`投影模式时，该参数无效。
...
-   展开面不能超出输出图像。
-   `ot_avs_projection_mode`展开时，如果输出配置为压缩，则必须使能背景色。
-   `ot_avs_projection_mode`展开时，如果输出配置为压缩，则起点的X坐标要求256对齐，surface\_len也要求256对齐。
...
-   split\_attr\`OT_AVS_SPLIT_NUM`\]在Hi3403V100上不支持，设置了不会生效。
-   center投影中心即为三维球面全景图转换到二维投影输出图的投影中心位置，当投影模式为`ot_avs_projection_mode`时，center不生效。
...
-   lut、gain\_attr以及out\_attr只有在`ot_avs_mode`模式下才会有效。
...
-   width、height和dynamic\_range只有在`ot_avs_mode`拼接模式下才会生效。
...
-   Hi3403V100的非0通道的动态范围只能设置为SDR8。
-   如果AVS使能的通道没有绑定后端，并且depth为0时，AVS会停止工作。
-   SS927V100所有的`ot_avs_mode`模式拼接组通道0的输出总面积最大为3840x2160，Hi3403V100无此限制。
