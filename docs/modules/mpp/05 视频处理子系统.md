...
-   Group
    -   VPSS对用户提供组（Group）的概念。最大个数请参考[OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)定义，各Group分时复用VPSS硬件，硬件依次处理各个组提交的任务。
...
SS528V100功能规格支持参考[图1](处理流程.md#fig2394234205417)数据流图。

SS625V100功能规格支持参考[图2](处理流程.md#fig193991685918)数据流图。

SS524V100功能规格支持参考[图3](处理流程.md#fig4231334803)数据流图。

SS522V101功能规格支持参考[图4](处理流程.md#fig14807173820110)数据流图。

Hi3403V100功能规格支持参考[图5](处理流程.md#fig076104110215)数据流图。

SS626V100功能规格支持参考[图6](处理流程.md#fig1380651110517)数据流图。
...
> **说明：** 
>-   当SS528V100/SS625V100/SS524V100/SS522V101 VPSS性能不够时，可以使用VGS来代替VPSS做一部分功能。对应的VPSS的组号设置为\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]，即最后（[OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)-  [OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md)）个组默认提交给VGS硬件来实现，用户可以根据实际场景自由选择是否用VGS硬件来代替VPSS 处理功能。如果通道是user模式，输入输出图像分辨率不变，且功能都不开启，则VGS 会bypass 此任务，不消耗VGS 性能，且输入输出是同一个VB。此类组有一些限制：
...
>-   Hi3403V100 VPSS组号在\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]范围内的组调用VGS硬件处理（此类组工作在离线模式），用于解码或VPSS性能不够的场景。单通道输出且不做任何处理时bypass处理，输入输出为同一个VB。此类组有如下限制：
>    -   不支持3DNR；
...
> **说明：** 
>-   Hi3403V100仅组号在\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]范围内的组支持输入Tile64x16格式。
...
> **说明：** 
>Hi3403V100仅组号在\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]范围内的组支持输入TILE压缩。
...
-   [ss\_mpi\_vpss\_create\_grp](ss_mpi_vpss_create_grp.md)：创建一个VPSS Group。
-   [ss\_mpi\_vpss\_destroy\_grp](ss_mpi_vpss_destroy_grp.md)：销毁一个VPSS Group。
-   [ss\_mpi\_vpss\_get\_grp\_attr](ss_mpi_vpss_get_grp_attr.md)：获取VPSS Group属性。
-   [ss\_mpi\_vpss\_set\_grp\_attr](ss_mpi_vpss_set_grp_attr.md)：设置VPSS Group属性。
-   [ss\_mpi\_vpss\_get\_grp\_param](ss_mpi_vpss_get_grp_param.md)：获取VPSS Group参数。
-   [ss\_mpi\_vpss\_set\_grp\_param](ss_mpi_vpss_set_grp_param.md)：设置VPSS Group参数。
-   [ss\_mpi\_vpss\_set\_grp\_nrx\_adv\_param](ss_mpi_vpss_set_grp_nrx_adv_param.md)：设置 VPSS Group高级参数。
-   [ss\_mpi\_vpss\_get\_grp\_nrx\_adv\_param](ss_mpi_vpss_get_grp_nrx_adv_param.md)：获取VPSS Group高级参数。
-   [ss\_mpi\_vpss\_set\_grp\_cfg](ss_mpi_vpss_set_grp_cfg.md)：设置VPSS Group 配置。
-   [ss\_mpi\_vpss\_get\_grp\_cfg](ss_mpi_vpss_get_grp_cfg.md)：获取VPSS Group 配置。
-   [ss\_mpi\_vpss\_start\_grp](ss_mpi_vpss_start_grp.md)：启用VPSS Group。
-   [ss\_mpi\_vpss\_stop\_grp](ss_mpi_vpss_stop_grp.md)：禁用VPSS Group。
-   [ss\_mpi\_vpss\_reset\_grp](ss_mpi_vpss_reset_grp.md)：重置一个VPSS Group。
-   [ss\_mpi\_vpss\_get\_chn\_attr](ss_mpi_vpss_get_chn_attr.md)：获取VPSS物理通道属性。
-   [ss\_mpi\_vpss\_set\_chn\_attr](ss_mpi_vpss_set_chn_attr.md)：设置VPSS物理通道属性。
-   [ss\_mpi\_vpss\_enable\_chn](ss_mpi_vpss_enable_chn.md)：启用VPSS通道。
-   [ss\_mpi\_vpss\_disable\_chn](ss_mpi_vpss_disable_chn.md)：禁用VPSS通道。
-   [ss\_mpi\_vpss\_set\_grp\_crop](ss_mpi_vpss_set_grp_crop.md)：设置VPSS组CROP参数。
-   [ss\_mpi\_vpss\_get\_grp\_crop](ss_mpi_vpss_get_grp_crop.md)：获取VPSS组CROP参数。
-   [ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)：用户向VPSS Group发送数据。
-   [ss\_mpi\_vpss\_get\_grp\_frame](ss_mpi_vpss_get_grp_frame.md)：用户从VPSS Group获取一帧原始图像。
-   [ss\_mpi\_vpss\_release\_grp\_frame](ss_mpi_vpss_release_grp_frame.md)：用户释放一帧原始图像。
-   [ss\_mpi\_vpss\_get\_chn\_frame](ss_mpi_vpss_get_chn_frame.md)：用户获取一帧通道图像。
-   [ss\_mpi\_vpss\_release\_chn\_frame](ss_mpi_vpss_release_chn_frame.md)：用户释放一帧通道图像。
-   [ss\_mpi\_vpss\_get\_grp\_rgn\_luma](ss_mpi_vpss_get_grp_rgn_luma.md)：获取输入图像指定区域的亮度总和。
-   [ss\_mpi\_vpss\_get\_chn\_rgn\_luma](ss_mpi_vpss_get_chn_rgn_luma.md)：获取通道图像指定区域的亮度总和。
-   [ss\_mpi\_vpss\_set\_chn\_rotation](ss_mpi_vpss_set_chn_rotation.md)：设置VPSS物理通道旋转属性。
-   [ss\_mpi\_vpss\_get\_chn\_rotation](ss_mpi_vpss_get_chn_rotation.md)：获取VPSS物理通道旋转属性。
-   [ss\_mpi\_vpss\_enable\_backup\_frame](ss_mpi_vpss_enable_backup_frame.md)：使能backup帧。
-   [ss\_mpi\_vpss\_disable\_backup\_frame](ss_mpi_vpss_disable_backup_frame.md)：不使能backup帧。
-   [ss\_mpi\_vpss\_set\_chn\_sharpen](ss_mpi_vpss_set_chn_sharpen.md)：设置通道Sharpen属性。
-   [ss\_mpi\_vpss\_get\_chn\_sharpen](ss_mpi_vpss_get_chn_sharpen.md)：获取通道Sharpen属性。
-   [ss\_mpi\_vpss\_set\_grp\_delay](ss_mpi_vpss_set_grp_delay.md)：设置延迟启动VPSS处理的延时队列长度。
-   [ss\_mpi\_vpss\_get\_grp\_delay](ss_mpi_vpss_get_grp_delay.md)：获取延迟启动VPSS处理的延时队列长度。
-   [ss\_mpi\_vpss\_enable\_user\_frame\_rate\_ctrl](ss_mpi_vpss_enable_user_frame_rate_ctrl.md)：VPSS以非绑定方式接收图像时，使能用户自己做帧率控制，如果VPSS通道工作在AUTO模式绑定到VO，此时VO的通道帧率控制不生效。
-   [ss\_mpi\_vpss\_disable\_user\_frame\_rate\_ctrl](ss_mpi_vpss_disable_user_frame_rate_ctrl.md)：VPSS以非绑定方式接收图像时，禁止用户自己做帧率控制，此时VO的通道帧率控制生效。
-   [ss\_mpi\_vpss\_set\_grp\_sizer](ss_mpi_vpss_set_grp_sizer.md)：设置VPSS Group Sizer属性。
-   [ss\_mpi\_vpss\_get\_grp\_sizer](ss_mpi_vpss_get_grp_sizer.md)：获取VPSS Group Sizer属性。
-   [ss\_mpi\_vpss\_set\_mod\_param](ss_mpi_vpss_set_mod_param.md)：设置VPSS模块参数。
-   [ss\_mpi\_vpss\_get\_mod\_param](ss_mpi_vpss_get_mod_param.md)：获取VPSS模块参数。
-   [ss\_mpi\_vpss\_get\_chn\_fd](ss_mpi_vpss_get_chn_fd.md)：获取VPSS通道对应的设备文件句柄。
-   [ss\_mpi\_vpss\_close\_fd](ss_mpi_vpss_close_fd.md)：关闭设备和通道的文件描述符。
-   [ss\_mpi\_vpss\_attach\_vb\_pool](ss_mpi_vpss_attach_vb_pool.md)：将VPSS的通道绑定到某个视频缓存VB池中。
-   [ss\_mpi\_vpss\_detach\_vb\_pool](ss_mpi_vpss_detach_vb_pool.md)：将VPSS的通道从某个视频缓存VB池中解绑定。
-   [ss\_mpi\_vpss\_set\_ldci\_attr](ss_mpi_vpss_set_ldci_attr.md)：设置VPSS LDCI属性。
-   [ss\_mpi\_vpss\_get\_ldci\_attr](ss_mpi_vpss_get_ldci_attr.md)：获取VPSS LDCI属性。
-   [ss\_mpi\_vpss\_set\_grp\_fisheye\_cfg](ss_mpi_vpss_set_grp_fisheye_cfg.md)：设置VPSS Group鱼眼镜头LMF参数。
-   [ss\_mpi\_vpss\_get\_grp\_fisheye\_cfg](ss_mpi_vpss_get_grp_fisheye_cfg.md)：获取VPSS Group鱼眼镜头LMF参数。
-   [ss\_mpi\_vpss\_set\_grp\_frame\_interrupt\_attr](ss_mpi_vpss_set_grp_frame_interrupt_attr.md)：设置VPSS在线模式使用的帧中断属性。
-   [ss\_mpi\_vpss\_get\_grp\_frame\_interrupt\_attr](ss_mpi_vpss_get_grp_frame_interrupt_attr.md)：获取VPSS在线模式使用的帧中断属性。
-   [ss\_mpi\_vpss\_set\_chn\_fisheye](ss_mpi_vpss_set_chn_fisheye.md)：设置VPSS物理通道鱼眼属性。
-   [ss\_mpi\_vpss\_get\_chn\_fisheye](ss_mpi_vpss_get_chn_fisheye.md)：获取VPSS物理通道鱼眼属性。
-   [ss\_mpi\_vpss\_fisheye\_pos\_query\_dst\_to\_src](ss_mpi_vpss_fisheye_pos_query_dst_to_src.md)：根据鱼眼矫正输出图像坐标点查找源图像坐标点。
-   [ss\_mpi\_vpss\_set\_chn\_ldc\_attr](ss_mpi_vpss_set_chn_ldc_attr.md)：设置VPSS镜头畸变矫正（LDC）属性。
-   [ss\_mpi\_vpss\_get\_chn\_ldc\_attr](ss_mpi_vpss_get_chn_ldc_attr.md)：获取VPSS镜头畸变矫正（LDC）属性。
-   [ss\_mpi\_vpss\_ldc\_pos\_query\_dst\_to\_src](ss_mpi_vpss_ldc_pos_query_dst_to_src.md)：根据镜头畸变校正（LDC）的输出图像坐标点查找输入图像的坐标点。
-   [ss\_mpi\_vpss\_ldc\_pos\_query\_src\_to\_dst](ss_mpi_vpss_ldc_pos_query_src_to_dst.md)：根据镜头畸变校正（LDC）的输入图像坐标点查找输出图像的坐标点。
-   [ss\_mpi\_vpss\_set\_chn\_spread\_attr](ss_mpi_vpss_set_chn_spread_attr.md)：设置VPSS物理通道展宽属性。
-   [ss\_mpi\_vpss\_get\_chn\_spread\_attr](ss_mpi_vpss_get_chn_spread_attr.md)：获取VPSS物理通道展宽属性。
-   [ss\_mpi\_vpss\_set\_chn\_crop](ss_mpi_vpss_set_chn_crop.md)：设置VPSS通道CROP参数。
-   [ss\_mpi\_vpss\_get\_chn\_crop](ss_mpi_vpss_get_chn_crop.md)：获取VPSS通道CROP参数。
-   [ss\_mpi\_vpss\_set\_low\_delay\_attr](ss_mpi_vpss_set_low_delay_attr.md)：设置VPSS通道低延时属性。
-   [ss\_mpi\_vpss\_get\_low\_delay\_attr](ss_mpi_vpss_get_low_delay_attr.md)：获取VPSS通道低延时属性。
-   [ss\_mpi\_vpss\_set\_chn\_align](ss_mpi_vpss_set_chn_align.md)：设置VPSS通道stride对齐。
-   [ss\_mpi\_vpss\_get\_chn\_align](ss_mpi_vpss_get_chn_align.md)：获取VPSS通道stride对齐。
-   [ss\_mpi\_vpss\_set\_ext\_chn\_attr](ss_mpi_vpss_set_ext_chn_attr.md)：设置扩展通道属性。
-   [ss\_mpi\_vpss\_get\_ext\_chn\_attr](ss_mpi_vpss_get_ext_chn_attr.md)：获取扩展通道属性。
-   [ss\_mpi\_vpss\_enable\_quick\_send](ss_mpi_vpss_enable_quick_send.md)：启用VPSS快速发送模式，提前发送 VO。
-   [ss\_mpi\_vpss\_disable\_quick\_send](ss_mpi_vpss_disable_quick_send.md)：不使能VPSS通道快速发送功能。
-   [ss\_mpi\_vpss\_set\_chn\_scale\_coef\_type](ss_mpi_vpss_set_chn_scale_coef_type.md)：设置VPSS通道上的缩放系数类型。
-   [ss\_mpi\_vpss\_get\_chn\_scale\_coef\_type](ss_mpi_vpss_get_chn_scale_coef_type.md)：获取VPSS通道上的缩放系数类型。
-   [ss\_mpi\_vpss\_set\_chn\_cfg](ss_mpi_vpss_set_chn_cfg.md)：设置VPSS通道上的静态配置。
-   [ss\_mpi\_vpss\_get\_chn\_cfg](ss_mpi_vpss_get_chn_cfg.md)：获取VPSS通道上的静态配置。
...
<p id="p2468mcpsimp"><a name="p2468mcpsimp"></a><a name="p2468mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2500mcpsimp"><a name="p2500mcpsimp"></a><a name="p2500mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   不支持重复创建。
-   具体功能限制参考结构体[ot\_vpss\_grp\_attr](ot_vpss_grp_attr.md)说明。
-   Hi3403V100 VI\_ONLINE\_VPSS\_ONLINE模式仅支持创建组0和组号在\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]范围内的组。
...
-   [ss\_mpi\_vpss\_set\_grp\_attr](#ss_mpi_vpss_set_grp_attr)
-   [ss\_mpi\_vpss\_get\_grp\_attr](#ss_mpi_vpss_get_grp_attr)
-   [ss\_mpi\_vpss\_start\_grp](#ss_mpi_vpss_start_grp)
-   [ss\_mpi\_vpss\_stop\_grp](#ss_mpi_vpss_stop_grp)
-   [ss\_mpi\_vpss\_destroy\_grp](#ss_mpi_vpss_destroy_grp)
-   [ss\_mpi\_vpss\_reset\_grp](#ss_mpi_vpss_reset_grp)
-   [ss\_mpi\_vpss\_set\_chn\_attr](#ss_mpi_vpss_set_chn_attr)
-   [ss\_mpi\_vpss\_enable\_chn](#ss_mpi_vpss_enable_chn)
-   [ss\_mpi\_vpss\_disable\_chn](#ss_mpi_vpss_disable_chn)
-   [ss\_mpi\_vpss\_set\_grp\_crop](#ss_mpi_vpss_set_grp_crop)
-   [ss\_mpi\_vpss\_get\_grp\_crop](#ss_mpi_vpss_get_grp_crop)
...
<p id="p2133mcpsimp"><a name="p2133mcpsimp"></a><a name="p2133mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2158mcpsimp"><a name="p2158mcpsimp"></a><a name="p2158mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   调用此接口之前，必须先调用[ss\_mpi\_vpss\_stop\_grp](ss_mpi_vpss_stop_grp.md)禁用此Group。
-   调用此接口时，会一直等待此Group当前任务处理结束才会真正销毁。

【举例】

请参考[ss\_mpi\_vpss\_create\_grp](ss_mpi_vpss_create_grp.md)。

【相关主题】

[ss\_mpi\_vpss\_create\_grp](#ss_mpi_vpss_create_grp)
...
<p id="p8211mcpsimp"><a name="p8211mcpsimp"></a><a name="p8211mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8243mcpsimp"><a name="p8243mcpsimp"></a><a name="p8243mcpsimp"></a>失败，参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2206mcpsimp"><a name="p2206mcpsimp"></a><a name="p2206mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2238mcpsimp"><a name="p2238mcpsimp"></a><a name="p2238mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   Group属性必须合法，其中部分静态属性不可动态设置。具体功能限制请参考[ot\_vpss\_grp\_attr](ot_vpss_grp_attr.md)。
...
<p id="p4066mcpsimp"><a name="p4066mcpsimp"></a><a name="p4066mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4098mcpsimp"><a name="p4098mcpsimp"></a><a name="p4098mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   grp\_param各成员取值功能限制及3DNR调试指导请参考[ot\_vpss\_grp\_param](ot_vpss_grp_param.md)  结构说明。
-   请务必先调用[ss\_mpi\_vpss\_get\_grp\_param](ss_mpi_vpss_get_grp_param.md)获取当前参数，再进行设置操作。
...
[ss\_mpi\_vpss\_get\_grp\_param](#ss_mpi_vpss_get_grp_param)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5592mcpsimp"><a name="p5592mcpsimp"></a><a name="p5592mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_param](#ss_mpi_vpss_set_grp_param)
...
<p id="p6747mcpsimp"><a name="p6747mcpsimp"></a><a name="p6747mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6779mcpsimp"><a name="p6779mcpsimp"></a><a name="p6779mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   grp\_adv\_param  为3DNR高级参数，成员取值及调试指导参考[ot\_vpss\_nrx\_adv\_param](ot_vpss_nrx_adv_param.md)结构说明。
-   请务必先调用[ss\_mpi\_vpss\_get\_grp\_nrx\_adv\_param](ss_mpi_vpss_get_grp_nrx_adv_param.md)获取当前参数，再进行设置操作。
...
[ss\_mpi\_vpss\_get\_grp\_nrx\_adv\_param](#ss_mpi_vpss_get_grp_nrx_adv_param)
...
<p id="p8799mcpsimp"><a name="p8799mcpsimp"></a><a name="p8799mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8831mcpsimp"><a name="p8831mcpsimp"></a><a name="p8831mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_nrx\_adv\_param](#ss_mpi_vpss_set_grp_nrx_adv_param)
...
[ss\_mpi\_vpss\_get\_grp\_cfg](#ss_mpi_vpss_get_grp_cfg)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p534420543548"><a name="p534420543548"></a><a name="p534420543548"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_cfg](#ss_mpi_vpss_set_grp_cfg)
...
<p id="p3061mcpsimp"><a name="p3061mcpsimp"></a><a name="p3061mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3086mcpsimp"><a name="p3086mcpsimp"></a><a name="p3086mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p4477mcpsimp"><a name="p4477mcpsimp"></a><a name="p4477mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4502mcpsimp"><a name="p4502mcpsimp"></a><a name="p4502mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p8143mcpsimp"><a name="p8143mcpsimp"></a><a name="p8143mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8168mcpsimp"><a name="p8168mcpsimp"></a><a name="p8168mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p3891mcpsimp"><a name="p3891mcpsimp"></a><a name="p3891mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p3900mcpsimp"><a name="p3900mcpsimp"></a><a name="p3900mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3932mcpsimp"><a name="p3932mcpsimp"></a><a name="p3932mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p5636mcpsimp"><a name="p5636mcpsimp"></a><a name="p5636mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p5645mcpsimp"><a name="p5645mcpsimp"></a><a name="p5645mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5678mcpsimp"><a name="p5678mcpsimp"></a><a name="p5678mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   具体成员取值及功能限制参考[ot\_vpss\_chn\_attr](ot_vpss_chn_attr.md)结构体说明。
...
[ss\_mpi\_vpss\_get\_chn\_attr](#ss_mpi_vpss_get_chn_attr)
...
<p id="p4654mcpsimp"><a name="p4654mcpsimp"></a><a name="p4654mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p4663mcpsimp"><a name="p4663mcpsimp"></a><a name="p4663mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4688mcpsimp"><a name="p4688mcpsimp"></a><a name="p4688mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p8441mcpsimp"><a name="p8441mcpsimp"></a><a name="p8441mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p8450mcpsimp"><a name="p8450mcpsimp"></a><a name="p8450mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8475mcpsimp"><a name="p8475mcpsimp"></a><a name="p8475mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p9003mcpsimp"><a name="p9003mcpsimp"></a><a name="p9003mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p9035mcpsimp"><a name="p9035mcpsimp"></a><a name="p9035mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   具体成员取值及功能限制参考[ot\_vpss\_crop\_info](ot_vpss_crop_info.md)结构体说明。
...
<p id="p3727mcpsimp"><a name="p3727mcpsimp"></a><a name="p3727mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3759mcpsimp"><a name="p3759mcpsimp"></a><a name="p3759mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="66%" headers="mcps1.1.3.1.2 "><p id="p8913mcpsimp"><a name="p8913mcpsimp"></a><a name="p8913mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   输入为压缩时，宽高对齐要求与"[输入输出特性](输入输出特性.md)"章节中保持一致。输入为非压缩时，会自动向下裁剪对齐。
-   仅离线模式支持此接口。
...
<p id="p6917mcpsimp"><a name="p6917mcpsimp"></a><a name="p6917mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p6926mcpsimp"><a name="p6926mcpsimp"></a><a name="p6926mcpsimp"></a><span xml:lang="sv-SE" id="ph6927mcpsimp"><a name="ph6927mcpsimp"></a><a name="ph6927mcpsimp"></a>取值范围：</span>[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6966mcpsimp"><a name="p6966mcpsimp"></a><a name="p6966mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p3629mcpsimp"><a name="p3629mcpsimp"></a><a name="p3629mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p3638mcpsimp"><a name="p3638mcpsimp"></a><a name="p3638mcpsimp"></a><span xml:lang="sv-SE" id="ph3639mcpsimp"><a name="ph3639mcpsimp"></a><a name="ph3639mcpsimp"></a>取值范围：</span>[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3671mcpsimp"><a name="p3671mcpsimp"></a><a name="p3671mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
此接口需与[ss\_mpi\_vpss\_get\_chn\_frame](ss_mpi_vpss_get_chn_frame.md)配对使用。
...
用户从Group获取一帧原始图像。主要应用场景：高清设备解码回放，要求暂停、步进时，PIP层和普通视频层上的两个通道显示同一帧图像。通过本接口和[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)等接口的配合使用，可实现该功能。
...
<p id="p2870mcpsimp"><a name="p2870mcpsimp"></a><a name="p2870mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2909mcpsimp"><a name="p2909mcpsimp"></a><a name="p2909mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   获取的图像要及时释放，否则将造成VB不够或解码回放时停止，建议与[ss\_mpi\_vpss\_release\_grp\_frame](ss_mpi_vpss_release_grp_frame.md)接口配对使用。
...
[ss\_mpi\_vpss\_release\_grp\_frame](#ss_mpi_vpss_release_grp_frame)
...
<p id="p470mcpsimp"><a name="p470mcpsimp"></a><a name="p470mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p502mcpsimp"><a name="p502mcpsimp"></a><a name="p502mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   此接口需与[ss\_mpi\_vpss\_get\_grp\_frame](ss_mpi_vpss_get_grp_frame.md)配对使用。
-   仅离线模式支持此功能。
...
[ss\_mpi\_vpss\_get\_grp\_frame](#ss_mpi_vpss_get_grp_frame)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5389mcpsimp"><a name="p5389mcpsimp"></a><a name="p5389mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p5449mcpsimp"><a name="p5449mcpsimp"></a><a name="p5449mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5507mcpsimp"><a name="p5507mcpsimp"></a><a name="p5507mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   统计区域的数量范围为\[1, 64\]。
-   统计区域坐标和宽高要求2像素对齐。
-   统计区域宽高最小为2x2，SS528V100/SS625V100/SS524V100/SS522V101/SS626V100统计区域宽高最大为16384x8192，Hi3403V100统计区域宽高最大为8192x8192。
-   亮度和区域不得超出图像。
...
<p id="p4734mcpsimp"><a name="p4734mcpsimp"></a><a name="p4734mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4775mcpsimp"><a name="p4775mcpsimp"></a><a name="p4775mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p9534mcpsimp"><a name="p9534mcpsimp"></a><a name="p9534mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7975mcpsimp"><a name="p7975mcpsimp"></a><a name="p7975mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2981mcpsimp"><a name="p2981mcpsimp"></a><a name="p2981mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6224mcpsimp"><a name="p6224mcpsimp"></a><a name="p6224mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p7299mcpsimp"><a name="p7299mcpsimp"></a><a name="p7299mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7331mcpsimp"><a name="p7331mcpsimp"></a><a name="p7331mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p8020mcpsimp"><a name="p8020mcpsimp"></a><a name="p8020mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8053mcpsimp"><a name="p8053mcpsimp"></a><a name="p8053mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_grp\_delay](#ss_mpi_vpss_get_grp_delay)
...
<p id="p4247mcpsimp"><a name="p4247mcpsimp"></a><a name="p4247mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4279mcpsimp"><a name="p4279mcpsimp"></a><a name="p4279mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_delay](#ss_mpi_vpss_set_grp_delay)
...
<p id="p7374mcpsimp"><a name="p7374mcpsimp"></a><a name="p7374mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7399mcpsimp"><a name="p7399mcpsimp"></a><a name="p7399mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   多次使能返回成功。
-   Group必须已创建。
-   此接口仅在VPSS通过接口[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)接收图像时，使能用户自己做帧率控制，如果VPSS通道工作在AUTO模式绑定到VO，此时VO的通道帧率控制不生效。
-   VPSS通过接口[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)接收图像时，默认使能用户自己做帧率控制。
...
<p id="p8626mcpsimp"><a name="p8626mcpsimp"></a><a name="p8626mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8651mcpsimp"><a name="p8651mcpsimp"></a><a name="p8651mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   重复禁用返回成功。
-   Group必须已创建。
-   此接口仅在VPSS通过接口[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)接收图像时，禁止用户自己做帧率控制，此时VO的通道帧率控制生效。
...
<p id="p3401mcpsimp"><a name="p3401mcpsimp"></a><a name="p3401mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3433mcpsimp"><a name="p3433mcpsimp"></a><a name="p3433mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   采用[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)接口用户送图时，不受影响。
-   Hi3403V100/SS626V100不支持此接口。
...
<p id="p3979mcpsimp"><a name="p3979mcpsimp"></a><a name="p3979mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4011mcpsimp"><a name="p4011mcpsimp"></a><a name="p4011mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6697mcpsimp"><a name="p6697mcpsimp"></a><a name="p6697mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   此接口只有在未创建任何组时才能调用。
-   相关参数说明参考[ot\_vpss\_mod\_param](ot_vpss_mod_param.md)结构体。
-   请务必先调用[ss\_mpi\_vpss\_get\_mod\_param](ss_mpi_vpss_get_mod_param.md)获取当前参数，再进行设置操作。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7654mcpsimp"><a name="p7654mcpsimp"></a><a name="p7654mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p8962mcpsimp"><a name="p8962mcpsimp"></a><a name="p8962mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_chn\_fd](#ss_mpi_vpss_get_chn_fd)
...
<p id="p7528mcpsimp"><a name="p7528mcpsimp"></a><a name="p7528mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p7537mcpsimp"><a name="p7537mcpsimp"></a><a name="p7537mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7571mcpsimp"><a name="p7571mcpsimp"></a><a name="p7571mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   在调用[ss\_mpi\_vpss\_detach\_vb\_pool](ss_mpi_vpss_detach_vb_pool.md)后，销毁创建的VB之前，需要保证VB没有被VPSS后端绑定的模块使用，可以通过sleep或清除后端模块通道缓存的方式先把VB都释放，再销毁缓存VB池。
...
[ss\_mpi\_vpss\_detach\_vb\_pool](#ss_mpi_vpss_detach_vb_pool)
...
<p id="p7115mcpsimp"><a name="p7115mcpsimp"></a><a name="p7115mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7140mcpsimp"><a name="p7140mcpsimp"></a><a name="p7140mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_attach\_vb\_pool](#ss_mpi_vpss_attach_vb_pool)
...
<p id="p1940mcpsimp"><a name="p1940mcpsimp"></a><a name="p1940mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1972mcpsimp"><a name="p1972mcpsimp"></a><a name="p1972mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   ldci\_attr各成员取值功能限制请参考[ot\_vpss\_ldci\_attr](ot_vpss_ldci_attr.md)结构说明。
-   请务必先调用[ss\_mpi\_vpss\_get\_ldci\_attr](ss_mpi_vpss_get_ldci_attr.md)获取当前参数，再进行设置操作。
...
[ss\_mpi\_vpss\_get\_ldci\_attr](#ss_mpi_vpss_get_ldci_attr)
...
<p id="p645mcpsimp"><a name="p645mcpsimp"></a><a name="p645mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p677mcpsimp"><a name="p677mcpsimp"></a><a name="p677mcpsimp"></a>失败，其值为<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_ldci\_attr](#ss_mpi_vpss_set_ldci_attr)
...
<p id="p5856mcpsimp"><a name="p5856mcpsimp"></a><a name="p5856mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5889mcpsimp"><a name="p5889mcpsimp"></a><a name="p5889mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_grp\_fisheye\_cfg](#ss_mpi_vpss_get_grp_fisheye_cfg)
...
<p id="p5768mcpsimp"><a name="p5768mcpsimp"></a><a name="p5768mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5801mcpsimp"><a name="p5801mcpsimp"></a><a name="p5801mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_fisheye\_cfg](#ss_mpi_vpss_set_grp_fisheye_cfg)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3285mcpsimp"><a name="p3285mcpsimp"></a><a name="p3285mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_grp\_frame\_interrupt\_attr](#ss_mpi_vpss_get_grp_frame_interrupt_attr)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2805mcpsimp"><a name="p2805mcpsimp"></a><a name="p2805mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_grp\_frame\_interrupt\_attr](#ss_mpi_vpss_set_grp_frame_interrupt_attr)
...
<p id="p4333mcpsimp"><a name="p4333mcpsimp"></a><a name="p4333mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4365mcpsimp"><a name="p4365mcpsimp"></a><a name="p4365mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Hi3403V100通道输出VIDEO\_FORMAT\_TILE\_16x8格式时，不支持鱼眼。
-   Hi3403V100鱼眼仅支持低延时输入，不支持低延时输出，VPSS物理通道开启低延时和鱼眼，后端模块收到的是非低延时帧。
...
[ss\_mpi\_vpss\_get\_chn\_fisheye](#ss_mpi_vpss_get_chn_fisheye)
...
<p id="p7016mcpsimp"><a name="p7016mcpsimp"></a><a name="p7016mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p7025mcpsimp"><a name="p7025mcpsimp"></a><a name="p7025mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7060mcpsimp"><a name="p7060mcpsimp"></a><a name="p7060mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_chn\_fisheye](#ss_mpi_vpss_set_chn_fisheye)
...
<p id="p6471mcpsimp"><a name="p6471mcpsimp"></a><a name="p6471mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6534mcpsimp"><a name="p6534mcpsimp"></a><a name="p6534mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6312mcpsimp"><a name="p6312mcpsimp"></a><a name="p6312mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_chn\_ldc\_attr](#ss_mpi_vpss_get_chn_ldc_attr)
...
<p id="p6103mcpsimp"><a name="p6103mcpsimp"></a><a name="p6103mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6135mcpsimp"><a name="p6135mcpsimp"></a><a name="p6135mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_chn\_ldc\_attr](#ss_mpi_vpss_set_chn_ldc_attr)
...
<p id="p4149mcpsimp"><a name="p4149mcpsimp"></a><a name="p4149mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p4158mcpsimp"><a name="p4158mcpsimp"></a><a name="p4158mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="75%" headers="mcps1.1.3.1.2 "><p id="p4198mcpsimp"><a name="p4198mcpsimp"></a><a name="p4198mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p130mcpsimp"><a name="p130mcpsimp"></a><a name="p130mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="75%" headers="mcps1.1.3.1.2 "><p id="p179mcpsimp"><a name="p179mcpsimp"></a><a name="p179mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3537mcpsimp"><a name="p3537mcpsimp"></a><a name="p3537mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_chn\_spread\_attr](#ss_mpi_vpss_get_chn_spread_attr)
...
<p id="p5122mcpsimp"><a name="p5122mcpsimp"></a><a name="p5122mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p5154mcpsimp"><a name="p5154mcpsimp"></a><a name="p5154mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_chn\_spread\_attr](#ss_mpi_vpss_set_chn_spread_attr)
...
<p id="p8701mcpsimp"><a name="p8701mcpsimp"></a><a name="p8701mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p8710mcpsimp"><a name="p8710mcpsimp"></a><a name="p8710mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p8742mcpsimp"><a name="p8742mcpsimp"></a><a name="p8742mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ss\_mpi\_vpss\_get\_chn\_crop](#ss_mpi_vpss_get_chn_crop)
-   ot\_coord
-   [ot\_vpss\_crop\_info](#ot_vpss_crop_info)
...
<p id="p9409mcpsimp"><a name="p9409mcpsimp"></a><a name="p9409mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p9450mcpsimp"><a name="p9450mcpsimp"></a><a name="p9450mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_chn\_crop](#ss_mpi_vpss_set_chn_crop)
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p8562mcpsimp"><a name="p8562mcpsimp"></a><a name="p8562mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ss\_mpi\_vpss\_get\_low\_delay\_attr](#ss_mpi_vpss_get_low_delay_attr)
...
<p id="p4568mcpsimp"><a name="p4568mcpsimp"></a><a name="p4568mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p4600mcpsimp"><a name="p4600mcpsimp"></a><a name="p4600mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_low\_delay\_attr](#ss_mpi_vpss_set_low_delay_attr)
...
<p id="p7747mcpsimp"><a name="p7747mcpsimp"></a><a name="p7747mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p7756mcpsimp"><a name="p7756mcpsimp"></a><a name="p7756mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p id="p7789mcpsimp"><a name="p7789mcpsimp"></a><a name="p7789mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_chn\_align](#ss_mpi_vpss_get_chn_align)
...
<p id="p3803mcpsimp"><a name="p3803mcpsimp"></a><a name="p3803mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p3844mcpsimp"><a name="p3844mcpsimp"></a><a name="p3844mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p6377mcpsimp"><a name="p6377mcpsimp"></a><a name="p6377mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p6386mcpsimp"><a name="p6386mcpsimp"></a><a name="p6386mcpsimp"></a>取值范围：[<a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>, <a href="OT_VPSS_MAX_CHN_NUM.md">OT_VPSS_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.4.1.2 "><p xml:lang="sv-SE" id="p6395mcpsimp"><a name="p6395mcpsimp"></a><a name="p6395mcpsimp"></a>VPSS通道属性<span xml:lang="en-US" id="ph6396mcpsimp"><a name="ph6396mcpsimp"></a><a name="ph6396mcpsimp"></a>。</span></p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p6420mcpsimp"><a name="p6420mcpsimp"></a><a name="p6420mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   Group必须已创建。
-   仅Hi3403V100支持此接口。
-   具体成员取值及功能限制参考[ot\_vpss\_ext\_chn\_attr](ot_vpss_ext_chn_attr.md)结构体说明。
...
[ss\_mpi\_vpss\_get\_ext\_chn\_attr](#ss_mpi_vpss_get_ext_chn_attr)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p4947mcpsimp"><a name="p4947mcpsimp"></a><a name="p4947mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_set\_ext\_chn\_attr](#ss_mpi_vpss_set_ext_chn_attr)
...
<p id="p294mcpsimp"><a name="p294mcpsimp"></a><a name="p294mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_GRP_NUM.md">OT_VPSS_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p303mcpsimp"><a name="p303mcpsimp"></a><a name="p303mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p328mcpsimp"><a name="p328mcpsimp"></a><a name="p328mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   SS528V100/SS625V100/SS524V100/SS522V101 VPSS后16组（[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md)\~[OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1）不支持快速发送模式，设置不生效。
...
<p id="p7458mcpsimp"><a name="p7458mcpsimp"></a><a name="p7458mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p7483mcpsimp"><a name="p7483mcpsimp"></a><a name="p7483mcpsimp"></a>失败，请参考<span xml:lang="fr-FR" id="ph1140410351012"><a name="ph1140410351012"></a><a name="ph1140410351012"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_vpss\_get\_chn\_scale\_coef\_ type](#ss_mpi_vpss_get_chn_scale_coef_type)
...
[ss\_mpi\_vpss\_set\_chn\_scale\_coef\_type](#ss_mpi_vpss_set_chn_scale_coef_type)
...
[ss\_mpi\_vpss\_get\_chn\_cfg](#ss_mpi_vpss_get_chn_cfg)
...
[ss\_mpi\_vpss\_set\_chn\_cfg](#ss_mpi_vpss_set_chn_cfg)

## 数据类型<a name="ZH-CN_TOPIC_0000002408260102"></a>

VPSS模块相关数据类型定义如下：

-   [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)：定义VPSS Group的最大个数。
-   [OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md)：定义VPSS中VGS Group的起始组号。
-   [OT\_VPSS\_IP\_NUM](OT_VPSS_IP_NUM.md)：定义VPSS IP个数。
-   [OT\_VPSS0](OT_VPSS0.md)：定义VPSS IP0。
-   [OT\_VPSS1](OT_VPSS1.md)：定义VPSS IP1。
-   [OT\_VPSS2](OT_VPSS2.md)：定义VPSS IP2。
-   [OT\_VPSS\_MAX\_CHN\_NUM](OT_VPSS_MAX_CHN_NUM.md)：定义VPSS通道的最大个数。
-   [OT\_VPSS\_MAX\_PHYS\_CHN\_NUM](OT_VPSS_MAX_PHYS_CHN_NUM.md)：定义VPSS物理通道的最大个数。
-   [OT\_VPSS\_MAX\_EXT\_CHN\_NUM](OT_VPSS_MAX_EXT_CHN_NUM.md)：定义VPSS扩展通道的最大个数。
-   [OT\_VPSS\_MIN\_IMG\_WIDTH](OT_VPSS_MIN_IMG_WIDTH.md)：定义VPSS图像的最小宽度。
-   [OT\_VPSS\_MIN\_IMG\_HEIGHT](OT_VPSS_MIN_IMG_HEIGHT.md)：定义VPSS图像的最小高度。
-   [OT\_VPSS\_MAX\_IMG\_WIDTH](OT_VPSS_MAX_IMG_WIDTH.md)：定义VPSS图像的最大宽度。
-   [OT\_VPSS\_MAX\_DEI\_WIDTH](OT_VPSS_MAX_DEI_WIDTH.md)：定义DEI模式时VPSS图像的最大输入宽度。
-   [OT\_VPSS\_MAX\_SEG\_COMPACT\_WIDTH](OT_VPSS_MAX_SEG_COMPACT_WIDTH.md)：定义VPSS紧凑段压缩时，支持的最大图像宽度。
-   [OT\_VPSS\_MAX\_IMG\_HEIGHT](OT_VPSS_MAX_IMG_HEIGHT.md)：定义VPSS图像的最大高度。
-   [OT\_VPSS\_MAX\_ZOOMIN](OT_VPSS_MAX_ZOOMIN.md)：定义VPSS物理通道的最大放大倍数。
-   [OT\_VPSS\_MAX\_ZOOMOUT](OT_VPSS_MAX_ZOOMOUT.md)：定义VPSS物理通道的最大缩小倍数。
-   [ot\_vpss\_grp](ot_vpss_grp.md)：定义VPSS组号。
-   [ot\_vpss\_chn](ot_vpss_chn.md)：定义VPSS通道号。
-   [ot\_vpss\_sizer\_info](ot_vpss_sizer_info.md)：定义尺寸筛选功能所需信息。
-   [ot\_vpss\_crop\_info](ot_vpss_crop_info.md)：定义CROP功能所需信息。
-   [ot\_vpss\_nr\_type](ot_vpss_nr_type.md)：NR类型枚举。
-   [ot\_vpss\_nr\_motion\_mode](ot_vpss_nr_motion_mode.md)：NR的运动矢量模式。
-   [ot\_vpss\_nr\_attr](ot_vpss_nr_attr.md)：定义VPSS GRP的3DNR属性。
-   [ot\_vpss\_dei\_mode](ot_vpss_dei_mode.md)：定义DEI的模式。
-   [ot\_vpss\_grp\_attr](ot_vpss_grp_attr.md)：定义VPSS Group属性。
-   [ot\_vpss\_chn\_attr](ot_vpss_chn_attr.md)：定义VPSS物理通道属性。
-   [ot\_vpss\_chn\_mode](ot_vpss_chn_mode.md)：定义VPSS CHN工作模式。
-   [ot\_vpss\_ext\_chn\_attr](ot_vpss_ext_chn_attr.md)：定义扩展通道属性。
-   [ot\_vpss\_luma\_result](ot_vpss_luma_result.md)：定义VPSS 的组亮度和获取结果。
-   [ot\_vpss\_chn\_sharpen\_param](ot_vpss_chn_sharpen_param.md)：定义VPSS 的通道Sharpen参数。
-   [ot\_vpss\_nr\_version](ot_vpss_nr_version.md)：NR版本枚举。
-   [ot\_vpss\_nrx\_norm\_param\_v1](ot_vpss_nrx_norm_param_v1.md)：定义3DNR标准参数。
-   [ot\_vpss\_nrx\_param\_manual\_v2](ot_vpss_nrx_param_manual_v2.md)：定义3DNR手动参数。
-   [ot\_vpss\_nrx\_param\_auto\_v2](ot_vpss_nrx_param_auto_v2.md)：定义3DNR自动参数。
-   [ot\_vpss\_nrx\_norm\_param\_v2](ot_vpss_nrx_norm_param_v2.md)：定义3DNR标准参数。
-   [ot\_vpss\_nrx\_adv\_param](ot_vpss_nrx_adv_param.md)：定义3DNR高级参数。
-   [ot\_vpss\_grp\_nrx\_param](ot_vpss_grp_nrx_param.md)：定义3DNR参数及版本。
-   [ot\_vpss\_grp\_param](ot_vpss_grp_param.md)：定义VPSS Group参数。
-   [ot\_vpss\_grp\_ip\_type](ot_vpss_grp_ip_type.md)：VPSS组使用的硬件IP类型枚举。
-   [ot\_vpss\_grp\_cfg](ot_vpss_grp_cfg.md)：定义VPSS 组cfg配置信息。
-   [ot\_vpss\_mod\_param](ot_vpss_mod_param.md)：通过接口设置模块参数。
-   [ot\_vpss\_color\_range](ot_vpss_color_range.md)：定义色域的量化范围类型。
-   [ot\_vpss\_ldci\_gauss\_coef\_attr](ot_vpss_ldci_gauss_coef_attr.md)：定义LDCI的GAUSS分布属性参数。
-   [ot\_vpss\_ldci\_he\_weight\_attr](ot_vpss_ldci_he_weight_attr.md)：定义LDCI的直方图均衡与原图融合权重属性参数。
-   [ot\_vpss\_ldci\_attr](ot_vpss_ldci_attr.md)：定义LDCI属性。
-   [ot\_vpss\_chn\_cfg](ot_vpss_chn_cfg.md)：定义通道配置结构体。
-   [ot\_vpss\_nrx\_adv\_mode](ot_vpss_nrx_adv_mode.md)：定义ot\_vpss\_nrx\_adv\_param的参数模式。
...
当OT\_VPSS\_VGS\_GRP\_NO与[OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)相等时，表示不支持VGS Group功能。
...
SS524V100/SS522V101/Hi3403V100：
...
<p xml:lang="sv-SE" id="p5254mcpsimp"><a name="p5254mcpsimp"></a><a name="p5254mcpsimp"></a><span xml:lang="en-US" id="ph5255mcpsimp"><a name="ph5255mcpsimp"></a><a name="ph5255mcpsimp"></a>宽度</span>：[<a href="OT_VPSS_MIN_IMG_WIDTH.md">OT_VPSS_MIN_IMG_WIDTH</a>, <a href="OT_VPSS_MAX_IMG_WIDTH.md">OT_VPSS_MAX_IMG_WIDTH</a>]</p>
<p xml:lang="sv-SE" id="p5258mcpsimp"><a name="p5258mcpsimp"></a><a name="p5258mcpsimp"></a><span xml:lang="en-US" id="ph5259mcpsimp"><a name="ph5259mcpsimp"></a><a name="ph5259mcpsimp"></a>高度</span>：[<a href="OT_VPSS_MIN_IMG_HEIGHT.md"><span xml:lang="de-DE" id="ph5261mcpsimp"><a name="ph5261mcpsimp"></a><a name="ph5261mcpsimp"></a>OT_VPSS_MIN_IMG_HEIGHT</span></a>, <a href="OT_VPSS_MAX_IMG_HEIGHT.md">OT_VPSS_MAX_IMG_HEIGHT</a>]</p>
</td>
</tr>
</tbody>
</table>
...
-   Hi3403V100 VPSS开启3DNR时，裁剪宽高自动向下4像素对齐。
...
-   [ot\_vpss\_grp\_attr](#ot_vpss_grp_attr)
-   [ss\_mpi\_vpss\_create\_grp](#ss_mpi_vpss_create_grp)
-   [ss\_mpi\_vpss\_set\_grp\_attr](#ss_mpi_vpss_set_grp_attr)
-   [ss\_mpi\_vpss\_get\_grp\_attr](#ss_mpi_vpss_get_grp_attr)
...
<td class="cellrowborder" valign="top" width="79%" headers="mcps1.1.3.1.2 "><p id="p9126mcpsimp"><a name="p9126mcpsimp"></a><a name="p9126mcpsimp"></a><span xml:lang="sv-SE" id="ph9127mcpsimp"><a name="ph9127mcpsimp"></a><a name="ph9127mcpsimp"></a>黑白融合统计信息使能。</span>仅Hi3403V100支持mcf_en。该开关需要配合MCF组件使用，非MCF场景请勿开启mcf_en。</p>
...
<p id="p9180mcpsimp"><a name="p9180mcpsimp"></a><a name="p9180mcpsimp"></a>取值范围：[0, <a href="OT_VPSS_MAX_PHYS_CHN_NUM.md">OT_VPSS_MAX_PHYS_CHN_NUM</a>)</p>
</td>
</tr>
...
-   max\_width、max\_height用于分配3DNR参考帧、重构帧buffer，分配使用的内存大小是按16对齐后的宽高来计算的。
    ...
    -   对于Hi3403V100，当VPSS分块处理且开启3DNR时，输入图像宽度不能大于组属性最大宽度，开启3DNR时，buffer大小是否足够以运行时校验为准。VI\_ONLINE\_VPSS\_ONLINE模式，组属性最大宽高必须与VPSS实际输入图像分辨率一致。
...
-   组帧率控制只有VPSS工作在离线模式时，并且通过系统绑定送图像到VPSS时才会生效，通过[ss\_mpi\_vpss\_send\_frame](ss_mpi_vpss_send_frame.md)接口送图像到VPSS组帧率控制不生效。
...
-   SS524V100/SS528V100可通过[ss\_mpi\_vpss\_set\_grp\_attr](ss_mpi_vpss_set_grp_attr.md)接口动态设置max\_width和max\_height，若nr/dei/ie等功能在修改最大宽高之前已经开启，那么会先释放掉已经申请的参考帧内存\(ref\)与DEI内存\(dei\)，再根据当前设置属性重新分配。
...
-   Hi3403V100 mcf\_en使能后，仅支持以下接口：
    ...
    [ss\_mpi\_vpss\_get\_mod\_param](#ss_mpi_vpss_get_mod_param)

    [ss\_mpi\_vpss\_get\_chn\_fd](#ss_mpi_vpss_get_chn_fd)

    [ss\_mpi\_vpss\_close\_fd](#ss_mpi_vpss_close_fd)
...
-   Hi3403V100 VPSS通道视频格式支持OT\_VIDEO\_FORMAT\_LINEAR和OT\_VIDEO\_FORMAT\_TILE\_16x8，组号在\[[OT\_VPSS\_VGS\_GRP\_NO](OT_VPSS_VGS_GRP_NO.md),  [OT\_VPSS\_MAX\_GRP\_NUM](OT_VPSS_MAX_GRP_NUM.md)  - 1\]范围内的组不支持输出OT\_VIDEO\_FORMAT\_TILE\_16x8。分块处理时不支持输出OT\_VIDEO\_FORMAT\_TILE\_16x8。
...
-   绑定源物理通道必须合法，范围为\[0,  [OT\_VPSS\_MAX\_PHYS\_CHN\_NUM](OT_VPSS_MAX_PHYS_CHN_NUM.md)\)。
-   绑定源物理通道必须工作在USER模式。
...
[ss\_mpi\_vpss\_get\_grp\_rgn\_luma](#ss_mpi_vpss_get_grp_rgn_luma)
...
-   [ss\_mpi\_vpss\_set\_chn\_sharpen](#ss_mpi_vpss_set_chn_sharpen)
-   [ss\_mpi\_vpss\_get\_chn\_sharpen](#ss_mpi_vpss_get_chn_sharpen)
...
<td class="cellrowborder" valign="top" width="62%" headers="mcps1.1.3.1.2 "><p id="p2721mcpsimp"><a name="p2721mcpsimp"></a><a name="p2721mcpsimp"></a>用于Hi3403V100的NR标准参数。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="79%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p7250mcpsimp"><a name="p7250mcpsimp"></a><a name="p7250mcpsimp"></a><span xml:lang="en-US" id="ph7251mcpsimp"><a name="ph7251mcpsimp"></a><a name="ph7251mcpsimp"></a>3DNR接口的标准参数。</span>ot_vpss_nrx_v2的定义见《<span xml:lang="en-US" id="ph7252mcpsimp"><a name="ph7252mcpsimp"></a><a name="ph7252mcpsimp"></a>Hi3403V100/SS927V100</span> 3DNR参数配置说明》。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="61%" headers="mcps1.1.3.1.2 "><p id="p2100mcpsimp"><a name="p2100mcpsimp"></a><a name="p2100mcpsimp"></a>Hi3403V100的NR标准参数。</p>
</td>
</tr>
</tbody>
</table>
...
-   contrast和ie\_strength对于Hi3403V100无效，不做异常检查。
...
-   使用[ss\_mpi\_vpss\_set\_grp\_cfg](ss_mpi_vpss_set_grp_cfg.md)接口设置IP类型时，接口内部会等待上一帧完成，以避免同一个软件组前后帧提交到不同IP时，帧出现乱序。
...
-   分块数量不够时，请通过[ss\_mpi\_vpss\_set\_mod\_param](ss_mpi_vpss_set_mod_param.md)接口设置合理的分块节点数量。
...
定义[ot\_vpss\_nrx\_adv\_param](ot_vpss_nrx_adv_param.md)的参数模式。
