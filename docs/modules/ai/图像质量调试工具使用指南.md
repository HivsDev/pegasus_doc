...
![](figures/寄存器-算法参数调试页（以曝光参数为例）.png)
...
![](figures/具有特殊属性的寄存器-算法参数组示例（以FPN为例）.png)
...
<p id="p20888134219456"><a name="p20888134219456"></a><a name="p20888134219456"></a><a name="image118885425458"></a><a name="image118885425458"></a><span>![](figures/a.png)</span></p>
...
<p id="p1137710574455"><a name="p1137710574455"></a><a name="p1137710574455"></a><a name="image13377175711454"></a><a name="image13377175711454"></a><span>![](figures/b.png)</span></p>
</td>
</tr>
...
<p id="p1281610617461"><a name="p1281610617461"></a><a name="p1281610617461"></a><a name="image881612614620"></a><a name="image881612614620"></a><span>![](figures/c.png)</span></p>
</td>
</tr>
...
<p id="p8664191624611"><a name="p8664191624611"></a><a name="p8664191624611"></a><a name="image1466416160467"></a><a name="image1466416160467"></a><span>![](figures/d.png)</span></p>
</td>
</tr>
...
<p id="p857920274467"><a name="p857920274467"></a><a name="p857920274467"></a><a name="image257810277461"></a><a name="image257810277461"></a><span>![](figures/e.png)</span></p>
<p id="p376mcpsimp"><a name="p376mcpsimp"></a><a name="p376mcpsimp"></a>点击该按钮，会弹出一个对话框，矩阵的值会显示在对话框内的表格控件中：</p>
<p id="p915135561517"><a name="p915135561517"></a><a name="p915135561517"></a><a name="image960845512157"></a><a name="image960845512157"></a><span>![](figures/zh-cn_image_0000002498141998.png)</span></p>
...
![](figures/Sharpen-Texture-Strength调试界面.png)
...
![](figures/Sharpen-Edge-Strength调试界面.png)
...
![](figures/YUVsharpen曲线界面-结构体数据导出功能.png)
...
2.  硬件上电，在工具上确认以下参数。
    ...
    **图 1**  IR标定参数确认——RGBIR参数<a name="fig937mcpsimp"></a>  
    ![](figures/IR标定参数确认-RGBIR参数.png)

    **图 2**  IR标定参数确认——RGBIR矩阵<a name="fig939mcpsimp"></a>  
    ![](figures/IR标定参数确认-RGBIR矩阵.png)
...
![](figures/LAB自定义对话框.png)

**图 2**  LAB点击颜色弹框选择<a name="fig14650256161210"></a>  
![](figures/LAB点击颜色弹框选择.png)
...
2.  点击“OK”按钮。
    ...
    **图 2**  Color Check Free场景框选<a name="fig16358165614336"></a>  
    ![](figures/Color-Check-Free场景框选.png)

    **图 3**  Color Check HSL场景框选<a name="fig6769140153515"></a>  
    ![](figures/Color-Check-HSL场景框选.png)
...
![](figures/通过截止频率获取滤波系数（窄带）.png)

**图 2**  通过截止频率获取滤波系数（宽带）<a name="fig1448214180256"></a>  
![](figures/通过截止频率获取滤波系数（宽带）.png)
...
![](figures/导入RAW数据后的RAW实用工具界面.png)
...
![](figures/PQTools-Stitching-Tool界面示意.png)
...
![](figures/建议的镜头模型标定方法抓取的标定图片示例.png)
...
![](figures/二进制数据处理对话框-（演进型）.png)

**图 2**  二进制数据处理对话框（稳定型）<a name="fig1675418825310"></a>  
![](figures/二进制数据处理对话框（稳定型）.png)
...
![](figures/Config-Stitch数据源设置.png)
...
![](figures/使用RAW-Utilities工具后图像异常示意图.png)
...
![](figures/若未经过Convert-Calibration-Data报错误图.png)
