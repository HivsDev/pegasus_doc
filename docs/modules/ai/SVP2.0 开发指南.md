...
<tbody><tr id="row227mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p229mcpsimp"><a name="p229mcpsimp"></a><a name="p229mcpsimp"></a><a name="image126"></a><a name="image126"></a><span>![](figures/zh-cn_image_0000002441731557.png)</span></p>
</td>
...
<tr id="row232mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p234mcpsimp"><a name="p234mcpsimp"></a><a name="p234mcpsimp"></a><a name="image127"></a><a name="image127"></a><span>![](figures/zh-cn_image_0000002441691713.png)</span></p>
</td>
...
<tr id="row237mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p239mcpsimp"><a name="p239mcpsimp"></a><a name="p239mcpsimp"></a><a name="image128"></a><a name="image128"></a><span>![](figures/zh-cn_image_0000002441691709.png)</span></p>
</td>
...
<tr id="row242mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p244mcpsimp"><a name="p244mcpsimp"></a><a name="p244mcpsimp"></a><a name="image129"></a><a name="image129"></a><span>![](figures/zh-cn_image_0000002441731553.png)</span></p>
</td>
...
<tr id="row248mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p250mcpsimp"><a name="p250mcpsimp"></a><a name="p250mcpsimp"></a><a name="image130"></a><a name="image130"></a><span>![](figures/zh-cn_image_0000002441691705.png)</span></p>
</td>
...
2.  进入Find and Install a Configuration Build界面，点击“Browse”，选择待安装配置核（此处以Otechn\_VisionQ6\_v3\_win32\_redist为例），点击“OK”即开始安装；
    ...
    **图 2**  Find and Install a Configuration Build<a name="fig72876154572"></a>  
    ![](figures/Find-and-Install-a-Configuration-Build.png)
