...
<tr id="row1795219203403"><td class="cellrowborder" valign="top" width="31%" headers="mcps1.1.3.1.1 "><p id="p3421112315406"><a name="p3421112315406"></a><a name="p3421112315406"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row227mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p229mcpsimp"><a name="p229mcpsimp"></a><a name="p229mcpsimp"></a><a name="image126"></a><a name="image126"></a><span><img src="figures/zh-cn_image_0000002441731557.png" alt="" /></span></p>
</td>
...
<tr id="row232mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p234mcpsimp"><a name="p234mcpsimp"></a><a name="p234mcpsimp"></a><a name="image127"></a><a name="image127"></a><span><img src="figures/zh-cn_image_0000002441691713.png" alt="" /></span></p>
</td>
...
<tr id="row237mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p239mcpsimp"><a name="p239mcpsimp"></a><a name="p239mcpsimp"></a><a name="image128"></a><a name="image128"></a><span><img src="figures/zh-cn_image_0000002441691709.png" alt="" /></span></p>
</td>
...
<tr id="row242mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p244mcpsimp"><a name="p244mcpsimp"></a><a name="p244mcpsimp"></a><a name="image129"></a><a name="image129"></a><span><img src="figures/zh-cn_image_0000002441731553.png" alt="" /></span></p>
</td>
...
<tr id="row248mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p250mcpsimp"><a name="p250mcpsimp"></a><a name="p250mcpsimp"></a><a name="image130"></a><a name="image130"></a><span><img src="figures/zh-cn_image_0000002441691705.png" alt="" /></span></p>
</td>
...
<img src="figures/SVP开发框架.png" alt="" />
...
<tr id="row9294425145618"><td class="cellrowborder" valign="top" width="44%" headers="mcps1.2.4.1.1 "><p id="p1753616261569"><a name="p1753616261569"></a><a name="p1753616261569"></a>Hi3403V100</p>
</td>
...
<tr id="row15850154019567"><td class="cellrowborder" valign="top" width="44%" headers="mcps1.2.3.1.1 "><p id="p352014216560"><a name="p352014216560"></a><a name="p352014216560"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row319mcpsimp"><td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.4.1.1 "><p id="p321mcpsimp"><a name="p321mcpsimp"></a><a name="p321mcpsimp"></a>Hi3403V100/Hi3403V100</p>
</td>
...
<tr id="row7370181914570"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.8.1.1 "><p id="p231112165710"><a name="p231112165710"></a><a name="p231112165710"></a>Hi3403V100</p>
</td>
...
1.  打开Xplorer 8.0.7，右键System Overview窗口下的Configurations，如[图1](#fig31925394563)所示，点击Find and Install a Configuration Build；
    ...
    **图 1**  System Overview<a name="fig31925394563"></a>  
    <img src="figures/System-Overview.png" alt="" />
...
2.  进入Find and Install a Configuration Build界面，点击“Browse”，选择待安装配置核（此处以Otechn\_VisionQ6\_v3\_win32\_redist为例），点击“OK”即开始安装；
    ...
    **图 2**  Find and Install a Configuration Build<a name="fig72876154572"></a>  
    <img src="figures/Find-and-Install-a-Configuration-Build.png" alt="" />
    ...
    **图 3**  查看安装好的配置核<a name="fig1742717500572"></a>  
    <img src="figures/查看安装好的配置核.png" alt="" />
...
3.  运行工程时（以HelloWorld为例），按照[图4](#fig185297106715)选择C: Otechn\_VisionQ6\_v3，即表示使用的是Otechn\_VisionQ6\_v3配置核。
    ...
    **图 4**  创建的工程界面<a name="fig185297106715"></a>  
    <img src="figures/创建的工程界面.png" alt="" />
...
1.  点击Xplorer的Tools-\>Stack Usage选项。
    ...
    **图 1**  查看栈信息操作界面<a name="fig19428194743813"></a>  
    <img src="figures/查看栈信息操作界面.png" alt="" />
...
2.  此时会出现Stack Usage的窗口。选择一个工程，选择其编译好的可执行文件右键选择“Binary File Info”，选择“Stack Usage”查看该文件的Stack使用情况。
    ...
    **图 2**  显示栈信息窗口<a name="fig1931604853914"></a>  
    <img src="figures/显示栈信息窗口.png" alt="" />
...
<img src="figures/DSP应用程序开发框图.png" alt="" />
...
> **注意：** 
>为提高编译速度，在DSP端库/代码没有加编译优化选项（-O），用户可以在调试性能阶段添加上去。以下添加-O2为例，在发布包Hi3403V100\_SDK\_V2.0.0.3\_B020/smp/dsp\_liteos/dspXX/Makefile.param\(在这里以Hi3403V100某个版本的smp为例，XX表示DSP核编号\)文件添加即可。<img src="figures/zh-cn_image_0000002441731525.png" alt="" />
...
<img src="figures/zh-cn_image_0000002441691685.png" alt="" />

适配位置2：适配帧结构体字段pFrameBuffer/pFrameData类型为64比特操作

<img src="figures/zh-cn_image_0000002408292270.png" alt="" />

适配位置3：适配DRAM地址有效性校验

<img src="figures/zh-cn_image_0000002441731533.png" alt="" />

适配位置4：增加类型转换和高低32比特操作宏

<img src="figures/zh-cn_image_0000002408132366.png" alt="" />

##### tileManager\_api.h头文件适配<a name="ZH-CN_TOPIC_0000002441691657"></a>

适配位置1：修改Bank数

<img src="figures/zh-cn_image_0000002441731541.png" alt="" />

适配位置2：适配帧结构体字段pFrameBuffer/pFrameData类型为64比特操作

<img src="figures/zh-cn_image_0000002441731537.png" alt="" />

适配位置3：适配帧结构体字段pFrameBuffer/pFrameData类型为64比特

<img src="figures/zh-cn_image_0000002408292278.png" alt="" />

适配位置4：适配xvAddIdmaRequestMultiChannel目的和源参数指针类型为64比特

<img src="figures/zh-cn_image_0000002441691689.png" alt="" />

适配位置5：适配xvCreateFrame帧地址参数指针类型为64比特

<img src="figures/zh-cn_image_0000002441691693.png" alt="" />

##### tileManager.c源文件适配<a name="ZH-CN_TOPIC_0000002408132346"></a>

适配位置1：适配xvInitMemAllocator 函数DRAM校验

<img src="figures/zh-cn_image_0000002408132378.png" alt="" />

适配位置2：适配xvCreateFrame帧地址参数指针类型为64比特及校验

<img src="figures/zh-cn_image_0000002408132374.png" alt="" />

适配位置3：适配内联函数addIdmaRequestInlineMultiChannel增加宽地址操作，并挪到实现xvAddIdmaRequestMultiChannel函数前

<img src="figures/zh-cn_image_0000002441731545.png" alt="" />

适配位置4：适配xvAddIdmaRequestMultiChannel目的和源参数指针类型为64比特

<img src="figures/zh-cn_image_0000002441731565.png" alt="" />

适配位置5：适配xvAddIdmaRequestMultiChannel目的和源参数地址校验以及拷贝操作替换成内联函数addIdmaRequestInlineMultiChannel

<img src="figures/zh-cn_image_0000002441731549.png" alt="" />

适配位置6：适配solveForX源64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408132382.png" alt="" />

<img src="figures/zh-cn_image_0000002408292290.png" alt="" />

适配位置7：适配xvReqTileTransferInMultiChannel源64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408132394.png" alt="" />

<img src="figures/zh-cn_image_0000002441691701.png" alt="" />

<img src="figures/zh-cn_image_0000002408292286.png" alt="" />

适配位置8：增加内联IDMA宽地址二维拷贝操作

<img src="figures/zh-cn_image_0000002408132390.png" alt="" />

适配位置9：适配xvReqTileTransferInFastMultiChannel源64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408292282.png" alt="" />

<img src="figures/zh-cn_image_0000002408132398.png" alt="" />

适配位置10：适配xvReqTileTransferInFast16MultiChannel源64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408292294.png" alt="" />

<img src="figures/zh-cn_image_0000002408292298.png" alt="" />

适配位置11：适配xvReqTileTransferOutMultiChannel目的64比特及宽地址操作

<img src="figures/zh-cn_image_0000002441691717.png" alt="" />

<img src="figures/zh-cn_image_0000002408292302.png" alt="" />

适配位置12：适配xvReqTileTransferOutFastMultiChannel目的64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408132386.png" alt="" />

适配位置13：适配xvReqTileTransferOutFast16MultiChannel目的64比特及宽地址操作

<img src="figures/zh-cn_image_0000002408292306.png" alt="" />

适配位置14：适配xvPadEdges 帧指针字段有效性判断

<img src="figures/zh-cn_image_0000002441691697.png" alt="" />

适配位置15：适配xvPadEdges16 帧指针字段有效性判断

<img src="figures/zh-cn_image_0000002408132402.png" alt="" />

适配位置16：去掉xvCheckForIdmaIndexMultiChannel函数参数index小于0校验

<img src="figures/zh-cn_image_0000002441731561.png" alt="" />
...
>-   Hi3403V100/Hi3403V100 CPU访问的DDR地址区间\[0x40000000, 0x2FFFFFFFF\], 在DSP端IDMA会映射到\[0x440000000, 0x6FFFFFFFF\]地址区间来访问，即IDMA访问的DDR地址需要加上偏移0x400000000\(加上idma\_offset值\),此部分映射框架已搭建好了，用户参考框架Sample使用即可。
