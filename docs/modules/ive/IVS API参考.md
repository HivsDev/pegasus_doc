...
-   [ss\_ivs\_md\_init]：初始化。
-   [ss\_ivs\_md\_exit]：退出。
-   [ss\_ivs\_md\_create\_chn]：创建MD通道。
-   [ss\_ivs\_md\_destroy\_chn]：销毁MD通道。
-   [ss\_ivs\_md\_set\_chn\_attr]：设置MD通道属性。
-   [ss\_ivs\_md\_get\_chn\_attr]：获取MD通道属性。
-   [ss\_ivs\_md\_get\_bg]：获取背景。
-   [ss\_ivs\_md\_proc]：侦测处理。
...
必须先调用[ss\_ivs\_md\_init]初始化才能调用此接口退出，否则返回错误。
...
必须先调用[ss\_ivs\_md\_init]初始化，否则返回错误。
...
-   [ss\_ivs\_md\_destroy\_chn]
-   [ss\_ivs\_md\_set\_chn\_attr]
-   [ss\_ivs\_md\_get\_chn\_attr]
-   [ss\_ivs\_md\_get\_bg]
-   [ss\_ivs\_md\_proc]
...
-   必须先调用[ss\_ivs\_md\_init]初始化，否则返回错误。
-   md\_chn必须为[ss\_ivs\_md\_create\_chn]已创建的通道号,否则返回错误。
