...
<tr id="row10658134621312"><td class="cellrowborder" valign="top" width="31%" headers="mcps1.1.3.1.1 "><p id="p812864918138"><a name="p812864918138"></a><a name="p812864918138"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row187mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p189mcpsimp"><a name="p189mcpsimp"></a><a name="p189mcpsimp"></a><a name="image103"></a><a name="image103"></a><span><img src="figures/zh-cn_image_0000002424362286.png" alt="" /></span></p>
</td>
...
<tr id="row192mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p194mcpsimp"><a name="p194mcpsimp"></a><a name="p194mcpsimp"></a><a name="image104"></a><a name="image104"></a><span><img src="figures/zh-cn_image_0000002424202450.png" alt="" /></span></p>
</td>
...
<tr id="row197mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p199mcpsimp"><a name="p199mcpsimp"></a><a name="p199mcpsimp"></a><a name="image105"></a><a name="image105"></a><span><img src="figures/zh-cn_image_0000002457841081.png" alt="" /></span></p>
</td>
...
<tr id="row202mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p204mcpsimp"><a name="p204mcpsimp"></a><a name="p204mcpsimp"></a><a name="image106"></a><a name="image106"></a><span><img src="figures/zh-cn_image_0000002457841065.png" alt="" /></span></p>
</td>
...
<tr id="row208mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p210mcpsimp"><a name="p210mcpsimp"></a><a name="p210mcpsimp"></a><a name="image107"></a><a name="image107"></a><span><img src="figures/zh-cn_image_0000002424362302.png" alt="" /></span></p>
</td>
...
<img src="figures/MCF模块基本原理图.png" alt="" />
...
<img src="figures/4K-30fps-MCF端到端调试流程图.png" alt="" />

**图 2**  4M@30fps MCF端到端调试流程图<a name="fig082311423517"></a>  
<img src="figures/4M-30fps-MCF端到端调试流程图.png" alt="" />
...
-   调节融合后图像的颜色
    ...
    -   为了避免低照下色噪的饱和度被拉大，可以设置cc\_thd\_y。当彩色图像的亮度低于阈值cc\_thd\_y时，会从该阈值到亮度为0的区间，逐步减小色度饱和度的补偿程度。
        ...
        **图 1**  MCF调试风格示例图<a name="fig2192183017464"></a>  
        <img src="figures/MCF调试风格示例图.png" alt="" />
...
<img src="figures/MCF标定场景推荐示例图.png" alt="" />
...
3.  对得到的标定参数进行处理。
    ...
    <img src="figures/zh-cn_formulaimage_0000002424202430.png" alt="" />

    则实际用于矫正的矩阵系数修正为：

    <img src="figures/zh-cn_formulaimage_0000002424362262.png" alt="" />
