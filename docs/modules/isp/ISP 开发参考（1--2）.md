...
<tr id="row5694533162316"><td class="cellrowborder" valign="top" width="32%" headers="mcps1.1.3.1.1 "><p id="p36535379232"><a name="p36535379232"></a><a name="p36535379232"></a>Hi3403V100</p>
</td>
...
<tr id="row149mcpsimp"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p151mcpsimp"><a name="p151mcpsimp"></a><a name="p151mcpsimp"></a><a name="image103"></a><a name="image103"></a><span><img src="figures/zh-cn_image_0000002506607747.png" alt="" /></span></p>
</td>
...
<tr id="row154mcpsimp"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p156mcpsimp"><a name="p156mcpsimp"></a><a name="p156mcpsimp"></a><a name="image104"></a><a name="image104"></a><span><img src="figures/zh-cn_image_0000002506567693.png" alt="" /></span></p>
</td>
...
<tr id="row159mcpsimp"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p161mcpsimp"><a name="p161mcpsimp"></a><a name="p161mcpsimp"></a><a name="image105"></a><a name="image105"></a><span><img src="figures/zh-cn_image_0000002474527736.png" alt="" /></span></p>
</td>
...
<tr id="row165mcpsimp"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p167mcpsimp"><a name="p167mcpsimp"></a><a name="p167mcpsimp"></a><a name="image106"></a><a name="image106"></a><span><img src="figures/zh-cn_image_0000002474367804.png" alt="" /></span></p>
</td>
...
<img src="figures/ISP控制结构示意图.png" alt="" title="ISP控制结构示意图" />
...
<img src="figures/ISP-firmware-架构.png" alt="" title="ISP-firmware-架构" />
...
<img src="figures/ISP-firmware-内部流程.png" alt="" title="ISP-firmware-内部流程" />

**图 2**  ISP firmware 软件结构<a name="fig81434122714"></a>  
<img src="figures/ISP-firmware-软件结构.png" alt="" title="ISP-firmware-软件结构" />
...
<img src="figures/ISP-firmware使用流程.png" alt="" title="ISP-firmware使用流程" />
...
<img src="figures/ISP-firmware-文件组织.png" alt="" title="ISP-firmware-文件组织" />
...
<img src="figures/ISP库与sensor库间的接口.png" alt="" title="ISP库与sensor库间的接口" />
...
<img src="figures/ISP库与AE库间的接口.png" alt="" title="ISP库与AE库间的接口" />
...
<img src="figures/ISP库与AWB库间的接口.png" alt="" title="ISP库与AWB库间的接口" />
...
<img src="figures/白色区域选择相关参数.png" alt="" title="白色区域选择相关参数" />
...
2.  ot\_isp\_run\_wakeup\_select默认配置为OT\_ISP\_RUN\_WAKEUP\_FE\_START，可匹配ss\_mpi\_isp\_run接口使用，推荐调用流程如[图1](#fig86541627175814)。
    ...
    **图 1**  接口调用流程\(1\)<a name="fig86541627175814"></a>  
    <img src="figures/接口调用流程(1" alt="" />.png "接口调用流程(1)")
...
1.  如需要从VI捞帧再送raw处理，则可将 ot\_isp\_run\_wakeup\_select配置为OT\_ISP\_RUN\_WAKEUP\_BE\_END，可匹配ss\_mpi\_isp\_run接口使用，推荐调用流程如[图2](#fig1140172181212)所示。这种配置的软件通路为run\_be通路。客户自行调ss\_mpi\_vi\_send\_pipe\_raw接口送raw时，应尽量保证送帧间隔均匀，如送raw持续不均匀，会对曝光比切换、模式切换等场景图像效果产生一定影响。
    ...
    **图 2**  接口调用流程\(2\)<a name="fig1140172181212"></a>  
    <img src="figures/接口调用流程(2" alt="" />.png "接口调用流程(2)")
