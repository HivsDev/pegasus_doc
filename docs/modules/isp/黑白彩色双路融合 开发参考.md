...
<tr id="row149mcpsimp"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p151mcpsimp"><a name="p151mcpsimp"></a><a name="p151mcpsimp"></a><a name="image103"></a><a name="image103"></a><span><img src="figures/zh-cn_image_0000002457869909.png" alt="" /></span></p>
</td>
...
<tr id="row154mcpsimp"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p156mcpsimp"><a name="p156mcpsimp"></a><a name="p156mcpsimp"></a><a name="image104"></a><a name="image104"></a><span><img src="figures/zh-cn_image_0000002424351010.png" alt="" /></span></p>
</td>
...
<tr id="row159mcpsimp"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p161mcpsimp"><a name="p161mcpsimp"></a><a name="p161mcpsimp"></a><a name="image105"></a><a name="image105"></a><span><img src="figures/zh-cn_image_0000002457869913.png" alt="" /></span></p>
</td>
...
<tr id="row165mcpsimp"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p167mcpsimp"><a name="p167mcpsimp"></a><a name="p167mcpsimp"></a><a name="image106"></a><a name="image106"></a><span><img src="figures/zh-cn_image_0000002424191174.png" alt="" /></span></p>
</td>
...
-   GROUP
    ...
    MCF对用户提供组（GROUP）的概念。最大可用数为[OT\_MCF\_MAX\_GRP\_NUM](OT_MCF_MAX_GRP_NUM.md)个，各GROUP分时复用MCF硬件。每个MCF GROUP包含多个PIPE和多个通道。

-   PIPE

    MCF组的PIPE。用于输入黑白彩色双路源图像。PIPE的数目即融合路数，为[OT\_MCF\_PIPE\_NUM](OT_MCF_PIPE_NUM.md)。用户可以通过系统绑定和前端相连或者发送图像到PIPE中融合处理。
...
<img src="figures/MCF上下文关系.png" alt="" />
...
<img src="figures/MCF场景数据流图.png" alt="" />
...
<img src="figures/MCF内部处理流程图.png" alt="" />
...
<tbody><tr id="row350mcpsimp"><td class="cellrowborder" valign="top" width="30.693069306930692%" headers="mcps1.2.5.1.1 mcps1.2.5.2.1 "><p id="p352mcpsimp"><a name="p352mcpsimp"></a><a name="p352mcpsimp"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row573mcpsimp"><td class="cellrowborder" valign="top" width="15%" headers="mcps1.2.8.1.1 mcps1.2.8.2.1 "><p xml:lang="fr-FR" id="p575mcpsimp"><a name="p575mcpsimp"></a><a name="p575mcpsimp"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row612mcpsimp"><td class="cellrowborder" valign="top" width="17.82178217821782%" headers="mcps1.2.6.1.1 mcps1.2.6.2.1 "><p xml:lang="fr-FR" id="p614mcpsimp"><a name="p614mcpsimp"></a><a name="p614mcpsimp"></a>Hi3403V100</p>
</td>
...
-   [ss\_mpi\_mcf\_create\_grp](ss_mpi_mcf_create_grp.md)：创建一个MCF GROUP。
-   [ss\_mpi\_mcf\_destroy\_grp](ss_mpi_mcf_destroy_grp.md)：销毁一个MCF GROUP。
-   [ss\_mpi\_mcf\_reset\_grp](ss_mpi_mcf_reset_grp.md)：复位MCF GROUP。
-   [ss\_mpi\_mcf\_start\_grp](ss_mpi_mcf_start_grp.md)：启用MCF GROUP。
-   [ss\_mpi\_mcf\_stop\_grp](ss_mpi_mcf_stop_grp.md)：禁用MCF GROUP。
-   [ss\_mpi\_mcf\_set\_grp\_attr](ss_mpi_mcf_set_grp_attr.md)：设置MCF GROUP属性。
-   [ss\_mpi\_mcf\_get\_grp\_attr](ss_mpi_mcf_get_grp_attr.md)：获取MCF GROUP属性。
-   [ss\_mpi\_mcf\_set\_alg\_param](ss_mpi_mcf_set_alg_param.md)：设置MCF算法参数。
-   [ss\_mpi\_mcf\_get\_alg\_param](ss_mpi_mcf_get_alg_param.md)：获取MCF算法参数。
-   [ss\_mpi\_mcf\_set\_grp\_crop](ss_mpi_mcf_set_grp_crop.md)：设置MCF组CROP功能属性，用来裁剪MCF融合后产生的黑边。
-   [ss\_mpi\_mcf\_get\_grp\_crop](ss_mpi_mcf_get_grp_crop.md)：获取MCF组CROP功能属性。
-   [ss\_mpi\_mcf\_send\_pipe\_frame](ss_mpi_mcf_send_pipe_frame.md)：用户向MCFpipe发送数据。
-   [ss\_mpi\_mcf\_set\_chn\_attr](ss_mpi_mcf_set_chn_attr.md)：设置MCF通道属性。
-   [ss\_mpi\_mcf\_get\_chn\_attr](ss_mpi_mcf_get_chn_attr.md)：获取MCF通道属性。
-   [ss\_mpi\_mcf\_enable\_chn](ss_mpi_mcf_enable_chn.md)：启用MCF通道。
-   [ss\_mpi\_mcf\_disable\_chn](ss_mpi_mcf_disable_chn.md)：禁用MCF通道。
-   [ss\_mpi\_mcf\_get\_chn\_frame](ss_mpi_mcf_get_chn_frame.md)：获取MCF通道帧数据。
-   [ss\_mpi\_mcf\_release\_chn\_frame](ss_mpi_mcf_release_chn_frame.md)：释放 MCF通道帧数据。
-   [ss\_mpi\_mcf\_set\_low\_delay\_attr](ss_mpi_mcf_set_low_delay_attr.md)：设置低延迟输出属性。
-   [ss\_mpi\_mcf\_get\_low\_delay\_attr](ss_mpi_mcf_get_low_delay_attr.md)：获取低延迟输出属性。
-   [ss\_mpi\_mcf\_attach\_vb\_pool](ss_mpi_mcf_attach_vb_pool.md)：将MCF绑定到某个视频缓存VB池中。
-   [ss\_mpi\_mcf\_detach\_vb\_pool](ss_mpi_mcf_detach_vb_pool.md)：将MCF的通道从某个视频缓存VB池中解绑定。
-   [ss\_mpi\_mcf\_set\_chn\_align](ss_mpi_mcf_set_chn_align.md)：设置MCF通道输出YUV数据的行stride对齐。
-   [ss\_mpi\_mcf\_get\_chn\_align](ss_mpi_mcf_get_chn_align.md)：获取MCF通道输出YUV数据的行stride对齐。
-   [ss\_mpi\_mcf\_set\_chn\_rotation](ss_mpi_mcf_set_chn_rotation.md)：设置MCF通道图像固定角度旋转属性。
-   [ss\_mpi\_mcf\_get\_chn\_rotation](ss_mpi_mcf_get_chn_rotation.md)：获取MCF通道图像固定角度旋转属性。
-   [ss\_mpi\_mcf\_set\_ext\_chn\_attr](ss_mpi_mcf_set_ext_chn_attr.md)：设置MCF GROUP扩展通道属性。
-   [ss\_mpi\_mcf\_get\_ext\_chn\_attr](ss_mpi_mcf_get_ext_chn_attr.md)：获取MCF GROUP扩展通道属性。
-   [ss\_mpi\_mcf\_set\_chn\_crop](ss_mpi_mcf_set_chn_crop.md)：设置MCF通道裁剪功能属性。
-   [ss\_mpi\_mcf\_get\_chn\_crop](ss_mpi_mcf_get_chn_crop.md)：获取MCF通道裁剪功能属性。
-   [ss\_mpi\_mcf\_get\_chn\_rgn\_luma](ss_mpi_mcf_get_chn_rgn_luma.md)：获取指定图像区域的亮度总和。
-   [ss\_mpi\_mcf\_get\_chn\_fd](ss_mpi_mcf_get_chn_fd.md)：获取MCF通道对应的设备文件句柄。
-   [ss\_mpi\_mcf\_close\_fd](ss_mpi_mcf_close_fd.md)：关闭获取的文件句柄。
-   [ss\_mpi\_mcf\_calibration](ss_mpi_mcf_calibration.md)：标定参数接口。
-   [ss\_mpi\_mcf\_set\_vi\_attr](ss_mpi_mcf_set_vi_attr.md)：设置MCF场景下VI属性。
-   [ss\_mpi\_mcf\_get\_vi\_attr](ss_mpi_mcf_get_vi_attr.md)：获取MCF场景下VI属性。
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p6293mcpsimp"><a name="p6293mcpsimp"></a><a name="p6293mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_destroy\_grp](#ss_mpi_mcf_destroy_grp)
...
<p id="p773mcpsimp"><a name="p773mcpsimp"></a><a name="p773mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p798mcpsimp"><a name="p798mcpsimp"></a><a name="p798mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_create\_grp](#ss_mpi_mcf_create_grp)
...
<p id="p842mcpsimp"><a name="p842mcpsimp"></a><a name="p842mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p867mcpsimp"><a name="p867mcpsimp"></a><a name="p867mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
请参见[ss\_mpi\_mcf\_create\_grp](ss_mpi_mcf_create_grp.md)。
...
<p id="p907mcpsimp"><a name="p907mcpsimp"></a><a name="p907mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p932mcpsimp"><a name="p932mcpsimp"></a><a name="p932mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_stop\_grp](#ss_mpi_mcf_stop_grp)
...
<p id="p975mcpsimp"><a name="p975mcpsimp"></a><a name="p975mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1000mcpsimp"><a name="p1000mcpsimp"></a><a name="p1000mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   结束成功后，再次调用[ss\_mpi\_mcf\_start\_grp](ss_mpi_mcf_start_grp.md)接口可返回成功。
...
[ss\_mpi\_mcf\_start\_grp](#ss_mpi_mcf_start_grp)
...
<p id="p1047mcpsimp"><a name="p1047mcpsimp"></a><a name="p1047mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1079mcpsimp"><a name="p1079mcpsimp"></a><a name="p1079mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   GROUP属性必须合法，具体请参见[ot\_mcf\_grp\_attr](ot_mcf_grp_attr.md)。
...
[ss\_mpi\_mcf\_get\_grp\_attr](#ss_mpi_mcf_get_grp_attr)
...
<p id="p1126mcpsimp"><a name="p1126mcpsimp"></a><a name="p1126mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1158mcpsimp"><a name="p1158mcpsimp"></a><a name="p1158mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_set\_grp\_attr](#ss_mpi_mcf_set_grp_attr)
...
<p id="p1202mcpsimp"><a name="p1202mcpsimp"></a><a name="p1202mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1234mcpsimp"><a name="p1234mcpsimp"></a><a name="p1234mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_get\_alg\_param](#ss_mpi_mcf_get_alg_param)
...
<p id="p1280mcpsimp"><a name="p1280mcpsimp"></a><a name="p1280mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1312mcpsimp"><a name="p1312mcpsimp"></a><a name="p1312mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_set\_alg\_param](#ss_mpi_mcf_set_alg_param)
...
<p id="p1352mcpsimp"><a name="p1352mcpsimp"></a><a name="p1352mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1386mcpsimp"><a name="p1386mcpsimp"></a><a name="p1386mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_get\_grp\_crop](#ss_mpi_mcf_get_grp_crop)
...
<p id="p1429mcpsimp"><a name="p1429mcpsimp"></a><a name="p1429mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1462mcpsimp"><a name="p1462mcpsimp"></a><a name="p1462mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_set\_grp\_crop](#ss_mpi_mcf_set_grp_crop)
...
<p id="p1504mcpsimp"><a name="p1504mcpsimp"></a><a name="p1504mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1513mcpsimp"><a name="p1513mcpsimp"></a><a name="p1513mcpsimp"></a>取值范围：[0, <a href="OT_MCF_PIPE_NUM.md">OT_MCF_PIPE_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1554mcpsimp"><a name="p1554mcpsimp"></a><a name="p1554mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p1599mcpsimp"><a name="p1599mcpsimp"></a><a name="p1599mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1608mcpsimp"><a name="p1608mcpsimp"></a><a name="p1608mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1640mcpsimp"><a name="p1640mcpsimp"></a><a name="p1640mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p1685mcpsimp"><a name="p1685mcpsimp"></a><a name="p1685mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1694mcpsimp"><a name="p1694mcpsimp"></a><a name="p1694mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1726mcpsimp"><a name="p1726mcpsimp"></a><a name="p1726mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p1769mcpsimp"><a name="p1769mcpsimp"></a><a name="p1769mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1778mcpsimp"><a name="p1778mcpsimp"></a><a name="p1778mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1803mcpsimp"><a name="p1803mcpsimp"></a><a name="p1803mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p1846mcpsimp"><a name="p1846mcpsimp"></a><a name="p1846mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1855mcpsimp"><a name="p1855mcpsimp"></a><a name="p1855mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1880mcpsimp"><a name="p1880mcpsimp"></a><a name="p1880mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p1923mcpsimp"><a name="p1923mcpsimp"></a><a name="p1923mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p1932mcpsimp"><a name="p1932mcpsimp"></a><a name="p1932mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p1972mcpsimp"><a name="p1972mcpsimp"></a><a name="p1972mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2021mcpsimp"><a name="p2021mcpsimp"></a><a name="p2021mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2030mcpsimp"><a name="p2030mcpsimp"></a><a name="p2030mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2063mcpsimp"><a name="p2063mcpsimp"></a><a name="p2063mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   GROUP必须已创建。
-   此接口需与[ss\_mpi\_mcf\_get\_chn\_frame](ss_mpi_mcf_get_chn_frame.md)配对使用。
...
<p id="p2109mcpsimp"><a name="p2109mcpsimp"></a><a name="p2109mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2118mcpsimp"><a name="p2118mcpsimp"></a><a name="p2118mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2150mcpsimp"><a name="p2150mcpsimp"></a><a name="p2150mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2200mcpsimp"><a name="p2200mcpsimp"></a><a name="p2200mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2209mcpsimp"><a name="p2209mcpsimp"></a><a name="p2209mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2241mcpsimp"><a name="p2241mcpsimp"></a><a name="p2241mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2282mcpsimp"><a name="p2282mcpsimp"></a><a name="p2282mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2291mcpsimp"><a name="p2291mcpsimp"></a><a name="p2291mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2323mcpsimp"><a name="p2323mcpsimp"></a><a name="p2323mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   必须保证组已创建。用户必须调用接口ss\_mpi\_vb\_create\_pool（具体描述请参见《MPP媒体处理软件V5.0开发参考》“系统控制”章节。）创建一个视频缓存VB池，再通过调用接口[ss\_mpi\_mcf\_attach\_vb\_pool](#ZH-CN_TOPIC_0000001218750275)把当前组的通道绑定到固定PoolId的VB池中。支持多个组的多个通道绑定到同一个VB池中。
-   当要切换当前组绑定的VB池时，只需再调一次接口[ss\_mpi\_mcf\_attach\_vb\_pool](#ZH-CN_TOPIC_0000001218750275)正确配置需要绑定到的VB池即可。
-   pool必须保证是已创建VB池的有效pool\_id。
-   在调用[ss\_mpi\_mcf\_detach\_vb\_pool](ss_mpi_mcf_detach_vb_pool.md)后，销毁创建的VB之前，需要保证VB没有被MCF后端绑定的模块使用，可以通过sleep或清除后端模块通道缓存的方式先把VB都释放，再销毁缓存VB池。
...
<p id="p2380mcpsimp"><a name="p2380mcpsimp"></a><a name="p2380mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2389mcpsimp"><a name="p2389mcpsimp"></a><a name="p2389mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2414mcpsimp"><a name="p2414mcpsimp"></a><a name="p2414mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2455mcpsimp"><a name="p2455mcpsimp"></a><a name="p2455mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2464mcpsimp"><a name="p2464mcpsimp"></a><a name="p2464mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2497mcpsimp"><a name="p2497mcpsimp"></a><a name="p2497mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_get\_chn\_align](#ss_mpi_mcf_get_chn_align)
...
<p id="p2544mcpsimp"><a name="p2544mcpsimp"></a><a name="p2544mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2553mcpsimp"><a name="p2553mcpsimp"></a><a name="p2553mcpsimp"></a>取值范围[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2585mcpsimp"><a name="p2585mcpsimp"></a><a name="p2585mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_set\_chn\_align](#ss_mpi_mcf_set_chn_align)
...
<p id="p2627mcpsimp"><a name="p2627mcpsimp"></a><a name="p2627mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2636mcpsimp"><a name="p2636mcpsimp"></a><a name="p2636mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2668mcpsimp"><a name="p2668mcpsimp"></a><a name="p2668mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2713mcpsimp"><a name="p2713mcpsimp"></a><a name="p2713mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2722mcpsimp"><a name="p2722mcpsimp"></a><a name="p2722mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2754mcpsimp"><a name="p2754mcpsimp"></a><a name="p2754mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p2793mcpsimp"><a name="p2793mcpsimp"></a><a name="p2793mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p xml:lang="sv-SE" id="p2803mcpsimp"><a name="p2803mcpsimp"></a><a name="p2803mcpsimp"></a><span xml:lang="en-US" id="ph2804mcpsimp"><a name="ph2804mcpsimp"></a><a name="ph2804mcpsimp"></a>取值范围</span>：[<a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2838mcpsimp"><a name="p2838mcpsimp"></a><a name="p2838mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ot\_mcf\_ext\_chn\_attr](#ot_mcf_ext_chn_attr)
-   [ss\_mpi\_mcf\_get\_ext\_chn\_attr](#ss_mpi_mcf_get_ext_chn_attr)
...
<p id="p2892mcpsimp"><a name="p2892mcpsimp"></a><a name="p2892mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2901mcpsimp"><a name="p2901mcpsimp"></a><a name="p2901mcpsimp"></a>取值范围[<a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p2934mcpsimp"><a name="p2934mcpsimp"></a><a name="p2934mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ot\_mcf\_ext\_chn\_attr](#ot_mcf_ext_chn_attr)
-   [ss\_mpi\_mcf\_set\_ext\_chn\_attr](#ss_mpi_mcf_set_ext_chn_attr)
...
<p id="p2980mcpsimp"><a name="p2980mcpsimp"></a><a name="p2980mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p2989mcpsimp"><a name="p2989mcpsimp"></a><a name="p2989mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3022mcpsimp"><a name="p3022mcpsimp"></a><a name="p3022mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_get\_chn\_crop](#ss_mpi_mcf_get_chn_crop)
...
<p id="p3072mcpsimp"><a name="p3072mcpsimp"></a><a name="p3072mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p3081mcpsimp"><a name="p3081mcpsimp"></a><a name="p3081mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3114mcpsimp"><a name="p3114mcpsimp"></a><a name="p3114mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_mcf\_set\_chn\_crop](#ss_mpi_mcf_set_chn_crop)
...
<p id="p3156mcpsimp"><a name="p3156mcpsimp"></a><a name="p3156mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p3165mcpsimp"><a name="p3165mcpsimp"></a><a name="p3165mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_PHYS_CHN_NUM.md">OT_MCF_MAX_PHYS_CHN_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3222mcpsimp"><a name="p3222mcpsimp"></a><a name="p3222mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p3269mcpsimp"><a name="p3269mcpsimp"></a><a name="p3269mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<p id="p3278mcpsimp"><a name="p3278mcpsimp"></a><a name="p3278mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_CHN_NUM.md">OT_MCF_MAX_CHN_NUM</a>)</p>
</td>
...
[ss\_mpi\_mcf\_get\_chn\_fd](#ss_mpi_mcf_get_chn_fd)
...
<p id="p3379mcpsimp"><a name="p3379mcpsimp"></a><a name="p3379mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3426mcpsimp"><a name="p3426mcpsimp"></a><a name="p3426mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p3472mcpsimp"><a name="p3472mcpsimp"></a><a name="p3472mcpsimp"></a>取值范围：[0, <a href="OT_MCF_MAX_GRP_NUM.md">OT_MCF_MAX_GRP_NUM</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3512mcpsimp"><a name="p3512mcpsimp"></a><a name="p3512mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   GROUP必须已创建。
-   此接口需与[ss\_mpi\_mcf\_get\_grp\_frame](ss_mpi_mcf_get_grp_frame.md)配对使用。
...
[ss\_mpi\_mcf\_get\_grp\_frame](#ss_mpi_mcf_get_grp_frame)
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3616mcpsimp"><a name="p3616mcpsimp"></a><a name="p3616mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3722mcpsimp"><a name="p3722mcpsimp"></a><a name="p3722mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   退出VI之前，需要调用此接口[ot\_mcf\_vi\_attr](ot_mcf_vi_attr.md)的enable设置为FALSE，关闭MCF场景下VI相关属性设置。
-   VB属性需要置为OT\_VB\_SUPPLEMENT\_BNR\_MOT\_MASK，具体描述请参见《MPP媒体处理软件V5.0开发参考》“系统控制”章节。
-   在VI送raw数据场景，在VI停止送raw数据之前，需要调用此接口[ot\_mcf\_vi\_attr](ot_mcf_vi_attr.md)的enable设置为FALSE。
-   将[ot\_mcf\_vi\_attr](ot_mcf_vi_attr.md)的enable设置为TRUE之后，表示开启MCF预处理功能，该功能建议默认开启，可以更好的优化低照下彩色图像的效果；开启时不建议调用mono\_pipe通路的获取通道帧接口，会导致通路性能异常。
-   本接口在VPSS在线模式下不可用。
...
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.2 "><p id="p3795mcpsimp"><a name="p3795mcpsimp"></a><a name="p3795mcpsimp"></a>失败，请参见<span xml:lang="fr-FR" id="ph1194611573377"><a name="ph1194611573377"></a><a name="ph1194611573377"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [OT\_MCF\_MAX\_GRP\_NUM](OT_MCF_MAX_GRP_NUM.md)：定义MCF最大GROUP个数。
-   [OT\_MCF\_PIPE\_NUM](OT_MCF_PIPE_NUM.md)：定义MCF PIPE个数。
-   [OT\_MCF\_MAX\_CHN\_NUM](OT_MCF_MAX_CHN_NUM.md)：定义MCF最大通道个数。
-   [OT\_MCF\_MAX\_PHYS\_CHN\_NUM](OT_MCF_MAX_PHYS_CHN_NUM.md):  定义MCF最大物理通道个数。
-   [OT\_MCF\_MAX\_EXT\_CHN\_NUM](OT_MCF_MAX_EXT_CHN_NUM.md):  定义MCF最大扩展通道个数。
-   [OT\_MCF\_MAX\_PIPE\_WIDTH](OT_MCF_MAX_PIPE_WIDTH.md)：定义MCF组的最大宽度。
-   [OT\_MCF\_MAX\_PIPE\_HEIGHT](OT_MCF_MAX_PIPE_HEIGHT.md)：定义MCF组的最大高度。
-   [OT\_MCF\_MIN\_PIPE\_WIDTH](OT_MCF_MIN_PIPE_WIDTH.md)：定义MCF组的最小宽度。
-   [OT\_MCF\_MIN\_PIPE\_HEIGHT](OT_MCF_MIN_PIPE_HEIGHT.md)：定义MCF组的最小高度。
-   [OT\_MCF\_MAX\_CHN\_WIDTH](OT_MCF_MAX_CHN_WIDTH.md)：定义MCF物理通道的最大宽度。
-   [OT\_MCF\_MAX\_CHN\_HEIGHT](OT_MCF_MAX_CHN_HEIGHT.md)：定义MCF物理通道的最大高度。
-   [OT\_MCF\_MIN\_CHN\_WIDTH](OT_MCF_MIN_CHN_WIDTH.md)：定义MCF物理通道的最小宽度。
-   [OT\_MCF\_MIN\_CHN\_HEIGHT](OT_MCF_MIN_CHN_HEIGHT.md)：定义MCF物理通道的最小高度。
-   [OT\_MCF\_MAX\_EXT\_CHN\_WIDTH](OT_MCF_MAX_EXT_CHN_WIDTH.md)：定义MCF扩展通道的最大宽度。
-   [OT\_MCF\_MAX\_EXT\_CHN\_HEIGHT](OT_MCF_MAX_EXT_CHN_HEIGHT.md)：定义MCF扩展通道的最大高度。
-   [OT\_MCF\_MIN\_EXT\_CHN\_WIDTH](OT_MCF_MIN_EXT_CHN_WIDTH.md)：定义MCF扩展物理通道的最小宽度。
-   [OT\_MCF\_MIN\_EXT\_CHN\_HEIGHT](OT_MCF_MIN_EXT_CHN_HEIGHT.md)：定义MCF扩展通道的最小高度。
-   [OT\_MCF\_BIAS\_LUT\_NUM](OT_MCF_BIAS_LUT_NUM.md)：定义MCF  算法参数BIAS lut表长度。
-   [OT\_MCF\_WEIGHT\_LUT\_NUM](OT_MCF_WEIGHT_LUT_NUM.md)：定义MCF  算法参数权重 lut表长度。
-   [OT\_MCF\_CC\_UV\_GAIN\_LUT\_NUM](OT_MCF_CC_UV_GAIN_LUT_NUM.md)：定义MCF  算法参数颜色校正 lut表长度。
-   [OT\_MCF\_COEF\_NUM](OT_MCF_COEF_NUM.md)：定义MCF  标定系数长度。
-   [ot\_mcf\_grp](ot_mcf_grp.md)：定义MCF GROUP类型。
-   [ot\_mcf\_id](ot_mcf_id.md)：定义MCF ID类型。
-   [ot\_mcf\_pipe](ot_mcf_pipe.md)：定义MCF PIPE类型。
-   [ot\_mcf\_chn](ot_mcf_chn.md)：定义MCF通道类型。
-   [ot\_mcf\_crop\_info](ot_mcf_crop_info.md)：定义MCF crop属性。
-   [ot\_mcf\_grp\_attr](ot_mcf_grp_attr.md)：定义MCF GROUP属性。
-   [ot\_mcf\_pipe\_attr](ot_mcf_pipe_attr.md)：定义MCF PIPE属性。
-   [ot\_mcf\_chn\_attr](ot_mcf_chn_attr.md)：定义MCF 通道属性。
-   [ot\_mcf\_feature\_info](ot_mcf_feature_info.md)：定义MCF的标定返回的特征点信息。
-   [ot\_mcf\_ext\_chn\_attr](ot_mcf_ext_chn_attr.md)：定义MCF 扩展通道属性。
-   [ot\_mcf\_calibration\_mode](ot_mcf_calibration_mode.md)：定义MCF标定模式。
-   [ot\_mcf\_calibration](ot_mcf_calibration.md)：定义MCF的标定参数。
-   [ot\_mcf\_hist\_adj\_mode](ot_mcf_hist_adj_mode.md)：定义MCF亮度调整模式。
-   [ot\_mcf\_fusion\_alpha\_mode](ot_mcf_fusion_alpha_mode.md)：定义MCF融合模式。
-   [ot\_mcf\_color\_correct\_cfg](ot_mcf_color_correct_cfg.md)：定义MCF颜色校正参数。
-   [ot\_mcf\_color\_hf\_proc\_cfg](ot_mcf_color_hf_proc_cfg.md)：定义MCF可见光亮度高频处理参数。
-   [ot\_mcf\_hist\_adj\_cfg](ot_mcf_hist_adj_cfg.md)：定义MCF直方图校正参数。
-   [ot\_mcf\_fusion\_global\_alpha\_mode\_cfg](ot_mcf_fusion_global_alpha_mode_cfg.md)：定义MCF全局融合参数。
-   [ot\_mcf\_fusion\_adaptive\_alpha\_mode\_cfg](ot_mcf_fusion_adaptive_alpha_mode_cfg.md)：定义MCF自适应融合参数。
-   [ot\_mcf\_filter\_proc\_cfg](ot_mcf_filter_proc_cfg.md)：定义MCF的滤波处理参数。
-   [ot\_mcf\_detail\_proc\_cfg](ot_mcf_detail_proc_cfg.md)：定义MCF细节处理参数。
-   [ot\_mcf\_base\_proc\_cfg](ot_mcf_base_proc_cfg.md)：定义MCF融合参数。
-   [ot\_mcf\_each\_freq\_proc\_cfg](ot_mcf_each_freq_proc_cfg.md)：定义MCF各频段的处理参数。
-   [ot\_mcf\_alg\_param](ot_mcf_alg_param.md)：MCF 算法参数。
-   [ot\_mcf\_vi\_attr](ot_mcf_vi_attr.md)：定义MCF VI属性。
-   [ot\_mcf\_path](ot_mcf_path.md)：定义MCF输出通路。
...
[ot\_mcf\_calibration](#ot_mcf_calibration)
...
-   SS927V100所有的组通道的输入总面积最大为2688x1520x2，Hi3403V100无此限制。

【相关数据类型及接口】

[ot\_mcf\_pipe\_attr](#ot_mcf_pipe_attr)
...
-   绑定源物理通道必须合法，范围为\[0,  [OT\_MCF\_MAX\_PHYS\_CHN\_NUM](OT_MCF_MAX_PHYS_CHN_NUM.md)\)。
-   宽、高必须满足2对齐。
...
调用mcf标定工具标定，将标定结果的region数据，调用[ss\_mpi\_mcf\_set\_grp\_crop](ss_mpi_mcf_set_grp_crop.md)接口把黑边裁剪掉。
...
正确设置VB属性和调用[ss\_mpi\_mcf\_set\_vi\_attr](ss_mpi_mcf_set_vi_attr.md)接口可以提高降噪效果。具体方法请参考mcf sample 1。
