...
<img src="figures/AWB有效像素颜色空间.png" alt="" title="AWB有效像素颜色空间" />
...
-   [ss\_mpi\_isp\_set\_stats\_cfg](ss_mpi_isp_set_stats_cfg.md)：设置ISP 3A统计信息配置。
-   [ss\_mpi\_isp\_get\_stats\_cfg](ss_mpi_isp_get_stats_cfg.md)：获取ISP 3A统计信息配置。
-   [ss\_mpi\_isp\_get\_ae\_stats](ss_mpi_isp_get_ae_stats.md)：获取AE统计信息。
-   [ss\_mpi\_isp\_get\_ae\_stitch\_stats](ss_mpi_isp_get_ae_stitch_stats.md)：获取拼接模式AE统计信息。
-   [ss\_mpi\_isp\_get\_mg\_stats](ss_mpi_isp_get_mg_stats.md)：获取MG统计信息。
-   [ss\_mpi\_isp\_get\_wb\_stats](ss_mpi_isp_get_wb_stats.md)：获取AWB统计信息。
-   [ss\_mpi\_isp\_get\_wb\_stitch\_stats](ss_mpi_isp_get_wb_stitch_stats.md)：获取拼接模式AWB统计信息。
-   [ss\_mpi\_isp\_get\_focus\_stats](ss_mpi_isp_get_focus_stats.md)：获取AF统计信息。
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36189mcpsimp"><a name="p36189mcpsimp"></a><a name="p36189mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36260mcpsimp"><a name="p36260mcpsimp"></a><a name="p36260mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36331mcpsimp"><a name="p36331mcpsimp"></a><a name="p36331mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36401mcpsimp"><a name="p36401mcpsimp"></a><a name="p36401mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36471mcpsimp"><a name="p36471mcpsimp"></a><a name="p36471mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36541mcpsimp"><a name="p36541mcpsimp"></a><a name="p36541mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36611mcpsimp"><a name="p36611mcpsimp"></a><a name="p36611mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p36680mcpsimp"><a name="p36680mcpsimp"></a><a name="p36680mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ot\_isp\_stats\_cfg](ot_isp_stats_cfg.md)：定义ISP 3A统计信息配置。
-   [ot\_isp\_stats\_ctrl](ot_isp_stats_ctrl.md)：定义ISP 3A统计信息使能。
-   [ot\_isp\_ae\_stats\_cfg](ot_isp_ae_stats_cfg.md)：定义AE统计信息配置。
-   [ot\_isp\_ae\_switch](ot_isp_ae_switch.md)：定义AE统计模块在ISP pipeline的位置。
-   [ot\_isp\_ae\_four\_plane\_mode](ot_isp_ae_four_plane_mode.md)：FourPlaneMode使能。
-   [ot\_isp\_ae\_hist\_skip](ot_isp_ae_hist_skip.md): 直方图统计时采样点设置。
-   [ot\_isp\_ae\_hist\_offset\_x](ot_isp_ae_hist_offset_x.md)：直方图统计时水平方向起始点设置。
-   [ot\_isp\_ae\_hist\_offset\_y](ot_isp_ae_hist_offset_y.md)：直方图统计时垂直方向起始点设置。
-   [ot\_isp\_ae\_hist\_config](ot_isp_ae_hist_config.md)：定义全局直方图统计时的采样点方式。
-   [ot\_isp\_ae\_stat\_mode](ot_isp_ae_stat_mode.md)：定义统计模块的开方模式。
-   [ot\_isp\_ae\_crop](ot_isp_ae_crop.md)：对AE模块输入图像进行裁剪。
-   [ot\_isp\_awb\_switch](ot_isp_awb_switch.md)：定义ISP  WB统计模块在ISP pipeline的位置。
-   [ot\_isp\_awb\_gain\_switch](ot_isp_awb_gain_switch.md)：定义AWB增益的位置。
-   [ot\_isp\_awb\_crop](ot_isp_awb_crop.md)：对AWB模块输入图像进行裁剪。
-   [ot\_isp\_wb\_stats\_cfg](ot_isp_wb_stats_cfg.md)：定义AWB统计信息配置。
-   [ot\_isp\_ae\_grid\_info](ot_isp_ae_grid_info.md)：定义AE分区间统计信息的坐标信息。
-   [ot\_isp\_ae\_stats](ot_isp_ae_stats.md)：定义AE统计信息。
-   [ot\_isp\_ae\_stitch\_stats](ot_isp_ae_stitch_stats.md)：定义拼接模式AE统计信息。
-   [ot\_isp\_mg\_grid\_info](ot_isp_mg_grid_info.md)：定义MG分区间统计信息的坐标信息。
-   [ot\_isp\_mg\_stats](ot_isp_mg_stats.md)：定义MG统计信息。
-   [ot\_isp\_awb\_grid\_info](ot_isp_awb_grid_info.md)：定义AWB分区间统计信息的坐标信息。
-   [ot\_isp\_wb\_stats](ot_isp_wb_stats.md)：定义AWB统计信息。
-   [ot\_isp\_wb\_stitch\_stats](ot_isp_wb_stitch_stats.md)：定义拼接模式AWB统计信息。
-   [OT\_ISP\_IIR\_EN\_NUM](OT_ISP_IIR_EN_NUM.md)：定义AF IIR使能的个数。
-   [OT\_ISP\_IIR\_GAIN\_NUM](OT_ISP_IIR_GAIN_NUM.md)：定义AF IIR gain的个数。
-   [OT\_ISP\_IIR\_SHIFT\_NUM](OT_ISP_IIR_SHIFT_NUM.md)：定义AF IIR shift的个数。
-   [OT\_ISP\_ACC\_SHIFT\_H\_NUM](OT_ISP_ACC_SHIFT_H_NUM.md)：定义AF IIR累加统计shift的个数。
-   [OT\_ISP\_ACC\_SHIFT\_V\_NUM](OT_ISP_ACC_SHIFT_V_NUM.md)：定义AF FIR累加统计shift的个数。
-   [OT\_ISP\_AF\_ZONE\_ROW](OT_ISP_AF_ZONE_ROW.md)：定义AF水平方向的分块个数。
-   [OT\_ISP\_AF\_ZONE\_COLUMN](OT_ISP_AF_ZONE_COLUMN.md)：定义AF垂直方向的分块个数。
-   [ot\_isp\_focus\_stats\_cfg](ot_isp_focus_stats_cfg.md)：定义AF统计信息配置。
-   [ot\_isp\_af\_cfg](ot_isp_af_cfg.md)：定义AF统计信息配置参数。
-   [ot\_isp\_af\_peak\_mode](ot_isp_af_peak_mode.md)：统计模式。
-   [ot\_isp\_af\_square\_mode](ot_isp_af_square_mode.md)：平方模式。
-   [ot\_isp\_af\_crop](ot_isp_af_crop.md)：AF输入图像的裁剪。
-   [ot\_isp\_af\_stats\_pos](ot_isp_af_stats_pos.md)：AF统计位置。
-   [ot\_isp\_af\_raw\_cfg](ot_isp_af_raw_cfg.md)：AF RAW域统计配置。
-   [ot\_isp\_af\_pre\_filter\_cfg](ot_isp_af_pre_filter_cfg.md)：AF预滤波器配置。
-   [ot\_isp\_af\_level\_depend](ot_isp_af_level_depend.md)：AF Level Depend Gain配置。
-   [ot\_isp\_af\_coring](ot_isp_af_coring.md)：AF Coring 配置。
-   [ot\_isp\_af\_h\_param](ot_isp_af_h_param.md)：AF统计水平滤波器IIR参数设置。
-   [ot\_isp\_af\_v\_param](ot_isp_af_v_param.md)：AF统计水平滤波器IIR参数设置。
-   [ot\_isp\_af\_fv\_param](ot_isp_af_fv_param.md)：AF统计结果输出格式参数。
-   [ot\_isp\_focus\_zone](ot_isp_focus_zone.md)：定义AF统计信息参数。
-   [ot\_isp\_fe\_focus\_stats](ot_isp_fe_focus_stats.md)：定义FE AF统计信息。
-   [ot\_isp\_be\_focus\_stats](ot_isp_be_focus_stats.md)：定义BE AF统计信息。
-   [ot\_isp\_focus\_grid\_info](ot_isp_focus_grid_info.md)：定义AF分区间统计信息的坐标信息。
-   [ot\_isp\_af\_stats](ot_isp_af_stats.md)：定义FE和BE的AF统计信息。
...
Hi3403V100不支持配置AWB统计模块位置在Expander后。
...
-   AWB统计信息的排列顺序请参考[表1](ot_isp_wb_stats.md#_Ref522957266)。
...
<img src="figures/Square模式.png" alt="" title="Square模式" />
...
<tr id="row39068mcpsimp"><td class="cellrowborder" valign="top" width="38%" headers="mcps1.1.3.1.1 "><p id="p39070mcpsimp"><a name="p39070mcpsimp"></a><a name="p39070mcpsimp"></a>iir_en[<a href="OT_ISP_IIR_EN_NUM.md">OT_ISP_IIR_EN_NUM</a>]</p>
</td>
...
<tr id="row39079mcpsimp"><td class="cellrowborder" valign="top" width="38%" headers="mcps1.1.3.1.1 "><p xml:lang="fr-FR" id="p39081mcpsimp"><a name="p39081mcpsimp"></a><a name="p39081mcpsimp"></a><span xml:lang="en-US" id="ph39082mcpsimp"><a name="ph39082mcpsimp"></a><a name="ph39082mcpsimp"></a>iir_gain[</span><a href="OT_ISP_IIR_GAIN_NUM.md">OT_ISP_IIR_GAIN_NUM</a><span xml:lang="en-US" id="ph39084mcpsimp"><a name="ph39084mcpsimp"></a><a name="ph39084mcpsimp"></a>]</span></p>
</td>
...
-   WDR模式下推荐使用BE DRC后的统计信息\(参考[ot\_isp\_af\_stats\_pos](ot_isp_af_stats_pos.md)\)。
-   Hi3403V100中AF支持从FE0获取统计信息，不支持从其他FE通道获取统计信息。请参考《ISP 图像调优指南》第2章关于ISP FE的说明。
-   YUV模式不支持获取统计信息pts。
-   pts每帧都会覆盖更新，若需要获取到每一帧raw对应的统计信息pts，则需要以帧间隔调用此接口；否则，统计信息pts与raw pts可能不是一一对应的。
...
-   [ss\_mpi\_isp\_set\_debug](ss_mpi_isp_set_debug.md)：设置ISP调试接口。
-   [ss\_mpi\_isp\_get\_debug](ss_mpi_isp_get_debug.md)：获取ISP调试接口。
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p39510mcpsimp"><a name="p39510mcpsimp"></a><a name="p39510mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="73%" headers="mcps1.1.3.1.2 "><p id="p39600mcpsimp"><a name="p39600mcpsimp"></a><a name="p39600mcpsimp"></a>失败，其值为<span xml:lang="sv-SE" id="ph82171364716"><a name="ph82171364716"></a><a name="ph82171364716"></a><a href="错误码.md">错误码</a></span>。</p>
</td>
</tr>
</tbody>
</table>
...
[ot\_isp\_debug\_info](ot_isp_debug_info.md)：定义ISP调试信息属性。
...
[AE] Version: [Hi3403V100V1.0.0.0 B010 Release], Build Time[Feb 21 2022, 19:04:13]
-----ae info-------------------------------------------------------------------
...
[AWB] Version: [Hi3403V100V1.0.0.0 B010 Release], Build Time[Feb 21 2022, 19:04:17]
-----awb info------------------------------------------------------------------
...
<img src="figures/Sensor适配示意图.png" alt="" title="Sensor适配示意图" />
...
<img src="figures/AE算法向ISP库注册的回调函数.png" alt="" title="AE算法向ISP库注册的回调函数" />
...
<img src="figures/AWB算法向ISP库注册的回调函数.png" alt="" title="AWB算法向ISP库注册的回调函数" />
...
> **说明：** 
>ss\_mpi\_isp\_get\_vd\_time\_out和[ss\_mpi\_isp\_get\_focus\_stats](ss_mpi_isp_get_focus_stats.md)请参考前面章节。

用户开发的AF算法可以参考[图1](#fig36322052192211)所示的结构，AF算法在一个thread内运行，使用ss\_mpi\_isp\_get\_vd\_time\_out接口将算法同步在VD下运行。通过调用[ss\_mpi\_isp\_get\_focus\_stats](ss_mpi_isp_get_focus_stats.md)来获取AF相关的统计信息，相关算法参考统计信息完成目标zoom和focus位置的计算，AF算法输出result，包括lens的位置信息和速度。调用Lens Driver将镜头镜片驱动到设定的位置即完成当前帧的操作。AF Alg向上提供控制接口和查询接口，方便用户完成一键聚焦，变焦，手动聚焦，查询算法状态等操作。

**图 1**  AF算法结构图<a name="fig36322052192211"></a>  
<img src="figures/AF算法结构图.png" alt="" title="AF算法结构图" />

【举例】

如果用户使用的是Linux系统，推荐将算法放在user space完成，lens driver放在kernel space，ISP驱动提供同步回调功能，参考“[AF同步回调](AF同步回调.md)”章节。
...
被动式自动对焦一般是通过分析图像特征得出图像清晰度值FV\(Focus Value\), 通过驱动对焦马达调节焦点到最佳位置，如[图1](#fig4442256191114)所示，图像越清晰FV值越大，Peak点对应聚焦清晰点。获取图像清晰度算法有多种，如灰度梯度法，高频分量法等，Hi3403V100采用高频分量法来计算FV，即图像越清晰的时候高频部分幅值越大，将图像通过高通滤波器便可以得到高频分量，Hi3403V100一共提供四个滤波器和亮度信息，分别为水平方向滤波H1，H2，垂直方向滤波V1，V2，以及Y和高亮计数器HlCnt。Hi3403V100提供FE（Front End）及BE（Back End）两个独立的AF统计信息获取模块。AF模块支持的最小分辨率为256\*120，低于该分辨率AF逻辑功能无法支持。

**图 1**  FV曲线<a name="fig4442256191114"></a>  
<img src="figures/FV曲线.png" alt="" title="FV曲线" />

Hi3403V100提供Bayer域或者YUV域进行统计，配置MPI中的stats\_pos字段即可以进行统计位置的调整。WDR模式下，非宽动态场景的Bayer域（即RAW域）统计信息无明显变化趋势，推荐使用YUV域统计信息。首先对图像进行预处理滤波，去除椒盐噪声对统计值的干扰，用户可以设置pre\_flt\_cfg.en来使能PreFilter。配置pre\_flt\_cfg.strength来控制[图3](#fig1479092219285)滤波强度。在经过水平垂直四组滤波器后会对输出做Level Depend Gain和Coring，关于这两个模块将在后面的章节详述。模块框[图2](#fig1275851542715)所示。

**图 2**  AF统计模块框图<a name="fig1275851542715"></a>  
<img src="figures/AF统计模块框图.png" alt="" title="AF统计模块框图" />

水平垂直滤波器分别采用IIR和FIR实现如[图3](#fig1479092219285)所示。

**图 3**  AF 4组滤波器<a name="fig1479092219285"></a>  
<img src="figures/AF-4组滤波器.png" alt="" title="AF-4组滤波器" />
...
<img src="figures/AF-输入图像裁剪.png" alt="" title="AF-输入图像裁剪" />
...
<img src="figures/Bayer域统计预处理.png" alt="" title="Bayer域统计预处理" />

**图 2**  关于Gamma配置的说明<a name="fig41650mcpsimp"></a>  
<img src="figures/关于Gamma配置的说明.png" alt="" title="关于Gamma配置的说明" />

> **须知：** 
>图中的GAMMA\_EN与[ot\_isp\_af\_raw\_cfg](ot_isp_af_raw_cfg.md)中的gamma\_value等效，GAIN\_LMT与[ot\_isp\_af\_raw\_cfg](ot_isp_af_raw_cfg.md)中的gamma\_gain\_limit等效。
...
-   高亮计数器
    ...
    **图 1**  高亮统计值<a name="_Ref450034695"></a>  
    <img src="figures/高亮统计值.png" alt="" title="高亮统计值" />
...
-   Level Depend Gain
    ...
    **图 2**  Level Depend Gain 曲线<a name="_Ref450034722"></a>  
    <img src="figures/Level-Depend-Gain-曲线.png" alt="" title="Level-Depend-Gain-曲线" />
...
<img src="figures/Coring-曲线.png" alt="" title="Coring-曲线" />
...
<img src="figures/平方配置模式映射曲线图.png" alt="" title="平方配置模式映射曲线图" />
...
<img src="figures/滤波器后的图像.png" alt="" title="滤波器后的图像" />
...
<td class="cellrowborder" valign="top" width="55.00000000000001%" headers="mcps1.2.3.1.2 "><p id="p41750mcpsimp"><a name="p41750mcpsimp"></a><a name="p41750mcpsimp"></a>YUV输入时gamma_value（参考 <a href="ot_isp_af_raw_cfg.md">ot_isp_af_raw_cfg</a>）设置为0。</p>
...
一般的推荐最终生成如[图1](概述-8.md#fig4442256191114)所示的两条曲线，我们将low BandPass filter生成的FV命名为FV1，High BandPass filter生成的命名为FV2，“[FV计算参考代码](FV计算参考代码.md)”中变量stFocusCfg的值为默认推荐使用的AF滤波器参数，FV1使用在低照度场合，FV2使用在正常照度场合。对于每一个block，FV1，FV2的计算方式为：

<img src="figures/zh-cn_formulaimage_0000002504085159.png" alt="" />

H1，H2，V1，V2分别为水平垂直四组滤波器的统计值，可设置适当的权重对水平和垂直方向的滤波器输出统计值进行混合。

最终的FV值还需要对每个block进行加权，即FV1，FV2采用如下公式计算。

<img src="figures/zh-cn_formulaimage_0000002503965251.png" alt="" />
...
<img src="figures/自动对焦参数仿真工具.png" alt="" title="自动对焦参数仿真工具" />
...
<img src="figures/通过截止频率获取滤波系数（窄带）.png" alt="" title="通过截止频率获取滤波系数（窄带）" />

**图 2**  通过截止频率获取滤波系数（宽带）<a name="_Ref480961583"></a>  
<img src="figures/通过截止频率获取滤波系数（宽带）.png" alt="" title="通过截止频率获取滤波系数（宽带）" />
...
<img src="figures/AF同步回调.png" alt="" title="AF同步回调" />



#### API参考<a name="ZH-CN_TOPIC_0000002470924942"></a>

-   [ot\_isp\_sync\_task\_register](ot_isp_sync_task_register.md)：向ISP注册同步回调接口。
-   [ot\_isp\_sync\_task\_unregister](ot_isp_sync_task_unregister.md)：向ISP反注册同步回调接口。
...
-   使用前需要确保ISP驱动已加载。
-   因为ISP同步回调内部实现不保存用户传入的new\_node指向的实体，所以要求使用[ot\_isp\_sync\_task\_node](ot_isp_sync_task_node.md)定义实体时不能为局部变量。
...
-   [ot\_isp\_sync\_tsk\_method](ot_isp_sync_tsk_method.md)：定义同步回调方法，决定实时性。
-   [ot\_isp\_drv\_focus\_zone](ot_isp_drv_focus_zone.md)：AF分区间统计信息。
-   [ot\_isp\_drv\_fe\_focus\_statistics](ot_isp_drv_fe_focus_statistics.md)：AF FE统计信息
-   [ot\_isp\_drv\_be\_focus\_statistics](ot_isp_drv_be_focus_statistics.md)：AF BE统计信息
-   [ot\_isp\_drv\_af\_statistics](ot_isp_drv_af_statistics.md)：AF模块统计信息。
-   [ot\_isp\_sync\_task\_node](ot_isp_sync_task_node.md)：定义同步回调节点信息。
...
-   在13.6.2小节的[2](适配不带光敏AE快速收敛模式（无光敏快启）.md#li102621649184615)中，将Sensor 配置为用I2C接口直接写Sensor寄存器的方式设定曝光量。在无光敏快启收敛完成后，需要进行相应的配置将Sensor的配置方式设定回普通方式。
...
<img src="figures/13-6-4.png" alt="" />
...
<img src="figures/工频闪类型自适应Sample用例处理流程.png" alt="" title="工频闪类型自适应Sample用例处理流程" />
