...
>本文未有特殊说明，Hi3403V100与SS927内容完全一致。
...
<tbody><tr id="row1372280416410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p3734547016410"><a name="p3734547016410"></a><a name="p3734547016410"></a><a name="image2670064316410"></a><a name="image2670064316410"></a><span><img src="figures/zh-cn_image_0000002408581998.png" alt="" /></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p1757432116410"><a name="p1757432116410"></a><a name="p1757432116410"></a>表示如不避免则将会导致死亡或严重伤害的具有高等级风险的危害。</p>
</td>
</tr>
<tr id="row466863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1432579516410"><a name="p1432579516410"></a><a name="p1432579516410"></a><a name="image4895582316410"></a><a name="image4895582316410"></a><span><img src="figures/zh-cn_image_0000002441981441.png" alt="" /></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p959197916410"><a name="p959197916410"></a><a name="p959197916410"></a>表示如不避免则可能导致死亡或严重伤害的具有中等级风险的危害。</p>
</td>
</tr>
<tr id="row123863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1232579516410"><a name="p1232579516410"></a><a name="p1232579516410"></a><a name="image1235582316410"></a><a name="image1235582316410"></a><span><img src="figures/zh-cn_image_0000002442021309.png" alt="" /></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p123197916410"><a name="p123197916410"></a><a name="p123197916410"></a>表示如不避免则可能导致轻微或中度伤害的具有低等级风险的危害。</p>
</td>
</tr>
<tr id="row5786682116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p2204984716410"><a name="p2204984716410"></a><a name="p2204984716410"></a><a name="image4504446716410"></a><a name="image4504446716410"></a><span><img src="figures/zh-cn_image_0000002408422122.png" alt="" /></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p4388861916410"><a name="p4388861916410"></a><a name="p4388861916410"></a>用于传递设备或环境安全警示信息。如不避免则可能会导致设备损坏、数据丢失、设备性能降低或其它不可预知的结果。</p>
<p id="p1238861916410"><a name="p1238861916410"></a><a name="p1238861916410"></a>“须知”不涉及人身伤害。</p>
</td>
</tr>
<tr id="row2856923116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p5555360116410"><a name="p5555360116410"></a><a name="p5555360116410"></a><a name="image799324016410"></a><a name="image799324016410"></a><span><img src="figures/zh-cn_image_0000002442021221.png" alt="" /></span></p>
</td>
...
<img src="figures/MindCmd功能框架.png" alt="" />
...
-   模型压缩：提供模型压缩功能，对模型的权重（weight）和数据（activation）进行低比特处理，让最终生成的网络模型更加轻量化，从而达到节省网络模型存储空间、降低传输时延、提高计算效率，达到性能提升与优化的目标，参见[模型压缩](ToolPlatform工具平台使用指南.md)。
-   模型转换：提供模型转换功能，将训练好的模型转换为离线模型，参见[模型转换](ToolPlatform工具平台使用指南.md)。
-   功能仿真：提供功能仿真推理功能，参见应用工程。
-   指令仿真：提供指令仿真推理功能，参见应用工程。
-   上板推理：提供上板推理功能，参见应用工程。
-   精度比对：提供精度比对功能，可以用来比对模型转换后SoC支持的算子运行结果与标准算子的运行结果，以便用来确认运算误差发生的原因，参见[精度比对](../modules/ai/精度比对工具使用指南.md)。
...
<td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.2.4.1.3 "><p id="p82501251144018"><a name="p82501251144018"></a><a name="p82501251144018"></a>MindCmd工具主要用于端到端一键执行数据预处理、模型量化、模型转换、仿真推理、模型推理、精度比对和性能分析。各子模块支持单独调用，参见MindCmd子命令。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.62%" headers="mcps1.2.4.1.3 "><a name="ul10992135553719"></a><a name="ul10992135553719"></a><ul id="ul10992135553719"><li>请参见安装Python3.7.5（Ubuntu）。</li></ul>
</td>
</tr>
...
支持在Docker中使用MindCmd，解决方案提供了Dockerfile文件，构建镜像请参考[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)“容器镜像构建”章节，启动容器请参考Docker容器中使用MindCmd。
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p44741134135216"><a name="p44741134135216"></a><a name="p44741134135216"></a>Caffe模型压缩参见[《AMCT使用指南(Caffe)》](../modules/ai/AMCT使用指南（Caffe）.md)"安装AMCT"。（可选）</p>
<p id="p1329717253422"><a name="p1329717253422"></a><a name="p1329717253422"></a>Pytorch模型压缩参见[《AMCT使用指南(PyTorch)》](../modules/ai/AMCT使用指南（PyTorch）.md)"工具安装"。（可选）</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p12474143415525"><a name="p12474143415525"></a><a name="p12474143415525"></a>请参见[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)"命令行方式开发环境安装"，完成依赖环境、工具链、CANN包安装。</p>
</td>
</tr>
...
<p id="p14744342526"><a name="p14744342526"></a><a name="p14744342526"></a>Caffe模型推理需参见[《AMCT使用指南(Caffe)》](../modules/ai/AMCT使用指南（Caffe）.md)"安装AMCT"。</p>
<p id="p1228318418311"><a name="p1228318418311"></a><a name="p1228318418311"></a>Pytorch模型推理参见[《AMCT使用指南(PyTorch)》](../modules/ai/AMCT使用指南（PyTorch）.md)"工具安装"。</p>
<p id="p3983143274811"><a name="p3983143274811"></a><a name="p3983143274811"></a>Onnx模型推理参见[《AMCT使用指南(PyTorch)》](../modules/ai/AMCT使用指南（PyTorch）.md)"工具安装"。</p>
</td>
</tr>
...
<p id="p1190463535319"><a name="p1190463535319"></a><a name="p1190463535319"></a>请参见[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)"板端环境安装" 和 "OpenSSH服务搭建"。</p>
<p id="p10124142620433"><a name="p10124142620433"></a><a name="p10124142620433"></a>请参见[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)"命令行方式开发环境安装"，完成依赖环境、工具链、CANN包安装。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p1030082919245"><a name="p1030082919245"></a><a name="p1030082919245"></a>请参见[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)"命令行方式开发环境安装"，完成依赖环境、工具链、CANN包安装。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p26602308245"><a name="p26602308245"></a><a name="p26602308245"></a>请参见[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)"命令行方式开发环境安装"，完成依赖环境、工具链、CANN包安装。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p680217184248"><a name="p680217184248"></a><a name="p680217184248"></a>请参见[《精度比对工具使用指南》](../modules/ai/精度比对工具使用指南.md)"安装依赖"，完成依赖环境安装。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="82.6%" headers="mcps1.2.3.1.2 "><p id="p19508928131013"><a name="p19508928131013"></a><a name="p19508928131013"></a>请参见[《Profiling工具使用指南》](../modules/ai/Profiling工具使用指南.md)"环境准备"，完成性能分析环境搭建。</p>
</td>
</tr>
</tbody>
</table>
...
<img src="figures/zh-cn_image_0000002442021525.png" alt="" />
...
<img src="figures/查看某一个配置项的值.png" alt="" />
...
<img src="figures/修改某一个配置项的值.png" alt="" />
...
<img src="figures/zh-cn_image_0000002408582282.png" alt="" />
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p5873642117"><a name="p5873642117"></a><a name="p5873642117"></a>上板推理默认配置文件，<strong id="b149681840175215"><a name="b149681840175215"></a><a name="b149681840175215"></a>若需要执行上板推理，则需要配置此参数</strong>。详细配置项参考ssh.cfg文件配置。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.81%" headers="mcps1.2.6.1.5 "><p id="p22900358310"><a name="p22900358310"></a><a name="p22900358310"></a>运行前先删除工作路径下一键推理的历史输出目录，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p1386954453611"><a name="p1386954453611"></a><a name="p1386954453611"></a>模型压缩开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p1172114233610"><a name="p1172114233610"></a><a name="p1172114233610"></a>开源框架推理开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p181443912363"><a name="p181443912363"></a><a name="p181443912363"></a>上板推理开关，默认值为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p11882716319"><a name="p11882716319"></a><a name="p11882716319"></a>功能仿真运行开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p9656152804018"><a name="p9656152804018"></a><a name="p9656152804018"></a>指令仿真运行开关，默认值为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p171943517400"><a name="p171943517400"></a><a name="p171943517400"></a>Dump数据精度比对开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.81%" headers="mcps1.2.6.1.5 "><p id="p12971625123311"><a name="p12971625123311"></a><a name="p12971625123311"></a>在一键推理流程执行到ATC组件时，追加ATC支持的命令参数，每个命令按行隔开，具体命令参见[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)。需要满足key=value格式，工具会转换为--key=value。例如配置：log_level=0</p>
...
工具内置一个PyTorch 模型pooling算子快速上手的用例，位于\{MINDCMD\_INSTALL\_PATH\}/testcase。请参考安装MindCmd完成安装，再参考全局配置完成MindCmd工具配置。
...
<img src="figures/Caffe模型一键推理流程图.png" alt="" />
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p782618230342"><a name="p782618230342"></a><a name="p782618230342"></a>指定数据预处理配置文件，参见数据预处理配置文件样例。</p>
<p id="p11826423153417"><a name="p11826423153417"></a><a name="p11826423153417"></a>数据预处理完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)--insert_op_conf 章节。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p333193015284"><a name="p333193015284"></a><a name="p333193015284"></a>指定AMCT的简易量化配置文件(*.cfg)或量化配置文件(*.json)。配置方式请参考[《AMCT使用指南（Caffe）》](../modules/ai/AMCT使用指南（Caffe）.md)。</p>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i1696934423315"><a name="i1696934423315"></a><a name="i1696934423315"></a>NNN</em>_RUN=1），则工作目录不能超出ssh.cfg文件配置小节中“HOST_MOUNT_PATH”配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p164818234554"><a name="p164818234554"></a><a name="p164818234554"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考NFS环境搭建。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考ssh.cfg文件配置。</p>
</td>
</tr>
...
-   模型和数据准备。
    ...
    > **说明：** 
    >-   推理数据的shape应该与模型所需输入数据的shape相同，如：模型resnet50的shape为（3，224，224），图片的shape也应为（3，224，224）。否则需要自定义数据预处理方式，通过--aapp参数指定数据预处理配置文件样例，数据预处理完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)“--insert\_op\_conf ”章节。
...
<img src="figures/PyTorch模型一键推理流程图.png" alt="" />
...
<td class="cellrowborder" valign="top" width="73.34%" headers="mcps1.2.4.1.3 "><p id="p14600165303319"><a name="p14600165303319"></a><a name="p14600165303319"></a>指定数据预处理配置文件，参考数据预处理配置文件样例。</p>
<p id="p26002053163311"><a name="p26002053163311"></a><a name="p26002053163311"></a>数据预处理完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)“--insert_op_conf ”章节。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.34%" headers="mcps1.2.4.1.3 "><p id="p1431102315238"><a name="p1431102315238"></a><a name="p1431102315238"></a>指定AMCT的简易量化配置文件(*.yml，*.yaml)或量化配置文件(*.json)。配置方式请参考[《AMCT使用指南（PyTorch）》](../modules/ai/AMCT使用指南（PyTorch）.md)“静态图简易量化配置功能说明”章节。</p>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i1042152314349"><a name="i1042152314349"></a><a name="i1042152314349"></a>NNN</em>_RUN=1），则工作目录不能超出ssh.cfg文件配置小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.34%" headers="mcps1.2.4.1.3 "><p id="p188991542163611"><a name="p188991542163611"></a><a name="p188991542163611"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考NFS环境搭建。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考ssh.cfg文件配置。</p>
</td>
</tr>
...
<img src="figures/量化后模型一键推理流程图.png" alt="" />
...
<img src="figures/硬件感知一键推理流程图.png" alt="" />
...
<img src="figures/ONNX模型一键推理流程图.png" alt="" />
...
<td class="cellrowborder" valign="top" width="69.41000000000001%" headers="mcps1.2.4.1.3 "><p id="p845812137486"><a name="p845812137486"></a><a name="p845812137486"></a>指定数据预处理配置文件，参考数据预处理配置文件样例。</p>
<p id="p7458313164818"><a name="p7458313164818"></a><a name="p7458313164818"></a>数据预处理完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)“--insert_op_conf ”章节。</p>
</td>
</tr>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i142475143517"><a name="i142475143517"></a><a name="i142475143517"></a>NNN</em>_RUN=1），则工作目录不能超出ssh.cfg文件配置小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="69.41000000000001%" headers="mcps1.2.4.1.3 "><p id="p1228816422313"><a name="p1228816422313"></a><a name="p1228816422313"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考NFS环境搭建。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考ssh.cfg文件配置。</p>
</td>
</tr>
...
<img src="figures/Deployed一键推理流程图.png" alt="" />
...
<td class="cellrowborder" valign="top" width="66.59%" headers="mcps1.2.4.1.3 "><p id="p359mcpsimp"><a name="p359mcpsimp"></a><a name="p359mcpsimp"></a>指定自定义aapp配置文件路径，aapp完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)“--insert_op_conf ”章节。当-i/--image_list传入图片列表路径，并且没有指定aapp配置文件时，则使用默认aapp配置：</p>
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p19932153420519"><a name="p19932153420519"></a><a name="p19932153420519"></a>指定AMCT的简易量化配置文件(*.cfg)或量化配置文件(*.json)。配置方式请参考[《AMCT使用指南（Caffe）》](../modules/ai/AMCT使用指南（Caffe）.md)。</p>
<div class="note" id="note19474237102"><a name="note19474237102"></a><a name="note19474237102"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p9947152313109"><a name="p9947152313109"></a><a name="p9947152313109"></a>通过--quant_config可以先对模型进行调试，符合预期后将量化的deployed模型使用Caffe模型一键推理部署。</p>
...
-   执行结果
    ...
    **表 1**  Caffe模型压缩结果文件描述
    ...
    <td class="cellrowborder" valign="top" width="65.71000000000001%" headers="mcps1.2.3.1.2 "><p id="p11597538102618"><a name="p11597538102618"></a><a name="p11597538102618"></a>记录量化因子的文件（不带BN融合），请参考[《AMCT使用指南（Caffe）》](../modules/ai/AMCT使用指南（Caffe）.md)“量化因子记录文件说明”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="65.71000000000001%" headers="mcps1.2.3.1.2 "><p id="p644103602615"><a name="p644103602615"></a><a name="p644103602615"></a>记录量化因子的文件（带BN融合），请参考[《AMCT使用指南（Caffe）》](../modules/ai/AMCT使用指南（Caffe）.md)“量化因子记录文件说明”。</p>
    </td>
    </tr>
...
<td class="cellrowborder" valign="top" width="74.25%" headers="mcps1.2.4.1.3 "><p id="p1431102315238"><a name="p1431102315238"></a><a name="p1431102315238"></a>指定AMCT的简易量化配置文件(*.yml, *.yaml)或量化配置文件(*.json)。配置方式请参考[《AMCT使用指南（PyTorch）》](../modules/ai/AMCT使用指南（PyTorch）.md)“静态图简易量化配置功能说明”章节。</p>
<div class="note" id="note19474237102"><a name="note19474237102"></a><a name="note19474237102"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p9947152313109"><a name="p9947152313109"></a><a name="p9947152313109"></a>通过--quant_config可以先对模型进行调试，符合预期后将量化的deployed模型使用oneclick部署。</p>
...
<p id="p1177912427559"><a name="p1177912427559"></a><a name="p1177912427559"></a>请参见[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)"参数说明"。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.13000000000001%" headers="mcps1.2.4.1.3 "><p id="p430mcpsimp"><a name="p430mcpsimp"></a><a name="p430mcpsimp"></a>配置ATC命令行参数，与-c/--cfg互斥。请参见[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)"参数说明"。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.39999999999999%" headers="mcps1.2.4.1.3 "><p id="p735mcpsimp"><a name="p735mcpsimp"></a><a name="p735mcpsimp"></a>指定工作路径，否则使用<a href="全局配置.md#table73353166121">表1</a>中配置的默认工作路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p173092417238"><a name="p173092417238"></a><a name="p173092417238"></a>指定工作路径，否则使用<a href="全局配置.md#table73353166121">表1</a>中配置的默认工作路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p589394112315"><a name="p589394112315"></a><a name="p589394112315"></a>指定工作路径，否则使用<a href="全局配置.md#table73353166121">表1</a>中配置的默认工作路径。<strong id="b188931541112314"><a name="b188931541112314"></a><a name="b188931541112314"></a>上板推理要求工作路径必须在HOST_MOUNT_PATH下</strong>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p7220172683711"><a name="p7220172683711"></a><a name="p7220172683711"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考NFS环境搭建。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考ssh.cfg文件配置。</p>
</td>
</tr>
...
-   配置默认工作路径（可选）
    ...
    使用全局配置文件\[base\_config\] section 下配置的默认工作路径，或通过命令行参数-k/--work\_dir指定工作路径。
...
-   准备ssh.cfg文件，参考ssh.cfg文件配置
    ...
    ssh.cfg文件配置优先级如下：-s/--ssh\_config参数配置 \> mindcmd.ini中的全局配置（SSH\_CFG\_PATH）。
...
-   执行结果
    ...
    文件内容如[图1](#fig2094417371163)所示数据，参数说明请参考[《精度比对工具使用指南》](../modules/ai/精度比对工具使用指南.md)。

    控制台会展示精度比对简易的执行结果，如[图2](#fig20745123117434)。

    **图 1**  精度比对执行结果<a name="fig2094417371163"></a>  
    <img src="figures/精度比对执行结果.png" alt="" />

    **图 2**  精度比对执行结果展示<a name="fig20745123117434"></a>  
    <img src="figures/精度比对执行结果展示.png" alt="" />
...
-   collect操作自动采集性能原始数据，并解析。
    ...
    **表 3**  性能数据采集命令行参数说明
    ...
    <td class="cellrowborder" valign="top" width="67.49000000000001%" headers="mcps1.2.4.1.3 "><p id="p8060118"><a name="p8060118"></a><a name="p8060118"></a>ssh配置文件的路径，具体配置内容见ssh.cfg文件配置。</p>
    </td>
    </tr>
...
-   执行性能分析展示
    ...
    2.  执行结果
        ...
        性能分析结果展示在控制台上，如[图1](#fig1793811366253)，具体结果可参考[《Profiling工具使用指南》](../modules/ai/Profiling工具使用指南.md)“展示Profiling数据”章节。

        **图 1**  性能分析展示图<a name="fig1793811366253"></a>  
        <img src="figures/性能分析展示图.png" alt="" />
...
> **说明：** 
>$\{SHARE\_DIR\}表示NFS共享路径，其与工作路径、挂载路径、数据卷路径的关联关系详见关于工作路径、挂载路径、数据卷路径和NFS共享路径。
...
ssh.cfg配置文件路径可写入MindCmd全局配置文件的SSH\_CFG\_PATH配置项，或作为工具命令行参数--ssh\_config的值。

> **说明：** 
>-   MindCmd工具上板推理时会根据以上配置文件提供的信息，自动执行mount、umount操作。
>-   HOST\_MOUNT\_PATH配置的路径不能超出2所配置的NFS共享目录范围，否则可能会导致mount失败。
>-   示例中的$\{SHARE\_DIR\}、$\{username\}、$\{password\}请根据实际情况替换。
>-   板端ssh环境搭建请参考[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)“OpenSSH服务搭建”章节。
...
>-   数据预处理完整配置方式请参考[《ATC工具使用指南》](../modules/ai/ATC工具使用指南.md)“--insert\_op\_conf” 章节。
...
1.  使用挂载数据卷和共享主机ip的方式启动容器，相关命令参数说明如表1所示。
    ...
    **表 1**  启动容器参数说明
    ...
    <div class="note" id="note10129102718714"><a name="note10129102718714"></a><a name="note10129102718714"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul1244482219531"></a><a name="ul1244482219531"></a><ul id="ul1244482219531"><li>${host_mount_dir}路径要求为服务器侧已存在路径，且前后${host_mount_dir}填写的路径应该保持一致，且不能超出ssh.cfg文件配置中配置的“HOST_MOUNT_PATH”。</li></ul>
    </div></div>
    </td>
    </tr>
    ...
    >-   构建解决方案镜像，请参考[《驱动和开发环境安装指南》](../getting-started/Hi3403V100环境搭建指南.md)“容器镜像构建”章节。
...
3.  <a name="li1404101713543"></a>修改容器的ssh默认端口
    ...
    **图 1**  修改ssh默认端口<a name="fig1286420152318"></a>  
    <img src="figures/修改ssh默认端口.png" alt="" />
...
2.  安装python3.7.5依赖的包。
    ...
    libsqlite3-dev需要在python安装之前安装，如果用户操作系统已经安装python3.7.5环境，在此之后再安装libsqlite3-dev，则需要重新编译python环境。如果安装python3-tk失败，请参见[《AMCT使用指南（PyTorch）》](../modules/ai/AMCT使用指南（PyTorch）.md)中”安装python3-tk时提示错误信息”小节。
...
<img src="figures/MindCmd安装失败-找不到Rust编译器.png" alt="" />
...
<img src="figures/PyTorch模型推理失败.png" alt="" />
...
<img src="figures/Python脚本中使用了argparse进行参数解析.png" alt="" />
...
<img src="figures/使用构造参数类传入参数.png" alt="" />
