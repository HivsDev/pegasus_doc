...
- 双击在 **1.1、软件获取** 下载的VirtualBox-6.1.36-152435-Win.exe 安装包，点击下一步，安装VirtualBox。
...
- 在Windows 主机，解压在 **1.1、软件获取** 下载的MobaXterm_Installer_v22.1.zip 压缩包，然后双击解压后的MobaXterm_installer_22.1.msi，进行MobaXterm的安装。
- 一直点击下一步，即可安装成功。
