...
- 双击在 **[1.1、软件获取](#11软件获取)** 下载的VirtualBox-6.1.36-152435-Win.exe 安装包，点击下一步，安装VirtualBox。

![1660296543764.png](figures/1660296543764.png)

- 点击浏览按钮，修改VirtualBox的安装路径，然后点击确定按钮，再点击下一步。

![1660296754355.png](figures/1660296754355.png)

- 当出现下面的界面，点击下一步。

![1660296839014.png](figures/1660296839014.png)

- 当出现下面的界面，点击是。

![1660296858985.png](figures/1660296858985.png)

- 当出现下面的安装界面时，点击安装。

![1660296894293.png](figures/1660296894293.png)

- 点击完成，即可完成VirtualBox的安装。

![1660296945033.png](figures/1660296945033.png)
...
![1660297859905.png](figures/1660297859905.png)

- 修改虚拟机的名称为hispark，然后修改Ubuntu系统的安装文件夹（因为软件默认安装在C盘，我们最好是把安装路径修改为其他磁盘），把类型配置为linux,然后版本选择 Ubuntu(64-bit)，然后再点击下一步。

![1660298040734.png](figures/1660298040734.png)

- 修改Ubuntu的运行内存大小为4G，然后点击下一步。

![1660298548447.png](figures/1660298548447.png)

- 选择现在创建虚拟硬盘，然后点击创建按钮。

![1660299094251.png](figures/1660299094251.png)

- 选择VDI（VirtualBox磁盘映像），然后点击下一步。

![1660299447519.png](figures/1660299447519.png)

- 选择动态分配，然后点击下一步。

![1660299605429.png](figures/1660299605429.png)

- 修改磁盘空间大小为100GB，然后点击创建按钮。请至少给Ubuntu分配100G的内存空间，否则后面的步骤会因为内存不足出现错误。

![1660543557813.png](figures/1660543557813.png)

- 点击设置按钮，选择常规选项，在高级选项处，把共享粘贴板和拖放都设置为双向，然后点击OK按钮。

![1660535140230.png](figures/1660535140230.png)

- 点击VirtualBox的设置，然后点击系统，选择处理器，把处理器的数量改为4。
- 注意：如果您的处理器小于等于4个的话，请把处理器数量改小一些。

![1660524570782.png](figures/1660524570782.png)

- 点击网络，选择网卡2，勾选启动网络连接，选择仅主机网络，点击OK。

![1660526866883.png](figures/1660526866883.png)

- 点击设置按钮，选择存储，然后选择没有盘片，点击光盘按钮，点击选择虚拟盘。

![image-20221008204335405.png](figures/image-20221008204335405.png)
...
![image-20221008204748937.png](figures/image-20221008204748937.png)

- 选择USB设备，把启动USB控制器的勾选去掉，禁用USB设备，然后点击OK（部分电脑可能无法进行这一步操作，可以先跳过）

![1677850636004.png](figures/1677850636004.png)

- 点击启动，启动Ubuntu系统

![image-20221008204846859.png](figures/image-20221008204846859.png)

#### 步骤2：Ubuntu系统的安装

- 选择中文(简体)，然后点击安装Ubuntu。

![image-20221008205114466.png](figures/image-20221008205114466.png)
...
![1660528406710.png](figures/1660528406710.png)

- 选择Chinese，然后点击继续按钮。

![image-20221008205422524.png](figures/image-20221008205422524.png)

- 将安装Ubuntu时下载更新的勾选去掉，然后点击继续按钮。

![1660528559616.png](figures/1660528559616.png)

- 点击现在安装。

![1660528682567.png](figures/1660528682567.png)

- 点击继续按钮。

![1660528767526.png](figures/1660528767526.png)

- 选择上海，然后点击继续按钮。

![1660528851907.png](figures/1660528851907.png)

- 设置好账号和密码，点击继续按钮，此处的账号和密码即为您Ubuntu的登录所需的账号和密码。
- 请按照本文的配置来，账号为：hispark，密码为：hispark。

![1660528966097.png](figures/1660528966097.png)

- 开始安装各种软件。

![1660529074917.png](figures/1660529074917.png)

- Ubuntu安装完成后，点击现在重启按钮。

![1660530895384.png](figures/1660530895384.png)

- 如果在重启的过程中出现提示**please remove the installation medium**，可以直接点击关闭按钮，选择强制退出，点击OK即可。

![image-20221008211749642.png](figures/image-20221008211749642.png)

![image-20221008211932823.png](figures/image-20221008211932823.png)

- 点击virtualbox的设备，点击安装增强功能

![1660531880704.png](figures/1660531880704.png)

- 当弹出 弹窗询问是否运行自启动软件时，点击取消。

![image-20221206112854144.png](figures/image-20221206112854144.png)

- 此时左边任务栏会多出一个光盘一样的图标，点击并打开光盘图标，进入该文件夹内。

![1660532499347.png](figures/1660532499347.png)

- 在光盘文件夹的空白处，鼠标右键，点击在终端打开。

![1660532614696.png](figures/1660532614696.png)
...
![1660534104460.png](figures/1660534104460.png)

![1660533974180.png](figures/1660533974180.png)
...
![image-20221011145610949.png](figures/image-20221011145610949.png)

#### 步骤3：更新软件

- 当Ubuntu重启之后，点击Ubuntu桌面左下角九个点图标，然后打开软件和更新图标。

![image-20221011150040989.png](figures/image-20221011150040989.png)

- 点击Ubuntu软件，在**下载自**处点击下拉框，选择其他站点。

![1660534504940.png](figures/1660534504940.png)

- 在**中国**下方选择**阿里云**，然后点击选择服务器。

![1660534590521.png](figures/1660534590521.png)

- 此时弹出认证对话框，输入您的Ubuntu登录密码，本文为hispark。

![1660534734924.png](figures/1660534734924.png)

- 点击关闭按钮，然后有对话框时，点击重新载入，此时会有一段时间的软件更新，耐心等待即可。

![1660534898362.png](figures/1660534898362.png)

- 更新完成后，在Ubuntu的桌面，点击鼠标右键，点击在终端打开，打开终端窗口。

![image-20221011153823669.png](figures/image-20221011153823669.png)
...
![image-20220817160453331.png](figures/image-20220817160453331.png)
...
![image-20221012145535748.png](figures/image-20221012145535748.png)
...
![image-20221012145800709.png](figures/image-20221012145800709.png)

#### 步骤5：安装MobaXterm并连接到Ubuntu

- 在Windows 主机，解压在 **[1.1、软件获取](#11软件获取)** 下载的MobaXterm_Installer_v22.1.zip 压缩包，然后双击解压后的MobaXterm_installer_22.1.msi，进行MobaXterm的安装。
- 一直点击下一步，即可安装成功。

![image-20221012150919332.png](figures/image-20221012150919332.png)
...
![image-20220817175838126.png](figures/image-20220817175838126.png)
...
![image-20221011162217364.png](figures/image-20221011162217364.png)
...
![image-20221012151654877.png](figures/image-20221012151654877.png)

- 点击OK之后，若需要您输入登录密码，直接输入您Ubuntu的用户登录密码即可进入Ubuntu的终端界面。

![image-20221012152351010.png](figures/image-20221012152351010.png)
...
![image-20220507194232987-1761559591651-82.png](figures/image-20220507194232987-1761559591651-82.png)
...
![image-20230202110442244-1761559591651-83.png](figures/image-20230202110442244-1761559591651-83.png)
...
![1660616774005.png](figures/1660616774005.png)

- 点击浏览按钮，选择VScode的安装路径，然后点击下一步。

![1660616884682.png](figures/1660616884682.png)

- 出现下方界面，点击下一步。

![1660616935702.png](figures/1660616935702.png)

- 出现下方界面，点击下一步。

![1660617000292.png](figures/1660617000292.png)

- 出现下方界面，点击安装。

![1660617037533.png](figures/1660617037533.png)

- 出现下方界面，点击完成。

![1660617098393.png](figures/1660617098393.png)

## 5、将代码导入到VScode

- 点击VScode 左上角的File，然后点击Open Folder

![1660617664316.png](figures/1660617664316.png)
...
![image-20221109141616499.png](figures/image-20221109141616499.png)
