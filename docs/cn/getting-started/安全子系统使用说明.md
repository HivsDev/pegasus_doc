...
<tbody><tr id="row14800754183515"><td class="cellrowborder" valign="top" width="31.31%" headers="mcps1.1.3.1.1 "><p id="p680013548356"><a name="p680013548356"></a><a name="p680013548356"></a>Hi3403V100</p>
</td>
...
<tbody><tr id="row880005423516"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p186mcpsimp"><a name="p186mcpsimp"></a><a name="p186mcpsimp"></a><a name="image103"></a><a name="image103"></a><span><img src="figures/zh-cn_image_0000002424190174.png" alt="" /></span></p>
</td>
...
<tr id="row9800135483510"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p191mcpsimp"><a name="p191mcpsimp"></a><a name="p191mcpsimp"></a><a name="image104"></a><a name="image104"></a><span><img src="figures/zh-cn_image_0000002457868937.png" alt="" /></span></p>
</td>
...
<tr id="row1080055419355"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p196mcpsimp"><a name="p196mcpsimp"></a><a name="p196mcpsimp"></a><a name="image105"></a><a name="image105"></a><span><img src="figures/zh-cn_image_0000002457828817.png" alt="" /></span></p>
</td>
...
<tr id="row2801054103511"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p201mcpsimp"><a name="p201mcpsimp"></a><a name="p201mcpsimp"></a><a name="image106"></a><a name="image106"></a><span><img src="figures/zh-cn_image_0000002424349998.png" alt="" /></span></p>
</td>
...
<tr id="row17801145414351"><td class="cellrowborder" valign="top" width="20.200000000000003%" headers="mcps1.1.3.1.1 "><p class="msonormal" id="p207mcpsimp"><a name="p207mcpsimp"></a><a name="p207mcpsimp"></a><a name="image107"></a><a name="image107"></a><span><img src="figures/zh-cn_image_0000002457868929.png" alt="" /></span></p>
</td>
...
3.  用户自定义区域：芯片集成了约25Kbit的用户自定义OTP区域，用以存放用户数据。
    ...
    在SSxxxx SDK包中，提供了OTP相关的读写接口。详细请参考本文“[SSxxxx OTP字段定义](../hardware/安全启动使用指南.md)  ”以及文档[《OTP API 参考》](../modules/reference/OTP API 参考.md)。
...
详细请参考[《OTP API参考》](../modules/reference/OTP API 参考.md)
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p186mcpsimp"><a name="p186mcpsimp"></a><a name="p186mcpsimp"></a><a href="OTP_USER_ONEWAY0.md">OTP_USER_ONEWAY0</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p194mcpsimp"><a name="p194mcpsimp"></a><a name="p194mcpsimp"></a><a href="OTP_USER_ONEWAY1.md">OTP_USER_ONEWAY1</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p202mcpsimp"><a name="p202mcpsimp"></a><a name="p202mcpsimp"></a><a href="OTP_USER_LOCKABLE0.md">OTP_USER_LOCKABLE0</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p210mcpsimp"><a name="p210mcpsimp"></a><a name="p210mcpsimp"></a><a href="OTP_USER_LOCKABLE1.md">OTP_USER_LOCKABLE1</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p218mcpsimp"><a name="p218mcpsimp"></a><a name="p218mcpsimp"></a><a href="OTP_USER_LOCKABLE2.md">OTP_USER_LOCKABLE2</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p226mcpsimp"><a name="p226mcpsimp"></a><a name="p226mcpsimp"></a><a href="OTP_USER_LOCKABLE3.md">OTP_USER_LOCKABLE3</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p234mcpsimp"><a name="p234mcpsimp"></a><a name="p234mcpsimp"></a><a href="OTP_USER_LOCKABLE4.md">OTP_USER_LOCKABLE4</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p242mcpsimp"><a name="p242mcpsimp"></a><a name="p242mcpsimp"></a><a href="OTP_USER_LOCKABLE5.md">OTP_USER_LOCKABLE5</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p250mcpsimp"><a name="p250mcpsimp"></a><a name="p250mcpsimp"></a><a href="OTP_USER_LOCKABLE6.md">OTP_USER_LOCKABLE6</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p266mcpsimp"><a name="p266mcpsimp"></a><a name="p266mcpsimp"></a><a href="OTP_USER_LOCKABLE8.md">OTP_USER_LOCKABLE8</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p274mcpsimp"><a name="p274mcpsimp"></a><a name="p274mcpsimp"></a><a href="OTP_USER_LOCKABLE9.md">OTP_USER_LOCKABLE9</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p282mcpsimp"><a name="p282mcpsimp"></a><a name="p282mcpsimp"></a><a href="OTP_USER_LOCKABLE10.md">OTP_USER_LOCKABLE10</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p290mcpsimp"><a name="p290mcpsimp"></a><a name="p290mcpsimp"></a><a href="OTP_USER_LOCKABLE11.md">OTP_USER_LOCKABLE11</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p298mcpsimp"><a name="p298mcpsimp"></a><a name="p298mcpsimp"></a><a href="OTP_USER_LOCKABLE13.md">OTP_USER_LOCKABLE13</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p306mcpsimp"><a name="p306mcpsimp"></a><a name="p306mcpsimp"></a><a href="OTP_USER_LOCKABLE14.md">OTP_USER_LOCKABLE14</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p314mcpsimp"><a name="p314mcpsimp"></a><a name="p314mcpsimp"></a><a href="OTP_USER_LOCKABLE15.md">OTP_USER_LOCKABLE15</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p322mcpsimp"><a name="p322mcpsimp"></a><a name="p322mcpsimp"></a><a href="OTP_USER_LOCKABLE16.md">OTP_USER_LOCKABLE16</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="36%" headers="mcps1.2.4.1.2 "><p id="p330mcpsimp"><a name="p330mcpsimp"></a><a name="p330mcpsimp"></a><a href="OTP_USER_LOCKABLE17.md">OTP_USER_LOCKABLE17</a></p>
</td>
...
TRNG具体应用方法，请参考文档[《CIPHER API 参考》](../modules/reference/CIPHER API 参考.md)
...
<img src="figures/密钥管理原理图.png" alt="" title="密钥管理原理图" />

SPACC具体应用方法，请参考文档[《CIPHER API 参考》](../modules/reference/CIPHER API 参考.md)
...
RSA具体应用方法，请参考文档[《CIPHER API 参考》](../modules/reference/CIPHER API 参考.md)。
...
SSxxxx 的JTAG调试接口可以通过OTP进行打开模式、密码模式、永久关闭模式的切换，默认为打开模式。OTP烧写的具体操作方法，请参照本文“[SSxxxx OTP字段定义](../hardware/安全启动使用指南.md)”和文档[《OTP API 参考》](../modules/reference/OTP API 参考.md)。
...
-   jtag\_prt\_mode：在jtag\_ca\_en为1（使能）的情况下有效。jtag\_prt\_mode由2bit控制不同工作模式。
    ...
    详细配置，请参考本文“[SSxxxx OTP字段定义](../hardware/安全启动使用指南.md)”。
