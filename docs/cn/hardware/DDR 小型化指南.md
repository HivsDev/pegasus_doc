...
基于 SS626V100的SDK目前支持运行Linux和liteos双系统或单linux系统，如业务场景只需运行单linux系统，可参考[《内存布局调整指南》](内存布局调整指南.md)3.2章节裁剪liteos系统相关MMZ占用。本文中默认以Linux和liteos双系统为基础进行描述。SS626V100的系统小型化基于DEMO单板实现，以容量为2G Bytes的DDR内存为例。

**图 1**  DEMO板中Linux系统内存分配图（仅供参考）<a name="fig58516719710"></a>  
<img src="figures/DEMO板中Linux系统内存分配图（仅供参考）.png" alt="" />
...
<td class="cellrowborder" valign="top" width="34.26240652617267%" headers="mcps1.1.7.1.5 "><p id="p572411981616"><a name="p572411981616"></a><a name="p572411981616"></a>公共VB池、模块VB池、UserVB池的个数设置参见[《MPP 媒体处理软件 V5.0 开发参考》](../modules/mpp/01 概述.md)“系统控制章节”的VB相关接口。</p>
...
> **说明：** 
>具体参见[《MPP媒体处理软件V5.0开发参考》](../modules/mpp/01 概述.md)"视频解码”章节。
...
> **说明：** 
>具体使用方法及限制参见[《MPP媒体处理软件V5.0开发参考》](../modules/mpp/01 概述.md)“视频处理子系统”章节。
...
> **说明：** 
>具体使用方法及限制参见[《MPP媒体处理软件V5.0开发参考》](../modules/mpp/01 概述.md)“视频图形子系统”章节。
...
> **说明：** 
>具体参见[《MPP媒体处理软件V5.0开发参考》](../modules/mpp/01 概述.md)"视频编码”章节。
...
> **说明：** 
>具体参见[《MPP媒体处理软件V5.0开发参考》](../modules/mpp/01 概述.md)"视频输出”章节。
...
> **说明：** 
>参考文档[《MPP 媒体处理软件 V5.0 开发参考》](../modules/mpp/01 概述.md)“音频”章节。
...
-   参考文档[《MPP 媒体处理软件 V5.0 开发参考》](../modules/mpp/01 概述.md)“区域管理”章节，proc信息查看命令cat /proc/umap/rgn。
