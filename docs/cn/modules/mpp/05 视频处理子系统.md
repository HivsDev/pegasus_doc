...
-   具体使用方法及场景约束请参考[《MPP 媒体处理软件 V5.0 FAQ》](MPP 媒体处理软件 V5.0 FAQ.md)。
...
-   抓拍场景，建议使用OT\_VPSS\_NR\_TYPE\_SNAP\_NORM模式。此模式仅做空域处理，不分配参考帧内存，VPSS仅处理ss\_mpi\_snap\_trigger\_pipe触发的抓拍帧，抓拍相关描述参考[《抓拍 使用指南》](../../getting-started/抓拍 使用指南.md)。
