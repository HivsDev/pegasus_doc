...
在工具平台主界面里，可以看到工具透视图，包括工具平台自身的透视图和已安装并处于激活状态的工具的透视图。如[图3]所示。
...
在工具平台菜单中【Device】 \> 【Switch Device】，选择要切换的方案，如所[图1]示。
...
工具放在F:\\Work!!!!!!!!!!!!!!!!!!!!!\\这样的路径下，会提示如[图1]异常，无法运行。
