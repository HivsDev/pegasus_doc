...
<tr id="row206101594251"><td class="cellrowborder" valign="top" width="31.759999999999998%" headers="mcps1.1.3.1.1 "><p id="p8622349102117"><a name="p8622349102117"></a><a name="p8622349102117"></a>Hi3403V100</p>
</td>
...
<img src="figures/工具启动画面.png" alt="" />

启动画面跳转后，显示工具首页，如图2所示。

**图 2**  工具首页<a name="_Ref403114108"></a>  
<img src="figures/工具首页.png" alt="" />
...
<img src="figures/已安装透视图.png" alt="" />
...
在工具平台菜单中【Device】 \> 【Switch Device】，选择要切换的方案，如所图1示。

**图 1**  方案切换菜单<a name="_Ref377548814"></a>  
<img src="figures/方案切换菜单.png" alt="" />
...
<img src="figures/路径异常提示.png" alt="" />
