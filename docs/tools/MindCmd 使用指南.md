...
-   一键推理：提供一键推理功能，一键式端到端执行数据预处理、开源框架推理、模型压缩、模型转换、功能仿真、指令仿真、上板推理、Dump、精度比对、性能分析等功能。参见[一键推理](一键推理.md)。
-   数据预处理：提供数据预处理功能，在进行模型压缩、模型转换等功能之前通过数据预处理将数据处理成与模型匹配的数据。参见[数据预处理](数据预处理.md)。
-   开源框架推理：提供开源框架推理功能。获取Ground Truth数据。参见[开源框架推理](开源框架推理.md)。
-   模型压缩：提供模型压缩功能，对模型的权重（weight）和数据（activation）进行低比特处理，让最终生成的网络模型更加轻量化，从而达到节省网络模型存储空间、降低传输时延、提高计算效率，达到性能提升与优化的目标，参见[模型压缩](模型压缩.md)。
-   模型转换：提供模型转换功能，将训练好的模型转换为离线模型，参见[模型转换](模型转换.md)。
-   功能仿真：提供功能仿真推理功能，参见[应用工程](应用工程.md)。
-   指令仿真：提供指令仿真推理功能，参见[应用工程](应用工程.md)。
-   上板推理：提供上板推理功能，参见[应用工程](应用工程.md)。
-   精度比对：提供精度比对功能，可以用来比对模型转换后SoC支持的算子运行结果与标准算子的运行结果，以便用来确认运算误差发生的原因，参见[精度比对](精度比对.md)。
-   性能分析：提供性能分析功能，用于采集和分析SoC推理业务各个运行阶段的关键性能指标，参见[性能分析](性能分析.md)。
-   工具模块：提供可单独调用的工具，包括原始Caffe模型子网导出、数据格式转换、模型Uninplace、ATC命令行转cfg文件，参见[Tools](Tools.md)。
...
<td class="cellrowborder" valign="top" width="57.599999999999994%" headers="mcps1.2.4.1.3 "><p id="p82501251144018"><a name="p82501251144018"></a><a name="p82501251144018"></a>MindCmd工具主要用于端到端一键执行数据预处理、模型量化、模型转换、仿真推理、模型推理、精度比对和性能分析。各子模块支持单独调用，参见<a href="MindCmd子命令.md">MindCmd子命令</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="62.62%" headers="mcps1.2.4.1.3 "><a name="ul10992135553719"></a><a name="ul10992135553719"></a><ul id="ul10992135553719"><li>请参见<a href="安装Python3-7-5（Ubuntu）.md">安装Python3.7.5（Ubuntu）</a>。</li></ul>
</td>
</tr>
...
支持在Docker中使用MindCmd，解决方案提供了Dockerfile文件，构建镜像请参考《驱动和开发环境安装指南》“容器镜像构建”章节，启动容器请参考[Docker容器中使用MindCmd](Docker容器中使用MindCmd.md)。
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p5873642117"><a name="p5873642117"></a><a name="p5873642117"></a>上板推理默认配置文件，<strong id="b149681840175215"><a name="b149681840175215"></a><a name="b149681840175215"></a>若需要执行上板推理，则需要配置此参数</strong>。详细配置项参考<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="37.81%" headers="mcps1.2.6.1.5 "><p id="p22900358310"><a name="p22900358310"></a><a name="p22900358310"></a>运行前先删除工作路径下<a href="一键推理.md">一键推理</a>的历史输出目录，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p1386954453611"><a name="p1386954453611"></a><a name="p1386954453611"></a><a href="模型压缩.md">模型压缩</a>开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p1172114233610"><a name="p1172114233610"></a><a name="p1172114233610"></a><a href="开源框架推理.md">开源框架推理</a>开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p181443912363"><a name="p181443912363"></a><a name="p181443912363"></a><a href="上板推理.md">上板推理</a>开关，默认值为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p11882716319"><a name="p11882716319"></a><a name="p11882716319"></a><a href="功能仿真.md">功能仿真</a>运行开关，默认值为1。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p9656152804018"><a name="p9656152804018"></a><a name="p9656152804018"></a><a href="指令仿真.md">指令仿真</a>运行开关，默认值为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p171943517400"><a name="p171943517400"></a><a name="p171943517400"></a>Dump数据<a href="精度比对.md">精度比对</a>开关，默认值为1。</p>
</td>
</tr>
...
工具内置一个PyTorch 模型pooling算子快速上手的用例，位于\{MINDCMD\_INSTALL\_PATH\}/testcase。请参考[安装MindCmd](安装MindCmd.md)完成安装，再参考[全局配置](全局配置.md)完成MindCmd工具配置。
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p782618230342"><a name="p782618230342"></a><a name="p782618230342"></a>指定数据预处理配置文件，参见<a href="数据预处理配置文件样例.md">数据预处理配置文件样例</a>。</p>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i1696934423315"><a name="i1696934423315"></a><a name="i1696934423315"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>小节中“HOST_MOUNT_PATH”配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.08%" headers="mcps1.2.4.1.3 "><p id="p164818234554"><a name="p164818234554"></a><a name="p164818234554"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考<a href="NFS环境搭建.md">NFS环境搭建</a>。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
</td>
</tr>
...
-   模型和数据准备。
    ...
    > **说明：** 
    >-   推理数据的shape应该与模型所需输入数据的shape相同，如：模型resnet50的shape为（3，224，224），图片的shape也应为（3，224，224）。否则需要自定义数据预处理方式，通过--aapp参数指定[数据预处理配置文件样例](数据预处理配置文件样例.md)，数据预处理完整配置方式请参考《ATC工具使用指南》“--insert\_op\_conf ”章节。
    >-   当推理数据为图片且未指定数据预处理配置文件时，工具会自动将所有图片Resize成模型所需输入数据的shape。

-   选择一键推理场景

    执行一键推理前在[全局配置](全局配置.md)中配置一键推理场景开关
...
<td class="cellrowborder" valign="top" width="73.34%" headers="mcps1.2.4.1.3 "><p id="p14600165303319"><a name="p14600165303319"></a><a name="p14600165303319"></a>指定数据预处理配置文件，参考<a href="数据预处理配置文件样例.md">数据预处理配置文件样例</a>。</p>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i1042152314349"><a name="i1042152314349"></a><a name="i1042152314349"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="73.34%" headers="mcps1.2.4.1.3 "><p id="p188991542163611"><a name="p188991542163611"></a><a name="p188991542163611"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考<a href="NFS环境搭建.md">NFS环境搭建</a>。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="69.41000000000001%" headers="mcps1.2.4.1.3 "><p id="p845812137486"><a name="p845812137486"></a><a name="p845812137486"></a>指定数据预处理配置文件，参考<a href="数据预处理配置文件样例.md">数据预处理配置文件样例</a>。</p>
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="全局配置.md#p181443912363">上板推理开关</a>（IS_<em id="i142475143517"><a name="i142475143517"></a><a name="i142475143517"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="69.41000000000001%" headers="mcps1.2.4.1.3 "><p id="p1228816422313"><a name="p1228816422313"></a><a name="p1228816422313"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考<a href="NFS环境搭建.md">NFS环境搭建</a>。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
</td>
</tr>
...
> **说明：** 
>Deployed模型的一键推理命令格式请参考：[Caffe模型一键推理](Caffe模型一键推理.md)、[PyTorch模型一键推理](PyTorch模型一键推理.md)和[ONNX模型一键推理](ONNX模型一键推理.md)。
...
-   数据准备
    ...
    执行开源框架前需要提前准备推理数据\(参考[数据预处理](数据预处理.md)\)，参考文件结构如下。
...
-   数据准备
    ...
    执行开源框架前需要提前准备推理数据\(处理方法参考[数据预处理](数据预处理.md)\)，参考文件结构如下。
...
<div class="note" id="note19474237102"><a name="note19474237102"></a><a name="note19474237102"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p9947152313109"><a name="p9947152313109"></a><a name="p9947152313109"></a>通过--quant_config可以先对模型进行调试，符合预期后将量化的deployed模型使用<a href="Caffe模型一键推理.md">Caffe模型一键推理</a>部署。</p>
...
<div class="note" id="note19474237102"><a name="note19474237102"></a><a name="note19474237102"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p9947152313109"><a name="p9947152313109"></a><a name="p9947152313109"></a>通过--quant_config可以先对模型进行调试，符合预期后将量化的deployed模型使用<a href="PyTorch模型一键推理.md">oneclick</a>部署。</p>
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p7220172683711"><a name="p7220172683711"></a><a name="p7220172683711"></a>指定板端ssh挂载配置文件。ssh挂载需先进行NFS环境搭建，可参考<a href="NFS环境搭建.md">NFS环境搭建</a>。</p>
<p id="p18435442131911"><a name="p18435442131911"></a><a name="p18435442131911"></a>ssh挂载配置文件的模板，可参考<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
</td>
</tr>
...
-   配置默认工作路径（可选）
    ...
    使用[全局配置](全局配置.md)文件\[base\_config\] section 下配置的默认工作路径，或通过命令行参数-k/--work\_dir指定工作路径。
...
-   准备ssh.cfg文件，参考[ssh.cfg文件配置](#ssh-cfg文件配置)
    ...
    ssh.cfg文件配置优先级如下：-s/--ssh\_config参数配置 \> mindcmd.ini中的全局配置（[SSH\_CFG\_PATH](全局配置.md#p687126112118)）。
...
-   collect操作自动采集性能原始数据，并解析。
    ...
    **表 3**  性能数据采集命令行参数说明
    ...
    <td class="cellrowborder" valign="top" width="67.49000000000001%" headers="mcps1.2.4.1.3 "><p id="p8060118"><a name="p8060118"></a><a name="p8060118"></a>ssh配置文件的路径，具体配置内容见<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>。</p>
    </td>
    </tr>
...
> **说明：** 
>$\{SHARE\_DIR\}表示NFS共享路径，其与工作路径、挂载路径、数据卷路径的关联关系详见[关于工作路径、挂载路径、数据卷路径和NFS共享路径](关于工作路径-挂载路径-数据卷路径和NFS共享路径.md)。
...
ssh.cfg配置文件路径可写入MindCmd全局配置文件的[SSH\_CFG\_PATH](全局配置.md#p687126112118)配置项，或作为工具命令行参数--ssh\_config的值。

> **说明：** 
>-   MindCmd工具上板推理时会根据以上配置文件提供的信息，自动执行mount、umount操作。
>-   HOST\_MOUNT\_PATH配置的路径不能超出[2](NFS环境搭建.md#li540246153120)所配置的NFS共享目录范围，否则可能会导致mount失败。
...
1.  使用挂载数据卷和共享主机ip的方式启动容器，相关命令参数说明如[表1](#table194044179542)所示。
    ...
    **表 1**  启动容器参数说明
    ...
    <div class="note" id="note10129102718714"><a name="note10129102718714"></a><a name="note10129102718714"></a><span class="notetitle"> 说明： </span><div class="notebody"><a name="ul1244482219531"></a><a name="ul1244482219531"></a><ul id="ul1244482219531"><li>${host_mount_dir}路径要求为服务器侧已存在路径，且前后${host_mount_dir}填写的路径应该保持一致，且不能超出<a href="ssh-cfg文件配置.md">ssh.cfg文件配置</a>中配置的“HOST_MOUNT_PATH”。</li></ul>
    </div></div>
    </td>
    </tr>
    ...
    >-   当在容器上板执行过程中出现挂载失败或报错提示“Permission denied”，请参考[NFS环境搭建](NFS环境搭建.md)  检查宿主机的数据卷路径是否在宿主机NFS共享目录下。
