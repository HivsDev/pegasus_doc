...
<img src="figures/双pipe离线拍照数据通路.png" alt="" title="双pipe离线拍照数据通路" />
...
这种数据通路可以用于NORMAL和PRO模式的拍照。PRO模式是在用户调用[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)接口之后才开始控制sensor进行长短曝光的。

-   双pipe离线时，拍照的pipe在用户调用[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)接口时才打开中断做数据处理，并且只处理抓拍的那几帧数据，抓拍完成后可以调用[ss\_mpi\_snap\_disable\_pipe](ss_mpi_snap_disable_pipe.md)停止数据处理。这样处理是为了降低拍照那个pipe的功耗。
-   双pipe离线时，用户拍摄正常曝光的照片，从调用[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)接口到VI输出第一张正常YUV数据，理论上的耗时在3帧左右，可以满足大部分客户场景的需求。所以，我们推荐客户采用双pipe离线的数据通路来实现拍照的方案。
...
<img src="figures/单pipe离线拍照数据通路.png" alt="" title="单pipe离线拍照数据通路" />
...
<img src="figures/单pipe在线拍照数据通路.png" alt="" title="单pipe在线拍照数据通路" />
...
ZSL模式的拍照通路和双pipe离线模式的拍照通路一样，区别是VI驱动内部会缓存一个RAW数据的队列。在调用[ss\_mpi\_snap\_enable\_pipe](ss_mpi_snap_enable_pipe.md)接口后，VI内部就开始缓存RAW数据，调用[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)接口会选择ZSL的拍照帧，然后将拍照的帧送给ISP做处理。
...
-   [ss\_mpi\_snap\_set\_pipe\_attr](ss_mpi_snap_set_pipe_attr.md)：设置拍照属性。
-   [ss\_mpi\_snap\_get\_pipe\_attr](ss_mpi_snap_get_pipe_attr.md)：获取拍照属性。
-   [ss\_mpi\_snap\_enable\_pipe](ss_mpi_snap_enable_pipe.md)：使能拍照的pipe。
-   [ss\_mpi\_snap\_disable\_pipe](ss_mpi_snap_disable_pipe.md)：停止拍照的pipe。
-   [ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)：触发抓拍。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1233mcpsimp"><a name="p1233mcpsimp"></a><a name="p1233mcpsimp"></a>失败，其值为<a href="错误码.md">错误码</a><span xml:lang="fr-FR" id="ph1235mcpsimp"><a name="ph1235mcpsimp"></a><a name="ph1235mcpsimp"></a>。</span></p>
</td>
</tr>
</tbody>
</table>
...
-   PIPE必须已创建。
-   拍照参数必须合法，具体请参见[ot\_snap\_attr](ot_snap_attr.md)。
...
-   在调用[ss\_mpi\_snap\_enable\_pipe](ss_mpi_snap_enable_pipe.md)接口之后，再次调用[ss\_mpi\_snap\_set\_pipe\_attr](#ZH-CN_TOPIC_0000001218750347)接口时，只能修改成员[ot\_snap\_attr](ot_snap_attr.md)的pro\_attr属性，修改其他属性都会报错。
...
[ss\_mpi\_snap\_get\_pipe\_attr](#ss_mpi_snap_get_pipe_attr)
...
<p id="p1009mcpsimp"><a name="p1009mcpsimp"></a><a name="p1009mcpsimp"></a>取值范围：[0, <a href="ss_mpi_snap_set_pipe_attr.md#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1041mcpsimp"><a name="p1041mcpsimp"></a><a name="p1041mcpsimp"></a>失败，其值为<a href="错误码.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_snap\_set\_pipe\_attr](#ss_mpi_snap_set_pipe_attr)
...
<p id="p1808mcpsimp"><a name="p1808mcpsimp"></a><a name="p1808mcpsimp"></a>取值范围：[0, <a href="ss_mpi_snap_set_pipe_attr.md#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1833mcpsimp"><a name="p1833mcpsimp"></a><a name="p1833mcpsimp"></a>失败，其值为<a href="错误码.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
-   PIPE必须已创建。
-   拍照的属性必须已经设置。
-   此接口不支持单PIPE拍照场景，调用ss\_mpi\_vi\_start\_pipe之后直接使用[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)接口即可拍照。
...
-   不支持重复使能拍照的PIPE。
-   双PIPE拍照时，[ss\_mpi\_snap\_enable\_pipe](#ZH-CN_TOPIC_0000001218948863)和[ss\_mpi\_snap\_trigger\_pipe](ss_mpi_snap_trigger_pipe.md)两个接口的调用间隔要大于2帧的曝光时间，才能使拍照的ISP处理效果正常。
-   PRO模式拍照时，[ss\_mpi\_snap\_disable\_pipe](ss_mpi_snap_disable_pipe.md)和[ss\_mpi\_snap\_enable\_pipe](#ZH-CN_TOPIC_0000001218948863)两个接口的调用间隔要大于4帧，即两次拍照的间隔，在低帧率下间隔过小，第二次拍照的帧可能不是期望的曝光帧。
...
<p id="p842mcpsimp"><a name="p842mcpsimp"></a><a name="p842mcpsimp"></a>取值范围：[0, <a href="ss_mpi_snap_set_pipe_attr.md#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p867mcpsimp"><a name="p867mcpsimp"></a><a name="p867mcpsimp"></a>失败，其值为<a href="错误码.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_snap\_enable\_pipe](#ss_mpi_snap_enable_pipe)
...
<p id="p2666mcpsimp"><a name="p2666mcpsimp"></a><a name="p2666mcpsimp"></a>取值范围：[0, <a href="ss_mpi_snap_set_pipe_attr.md#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2691mcpsimp"><a name="p2691mcpsimp"></a><a name="p2691mcpsimp"></a>失败，其值为<a href="错误码.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ot\_snap\_attr](ot_snap_attr.md)：定义拍照参数的结构体。
-   [ot\_snap\_type](ot_snap_type.md)：定义拍照类型的枚举。
-   [ot\_snap\_norm\_attr](ot_snap_norm_attr.md)：定义Normal类型拍照参数的结构体。
-   [ot\_snap\_pro\_attr](ot_snap_pro_attr.md)：定义PRO类型拍照参数的结构体。
-   [ot\_snap\_pro\_param](ot_snap_pro_param.md)：定义PRO类型ISP相关参数结构体。
-   [ot\_snap\_pro\_auto\_param](ot_snap_pro_auto_param.md)：定义PRO类型ISP自动模式参数结构体。
-   [ot\_snap\_pro\_manual\_param](ot_snap_pro_manual_param.md)：定义PRO类型ISP手动模式参数结构体。
...
[ot\_snap\_pro\_attr](#ot_snap_pro_attr)
...
[ot\_snap\_pro\_param](#ot_snap_pro_param)
...
-   [ss\_mpi\_photo\_alg\_init](ss_mpi_photo_alg_init.md)：初始化某个PHOTO算法。
-   [ss\_mpi\_photo\_alg\_deinit](ss_mpi_photo_alg_deinit.md)：去初始化某个PHOTO算法。
-   [ss\_mpi\_photo\_alg\_process](ss_mpi_photo_alg_process.md)：启动某个PHOTO算法的处理。
-   [ss\_mpi\_photo\_set\_alg\_coef](ss_mpi_photo_set_alg_coef.md)：设置某个PHOTO算法的图像效果调节系数。
-   [ss\_mpi\_photo\_get\_alg\_coef](ss_mpi_photo_get_alg_coef.md)：获取某个PHOTO算法的图像效果调节系数。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2250mcpsimp"><a name="p2250mcpsimp"></a><a name="p2250mcpsimp"></a>失败，其值为<a href="错误码-5.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_photo\_alg\_deinit](#ss_mpi_photo_alg_deinit)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p618mcpsimp"><a name="p618mcpsimp"></a><a name="p618mcpsimp"></a>失败，其值为<a href="错误码-5.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_photo\_alg\_init](#ss_mpi_photo_alg_init)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2109mcpsimp"><a name="p2109mcpsimp"></a><a name="p2109mcpsimp"></a>失败，其值为<a href="错误码-5.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p2555mcpsimp"><a name="p2555mcpsimp"></a><a name="p2555mcpsimp"></a>失败，其值为<a href="错误码-5.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_photo\_get\_alg\_coef](#ss_mpi_photo_get_alg_coef)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p234mcpsimp"><a name="p234mcpsimp"></a><a name="p234mcpsimp"></a>失败，其值为<a href="错误码-5.md">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
[ss\_mpi\_photo\_set\_alg\_coef](#ss_mpi_photo_set_alg_coef)

## 数据类型<a name="ZH-CN_TOPIC_0000002441683317"></a>

PHOTO相关数据类型定义如下：

-   [ot\_photo\_alg\_type](ot_photo_alg_type.md)：定义PHOTO算法类型的枚举。
-   [ot\_photo\_alg\_init](ot_photo_alg_init.md)：定义PHOTO算法初始化的结构体。
-   [ot\_photo\_alg\_attr](ot_photo_alg_attr.md)：定义PHOTO算法处理的属性结构体。
-   [ot\_photo\_hdr\_attr](ot_photo_hdr_attr.md)：定义HDR算法处理的结构体。
-   [ot\_photo\_sfnr\_attr](ot_photo_sfnr_attr.md)：定义SFNR算法处理的结构体。
-   [ot\_photo\_mfnr\_attr](ot_photo_mfnr_attr.md)：定义MFNR算法处理的结构体。
-   [ot\_photo\_de\_attr](ot_photo_de_attr.md)：定义DE算法处理的结构体。
-   [ot\_photo\_face\_info](ot_photo_face_info.md)：定义人脸区域信息的结构体。
-   [ot\_photo\_alg\_coef](ot_photo_alg_coef.md)：定义PHOTO算法系数的结构体。
-   [ot\_photo\_hdr\_coef](ot_photo_hdr_coef.md)：定义HDR算法系数的结构体。
-   [ot\_photo\_image\_fusion\_param](ot_photo_image_fusion_param.md)：定义图像融合参数的结构体。
-   [ot\_photo\_dark\_motion\_detection\_param](ot_photo_dark_motion_detection_param.md)：定义HDR中鬼影检测参数的结构体。
-   [ot\_photo\_sfnr\_coef](ot_photo_sfnr_coef.md)：定义SFNR算法系数的结构体。
-   [ot\_photo\_sfnr\_iso\_strategy](ot_photo_sfnr_iso_strategy.md)：定义SFNR算法ISO策略的结构体。
-   [ot\_photo\_mfnr\_coef](ot_photo_mfnr_coef.md)：定义MFNR算法系数的结构体。
-   [ot\_photo\_mfnr\_3dnr\_param](ot_photo_mfnr_3dnr_param.md)：定义MFNR算法中时域降噪系数的结构体。
-   [ot\_photo\_mfnr\_3dnr\_iso\_strategy](ot_photo_mfnr_3dnr_iso_strategy.md)：定义MFNR算法时域降噪系数中每个ISO档位的结构体。
-   [ot\_photo\_mfnr\_2dnr\_param](ot_photo_mfnr_2dnr_param.md)：定义MFNR算法中空域降噪系数的结构体。
-   [ot\_photo\_mfnr\_2dnr\_iso\_strategy](ot_photo_mfnr_2dnr_iso_strategy.md)：定义MFNR算法空域降噪系数中每个ISO档位的结构体。
-   [ot\_photo\_de\_coef](ot_photo_de_coef.md)：定义DE算法系数的结构体。
-   [ot\_photo\_de\_iso\_strategy](ot_photo_de_iso_strategy.md)：定义DE算法每个ISO档位对应策略的结构体。
-   [OT\_PHOTO\_HDR\_FRAME\_NUM](OT_PHOTO_HDR_FRAME_NUM.md)：定义HDR合成的帧数目。
-   [OT\_PHOTO\_MFNR\_FRAME\_NUM](OT_PHOTO_MFNR_FRAME_NUM.md)：定义MFNR合成的帧数目。
-   [OT\_PHOTO\_HDR\_ISO\_LEVEL\_CNT](OT_PHOTO_HDR_ISO_LEVEL_CNT.md)：定义调节HDR图像效果的ISO档位数目。
-   [OT\_PHOTO\_SFNR\_ISO\_LEVEL\_CNT](OT_PHOTO_SFNR_ISO_LEVEL_CNT.md)：定义调节SFNR图像效果的ISO档位数目。
-   [OT\_PHOTO\_MFNR\_ISO\_LEVEL\_CNT](OT_PHOTO_MFNR_ISO_LEVEL_CNT.md)：定义调节MFNR图像效果的ISO档位数目。
-   [OT\_PHOTO\_DE\_ISO\_LEVEL\_CNT](OT_PHOTO_DE_ISO_LEVEL_CNT.md)：定义调节DE图像效果的ISO档位数目。
-   [OT\_PHOTO\_MAX\_FACE\_NUM](OT_PHOTO_MAX_FACE_NUM.md)：定义算法处理中最大的人脸区域的数目。
-   [OT\_PHOTO\_MIN\_WIDTH](OT_PHOTO_MIN_WIDTH.md)：定义算法处理支持的最小图像分辨率的宽。
-   [OT\_PHOTO\_MIN\_HEIGHT](OT_PHOTO_MIN_HEIGHT.md)：定义算法处理支持的最小图像分辨率的高。
-   [OT\_PHOTO\_MAX\_WIDTH](OT_PHOTO_MAX_WIDTH.md)：定义算法处理支持的最大图像分辨率的宽。
-   [OT\_PHOTO\_MAX\_HEIGHT](OT_PHOTO_MAX_HEIGHT.md)：定义算法处理支持的最大图像分辨率的高。
...
-   [ss\_mpi\_photo\_alg\_init](#ss_mpi_photo_alg_init)
-   [ss\_mpi\_photo\_alg\_deinit](#ss_mpi_photo_alg_deinit)
-   [ss\_mpi\_photo\_alg\_process](#ss_mpi_photo_alg_process)
-   [ss\_mpi\_photo\_set\_alg\_coef](#ss_mpi_photo_set_alg_coef)
-   [ss\_mpi\_photo\_get\_alg\_coef](#ss_mpi_photo_get_alg_coef)
...
[ot\_photo\_alg\_attr](#ot_photo_alg_attr)
...
[ot\_photo\_hdr\_attr](#ot_photo_hdr_attr)
...
[ot\_photo\_alg\_coef](#ot_photo_alg_coef)
...
<img src="figures/公用曲线.png" alt="" title="公用曲线" />

**图 2**  各自曲线<a name="fig16968388141"></a>  
<img src="figures/各自曲线.png" alt="" title="各自曲线" />
...
[ot\_photo\_hdr\_coef](#ot_photo_hdr_coef)
...
[ot\_photo\_sfnr\_coef](#ot_photo_sfnr_coef)
...
[ot\_photo\_mfnr\_coef](#ot_photo_mfnr_coef)
...
[ot\_photo\_mfnr\_3dnr\_param](#ot_photo_mfnr_3dnr_param)
...
[ot\_photo\_mfnr\_2dnr\_param](#ot_photo_mfnr_2dnr_param)
...
[ot\_photo\_de\_coef](#ot_photo_de_coef)
...
[ot\_photo\_image\_fusion\_param](#ot_photo_image_fusion_param)
...
<img src="figures/视频采集类抓拍机典型数据通路.png" alt="" title="视频采集类抓拍机典型数据通路" />
